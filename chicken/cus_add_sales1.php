...
<html>
	...
	<body class="hold-transition skin-blue sidebar-mini">
			...
			?>
				<div class="box-body">
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-18">
								<form action="cus_save_sales1.php" method="post" role="form" onsubmit="return checkval()">
									<div class="form-group col-md-1">
										<label>Date<b style="color:red;">&nbsp;*</b></label>
										<input type="text" style="width:100px;" class="form-control" name="pdate" value="<?php echo $fdate; ?>" id="slc_datepickers" onchange="fetchtds()" readonly>
									</div>
									<div class="form-group col-md-1">
										<label>Invoice</label>
									<input type="text" name="inv" id="inv" style="width:auto;background:none;border:none;text-decoration:none;" class="form-control" value="<?php echo $code; ?>" placeholder="Enter Location..." readonly>
									</div>
									<div class="form-group col-md-3">&ensp;&ensp;
										<label>Customer<b style="color:red;">&nbsp;*</b></label>
										<select name="pname" id="pname" class="form-control select2" style="width: 100%;" onchange="fetchoutstanding()">
									...
									<input type="text" name="binv" id="binv" style="" class="form-control" placeholder="Enter Book Invoice...">
									</div>
									...
									<div class="form-group col-md-1" style="visibility:hidden;"><!-- style="visibility:visible;"-->
										<label>Outstanding<b style="color:red;">&nbsp;*</b></label>
										<input type="text" style="width:auto;" class="form-control" name="outstanding" id="outstanding">
									</div>
									<div class="col-md-12">
										<table style="width:100%;line-height:30px;" id="tab3">
											<tr style="line-height:30px;">
												<th><label>Item Description<b style="color:red;">&nbsp;*</b></label></th>
												<th <?php if($ifjbwen == 1 || $ifjbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><label>Jals<b style="color:red;">&nbsp;*</b></label></th>
												<th <?php if($ifjbwen == 1 || $ifjbw == 1 || $ifbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><label>Birds</label></th>
												<!--<th><label>Weight<b style="color:red;">&nbsp;*</b></label></th>-->
												<th <?php if($ifjbwen == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><label>T. Weight<b style="color:red;">&nbsp;*</b></label></th>
												<th <?php if($ifjbwen == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><label>E. Weight<b style="color:red;">&nbsp;*</b></label></th>
												<?php
												if($_SESSION['dbase'] == "poulso6_chicken_ka_dharun_feeds"){
												?>
												<th><label>No.of Bags<b style="color:red;">&nbsp;*</b></label></th>
												<?php
												}
												else{
												?>
											...
											<tr style="margin:5px 0px 5px 0px;" id="row_id[0]">
												<td style="width: 180px;padding-right:30px;"><select name="scat[]" id="scat[0]" class="form-control select2" style="width: 100%;" onchange="calculatetotal(this.id);fetchprice(this.id);"><?php foreach($itype as $ic){ ?><option value="<?php echo $itype[$ic]."@".$itypes[$ic]; ?>"><?php echo $itypes[$ic]; ?></option><?php } ?></select></td>
												<td <?php if($ifjbwen == 1 || $ifjbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" name="jval[]" id="jval[0]" value="0" class="form-control" onchange="validate_count(this.id);calculatetotal(this.id);" /></td>
												<td <?php if($ifjbwen == 1 || $ifjbw == 1 || $ifbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" name="bval[]" id="bval[0]" value="0" class="form-control" onchange="validate_count(this.id);calculatetotal(this.id);" /></td>
												<td <?php if($ifjbwen == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" name="wval[]" id="wval[0]" value="0" class="form-control" onchange="validateamount(this.id);calculatetotal(this.id);" /></td>
												<!--<td><input type="text" name="twval[]" id="twval[0]" value="0" class="form-control" onchange="validateamount(this.id);calculatetotal(this.id);" /></td>-->
												<td <?php if($ifjbwen == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" name="ewval[]" id="ewval[0]" value="0" class="form-control" onchange="validateamount(this.id);calculatetotal(this.id);" /></td>
												<td><input type="text" name="nwval[]" id="nwval[0]" value="0" class="form-control" onchange="validateamount(this.id);" onkeyup="calculatetotal(this.id);" /></td>
												<td><input type="text" name="iprice[]" id="iprice[0]" class="form-control" onchange="validateamount(this.id);calculatetotal(this.id);" onkeyup="calculatetotal(this.id);"></td>
												<td style="display:none;"><input type="text" name="idisc[]" id="idisc[0]" style="" class="form-control" onchange="validateamount(this.id);calculatetotal(this.id);"></td>
												<td style="display:none;"><input type="text" name="itax[]" id="itax[0]" style="" class="form-control" onchange="validateamount(this.id);calculatetotal(this.id);" onkeyup="calculatetotal(this.id);"></td>
												<td><input type="text" name="tamt[]" id="tamt[0]" class="form-control" onchange="validateamount(this.id);" readonly /></td>
												<td style="width: 150px;padding-right:30px;"><select name="wcodes[]" id="wcodes[0]" class="form-control select2" style="width: 100%;"><?php foreach($wcode as $it){ ?><option value="<?php echo $wcode[$it]; ?>"><?php echo $wdesc[$it]; ?></option><?php } ?></select></td>
										...
										<div class="col-md-12" align="left">
											<div class="col-md-4">
												<input type="checkbox" name="tds" id="tds" style="width:auto;" onchange="caltds()" >
												<label>TCS</label>
												<input type="text" name="tdsamt" id="tdsamt" class="form-control" style="width:auto;">
											</div>
											<div class="col-md-4" style="visibility: hidden;">
												<label>TCS Percentage</label>
												<input type="text" name="tdsperval" id="tdsperval" class="form-control" style="width:auto;" value="<?php echo $tdsper; ?>">
											</div>
										</div>
										<div class="col-md-12" align="left">
											<div class="col-md-3">
												<label>Vehicle No.</label>
												<input type="text" name="vno" id="vno" class="form-control"style="width:auto;" >
											</div>
											<div class="col-md-3">
												<label>Driver</label>
												<input type="text" name="dname" id="dname" class="form-control"style="width:auto;" >
											</div>
											<div class="col-md-2">
												<label>Transport Charges</label>
												<input type="text" name="delivery_charge" id="delivery_charge" class="form-control text-right" style="width:auto;" onkeyup="validatenum(this.id);caltds();" onchange="validateamount(this.id);" />
											</div>
											<div class="col-md-2">
												<label>Dressing Charges</label>
												<input type="text" name="dressing_charge" id="dressing_charge" class="form-control text-right" style="width:auto;" onkeyup="validatenum(this.id);caltds();" onchange="validateamount(this.id);" />
											</div>
											<div class="col-md-2">
												<label>Billing Amount</label>
												<input type="text" name="gtamt" id="gtamt" class="form-control text-right" style="width:auto;" readonly>
											</div>
										</div>
										<div class="col-md-12" align="left">
		...
		<script>
			...
			// 	var tamt = document.getElementById("tamt["+ac+"]").value;
			// 	var nwal = document.getElementById("nwval["+ac+"]").value;
			// 	var rate = (float)tamt/(float)nwal;
			// 	//document.getElementById("iprice["+ac+"]").value = rate;
			...
			function rowgen(a){
				...
				html+= '<td style="width: 180px;padding-right:30px;"><select name="scat[]" id="scat['+c+']" class="form-control select" style="width: 100%;" onchange="calculatetotal(this.id);fetchprice(this.id);"><?php foreach($itype as $ic){ ?><option value="<?php echo $itype[$ic]."@".$itypes[$ic]; ?>"><?php echo $itypes[$ic]; ?></option><?php } ?></select></td>';
				html+= '<td <?php if($ifjbwen == 1 || $ifjbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" name="jval[]" id="jval['+c+']" value="0" class="form-control" onchange="validate_count(this.id);calculatetotal(this.id);" /></td>';
				html+= '<td <?php if($ifjbwen == 1 || $ifjbw == 1 || $ifbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" name="bval[]" id="bval['+c+']" value="0" class="form-control" onchange="validate_count();calculatetotal(this.id);" /></td>';
			...
			function calculatetotal(aa){
				...
				var t_charge = document.getElementById("delivery_charge").value; if(t_charge == ""){ t_charge = 0; }
				var d_charge = document.getElementById("dressing_charge").value; if(d_charge == ""){ d_charge = 0; }
				...
				if(r.match("WT")){
					...
					l = parseFloat(l) + parseFloat(t_charge) + parseFloat(d_charge);
			...
			function calbalamt() {
				...
				if(document.getElementById("tds").checked == true){
					var b = document.getElementById("tdsperval").value;
					var c = document.getElementById("gtamt").value;
					var d = b/100; var e = c * d; var f = parseFloat(c) + parseFloat(e);
					document.getElementById("tdsamt").value = e;
					document.getElementById("gtamt").value = f;
				}
				else { }
			...
			function fetchoutstanding(){
				...
				if(!a.match("select")){
					var prices = new XMLHttpRequest();
					var method = "GET";
					var url = "cus_fetchoutstandingbal.php?cuscode="+a;
					var asynchronous = true;
					prices.open(method, url, asynchronous);
					prices.send();
					prices.onreadystatechange = function(){
						if(this.readyState == 4 && this.status == 200){
							var f = this.responseText;
							if(f == "") {
								document.getElementById("outstanding").value = "0.00";
							}
							else {
								document.getElementById("outstanding").value = f;
							}
						}
					}
				}
