						...
						<div class="col-md-12" id="salesManagerWrapper" style="display: none;">
							...
							<div class="form-group col-md-4">
                                ...
                                <?php foreach($emp_code as $ecode){ ?>
									<option value="<?php echo $ecode ?>"><?php echo $emp_name[$ecode] ?></option>
								<?php } ?>
						...
						<div class="col-md-12">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="gdesc" id="gdesc" class="form-control" placeholder="Enter description..." onkeyup="validatename(this.id)">
								</div>
								<br/>
