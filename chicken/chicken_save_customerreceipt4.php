...
$file_name = "chicken_display_customerreceipt4.php"; $sms_type = "WappKey"; $wapp_ptrn = "Normal";
...
for($i = 0;$i < $dsize;$i++){
    ...
    VALUES ('$incr','$prefix','$trnum','$date[$i]','$ccode[$i]','$smtype','$mode[$i]','$code[$i]','$amount1[$i]','$tcds_per[$i]','$tcds_amt[$i]','$amount[$i]','$vtype','$warehouse','$remarks[$i]','$flag','$active','$tdflag','$pdflag','$trtype','$trlink','$addedemp','$addedtime','$addedtime')";
