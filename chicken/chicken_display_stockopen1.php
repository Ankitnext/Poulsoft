<?php
//chicken_display_stockopen1.php
    ...
    <html>
		...
		<section class="content-header">
			<ol class="breadcrumb">
				...
				<li class="active">Create Stock Opening</li>
			</ol>
			<h1>Stock Opening</h1>
		</section><br/>
                    ...
                    <div class="box">
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php
                                    // Main Contact Details Column Creation
                                    ...
                                    $sql = "SELECT * FROM `item_stock_opening` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `dflag` = '0' ORDER BY `date` ASC";
