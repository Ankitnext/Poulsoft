    ...
    <html>
		...
		<section class="content-header">
            ...
            <div class="row" style="margin: 10px 10px 0 10px;">
                ...
                <div align="right">
                    <?php /*if($acs_edit_flag == 1){ ?><button type="button" class="btn btn-info" id="editpage" value="chicken_edit_pursale4m.php" onclick="add_page(this.id)" ><i class="fa fa-align-left"></i> Edit Multiple</button><?php }*/ ?>
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                    ...
                                    if(in_array("line_sexp", $existing_col_names, TRUE) == ""){ $sql = "ALTER TABLE `pur_purchase` ADD `line_sexp` DECIMAL(20,5) NULL DEFAULT NULL AFTER `balance`"; mysqli_query($conn,$sql); }
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $sup_name[$row['customercode']]; ?></td>
