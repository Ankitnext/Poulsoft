<?php
//chicken_display_vehfuel_fills.php
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
									<tr>
                                        ...
                                        <th>Vehicle No.</th>
										<th>Driver Name</th>
										<th>Meter P. Reading</th>
										<th>Meter Current Reading</th>
										<th>Fuel Type</th>
										<th>Fuel In Ltrs</th>
										<th>Price</th>
										<th>Amount</th>
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM `vehicle_fuelfilling` WHERE `active`='1' AND `dflag`='0'";
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $vno_name[$row['vno']]; ?></td>
                                        <td><?php echo $drv_name[$row['driver']]; ?></td>
										<td><?php echo $row['reading']; ?></td>
										<td><?php echo $row['cur_reading']; ?></td>
										<td><?php echo $row['fueltype']; ?></td>
										<td><?php echo $row['fuel_lt']; ?></td>
