    ...
    <html>
        ...
        <body>
            <div class="card border-secondary mb-3">
                <div class="card-header">Add Shop Price</div>
                <form action="chicken_save_shopprice1.php" method="post" onsubmit="return checkval();">
                    <div class="ml-5 card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-1">
                                ...
                                <select name="warehouse" id="warehouse" class="form-control select2" style="width: 200px;"><option value="select">-All-</option><?php foreach($sector_code as $cc){ ?><option value="<?php echo $sector_code[$cc]; ?>"><?php echo $sector_name[$cc]; ?></option><?php } ?></select> 
                            </div>
                        </div>
                        <div class="row">
                            <table>
