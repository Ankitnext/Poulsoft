	...
	<body class="hold-transition skin-blue sidebar-mini">
										...
										<table style="line-height:30px;" id="tab3">
                                            ...
                                            <tbody id="row_body">
                                                ...
                                                <tr id="row_no[<?php echo $i; ?>]" style="margin:5px 0px 5px 0px;">
													<td style="width: 180px;padding-right:20px;"><select name="scat[]" id="scat[<?php echo $i; ?>]" class="form-control select2" style="width: 100%;" onchange="chk_itemtype();"><?php foreach($item_code as $ic){ ?><option value="<?php echo $ic."@".$item_name[$ic]; ?>" <?php if($ic == $icode[$i]){ echo "selected"; } ?>><?php echo $item_name[$ic]; ?></option><?php } ?></select></td>
													...
													<?php } ?>
													<td style="width: 90px;padding-right:20px;"><input type="text" style="width: 90px;" name="iprice[]" id="iprice[<?php echo $i; ?>]" class="form-control text-right" value="<?php echo $price[$i]; ?>" onkeyup="validatenum(this.id);calculatetotal(this.id);" onchange="validateamount(this.id);"></td>
		...
		<script>
			...
			function create_row(a){
				...
				html += '<td style="width: 180px;padding-right:20px;"><select name="scat[]" id="scat['+d+']" class="form-control select2"  style="width: 100%;"  onchange="chk_itemtype();"><?php foreach($item_code as $ic){ ?><option value="<?php echo $ic."@".$item_name[$ic]; ?>"><?php echo $item_name[$ic]; ?></option><?php } ?></select></td>';
				...
				html += '<td  style="width: 90px;padding-right:20px;"><input type="text"  style="width: 90px;" name="iprice[]" id="iprice['+d+']" class="form-control text-right" onkeyup="validatenum(this.id);calculatetotal(this.id);" onchange="validateamount(this.id);"></td>';
