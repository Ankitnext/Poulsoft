									...
									<table style="width:100%;line-height:30px;" id="tab3" align="center">
										<thead>
											...
											<tr style="line-height:30px;">
												...
												<td><input type="text" name="pdate[]" id="pdate[0]"class="form-control crdr_datepickers" value="<?php echo $fdate; ?>" readonly></td>
												<td><input type="text" name="dcno[]" id="dcno[0]" class="form-control" style="width:80px;" ></td>
												<td><select name="mode[]" id="mode[0]" class="form-control select2" style="width:100%"><option value="select">select</option> <?php foreach($acode as $fcode){ ?> <option value="<?php echo $acode[$fcode]; ?>"><?php echo $adesc[$fcode]; ?></option> <?php } ?> </select></td>
												...
												<td><select name="sector[]" id="sector[0]" class="form-control select2" style="width:100%"> <?php foreach($wcode as $fcode){ ?> <option value="<?php echo $wcode[$fcode]; ?>"><?php echo $wdesc[$fcode]; ?></option> <?php } ?> </select></td>
		...
		<script>
			...
			function rowgen(a){
				...
				html+= '<tr style="line-height:30px;">';
					...
					html+= '<td><input type="text" name="pdate[]" id="pdate['+d+']" class="form-control crdr_datepickers" value="<?php echo $fdate; ?>" onmouseover="crdr_displaycalendor()" readonly></td>';
					html+= '<td><input type="text" name="dcno[]" id="dcno['+d+']" class="form-control" style="width:80px;"></td>';
					html+= '<td><select name="mode[]" id="mode['+d+']" class="form-control select2" style="width:100%"> <option value="select">select</option> <?php foreach($acode as $fcode){ ?> <option value="<?php echo $acode[$fcode]; ?>"><?php echo $adesc[$fcode]; ?></option> <?php } ?> </select></td>';
					...
					html+= '<td><select name="sector[]" id="sector['+d+']" class="form-control select2" style="width:100%"> <?php foreach($wcode as $fcode){ ?> <option value="<?php echo $wcode[$fcode]; ?>"><?php echo $wdesc[$fcode]; ?></option> <?php } ?> </select></td>';
