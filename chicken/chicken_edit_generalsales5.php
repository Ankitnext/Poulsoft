<?php
//chicken_edit_generalsales5.php
...
?>
    <html>
        ...
        <body>
            <?php
            $ids = $_GET['trnum'];
            $sql = "SELECT * FROM `customer_sales` WHERE `invoice` = '$ids' AND `flag` = '0' AND `tdflag` = '0' AND `pdflag` = '0' AND `trlink` = 'chicken_display_generalsales5.php'";
            ...
            <div class="card border-secondary mb-3">
                ...
                <form action="chicken_modify_generalsales5.php" method="post" onsubmit="return checkval();">
                    <div class="card-body">
                            ...
                            <table align="center">
                                ...
                                <?php $incr = $c; for($c = 0;$c <= $incr;$c++){  ?>
                                    <tr style="margin:5px 0px 5px 0px;" id="row_no[<?php echo $c; ?>]">
                                        ...
                                        <?php
                                        if((int)$jals_flag == 1){ echo '<td><input type="text" name="jals[]" id="jals['.$c.']" class="form-control text-right" value="'.$jals[$c].'" style="width:90px;" onkeyup="validate_num(this.id);calculate_final_totalamt();" onchange="validate_amount(this.id);" /></td>'; }
                                        if((int)$birds_flag == 1){ echo '<td><input type="text" name="birds[]" id="birds['.$c.']" class="form-control text-right" value="'.$birds[$c].'" style="width:90px;" onkeyup="validate_num(this.id);calculate_final_totalamt();" onchange="validate_amount(this.id);" /></td>'; }
                                        if((int)$tweight_flag == 1){ echo '<td><input type="text" name="tweight[]" id="tweight['.$c.']" class="form-control text-right" value="'.$totalweight[$c].'" style="width:90px;" onkeyup="validate_num(this.id);calculate_final_totalamt();" onchange="validate_amount(this.id);" /></td>'; }
                                        if((int)$eweight_flag == 1){ echo '<td><input type="text" name="eweight[]" id="eweight['.$c.']" class="form-control text-right" value="'.$emptyweight[$c].'" style="width:90px;" onkeyup="validate_num(this.id);calculate_final_totalamt();" onchange="validate_amount(this.id);" /></td>'; }
                                        ?>
                                        ...
                                        <td><input type="text" name="amount[]" id="amount[<?php echo $c; ?>]" class="form-control text-right" value="<?php echo $amount[$c]; ?>" style="width:90px;" onkeyup="validate_num(this.id);calculaterate(this.id);" onchange="validate_amount(this.id);calculaterate(this.id);calculate_final_totalamt();" /></td>
            ...
            <script>
                function return_back(){
                    window.location.href = "chicken_display_generalsales5.php";
                }
                ...
                function create_row(a){
                    ...
                    html += '<td><input type="text" name="amount[]" id="amount['+d+']" class="form-control text-right" style="width:90px;" onkeyup="validate_num(this.id);" onchange="validate_amount(this.id);calculaterate(this.id);" /></td>';
