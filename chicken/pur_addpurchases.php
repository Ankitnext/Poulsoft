	...
	<body class="hold-transition skin-blue sidebar-mini">
										...
										<table style="line-height:30px;" id="tab3">
                                            ...
                                            <tbody id="row_body">
												<tr style="margin:5px 0px 5px 0px;">
													<td style="width: 180px;padding-right:20px;text-align:Left;"><select name="scat[]" id="scat[0]" class="form-control select2" style="width: 100%;" onchange="calculatetotal(this.id);"><?php foreach($item_code as $ic){ ?><option value="<?php echo $ic."@".$item_name[$ic]."@".$item_cname[$item_cat[$ic]]; ?>"><?php echo $item_name[$ic]; ?></option><?php } ?></select></td>
													...
													<td style="width: 90px;padding-right:20px;"><input style="width: 90px;" type="text" name="iprice[]" id="iprice[0]" class="form-control text-right" onkeyup="validatenum(this.id);calculatetotal(this.id);" onchange="validateamount2(this.id);"></td>
		...
		<script>
			...
			function create_row(a){
				...
				html += '<td style="width: 180px;padding-right:20px;"><select name="scat[]" id="scat['+d+']" class="form-control select2" style="width: 100%;" onchange="calculatetotal(this.id);"><?php foreach($item_code as $ic){ ?><option value="<?php echo $ic."@".$item_name[$ic]."@".$item_cname[$item_cat[$ic]]; ?>"><?php echo $item_name[$ic]; ?></option><?php } ?></select></td>';
				...
				html += '<td style="width: 90px;padding-right:20px;"><input style="width: 90px;" type="text" name="iprice[]" id="iprice['+d+']" class="form-control text-right" onkeyup="validatenum(this.id);calculatetotal(this.id);" onchange="validateamount2(this.id);"></td>';
