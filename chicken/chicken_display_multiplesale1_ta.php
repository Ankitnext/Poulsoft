<?php
//chicken_display_multiplesale1_ta.php
    ...
    <html>
		...
		<section class="content-header">
            ...
            <div class="row" style="margin: 10px 10px 0 10px;">
                ...
                <div align="right">
                    <?php if($edt_flag == 1){ ?><button type="button" class="btn btn-info" id="editpage" value="chicken_edit_multiplesale1_tam.php" onclick="add_page(this.id)" ><i class="fa fa-align-left"></i> Edit Multiple</button><?php } ?>
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                    ...
                                    if(in_array("whatsapp_keygenerate_master", $exist_tbl_names, TRUE) == ""){ $sql1 = "CREATE TABLE $database_name.whatsapp_keygenerate_master LIKE poulso6_admin_broiler_broilermaster.whatsapp_keygenerate_master;"; mysqli_query($conn,$sql1); }
