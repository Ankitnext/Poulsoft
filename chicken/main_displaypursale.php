<?php
	...
	if($_GET['cid'] == "" && $_SESSION['disppursale'] != ""){ $cid = $_SESSION['disppursale']; } else if($_GET['cid'] != "" && $_SESSION['disppursale'] == ""){ $cid = $_GET['cid']; $_SESSION['disppursale'] = $cid; } else { $cid = $_GET['cid']; $_SESSION['disppursale'] = $cid; }
...
<html>
	<body class="hold-transition skin-blue sidebar-mini">
		...
		<form action="main_displaypursale.php?cid=<?php echo $cid; ?>" method="post">
			...
			<div class="row">
				<div class="col-lg-19">
					...
					<?php
						...
						$sql = "SELECT * FROM `customer_sales` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `trtype` = 'PST' AND `tdflag` = '0' AND `pdflag` = '0' ORDER BY `id` DESC"; $query = mysqli_query($conn,$sql);
					?>
