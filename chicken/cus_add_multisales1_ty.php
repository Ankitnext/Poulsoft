	...
	<body class="hold-transition skin-blue sidebar-mini">
			...
			?>
				...
				<div class="box-body">
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-18">
								<form action="cus_save_multisales1_ty.php" method="post" role="form" onsubmit="return checkval()">
									...
									<div class="col-md-12">
										<table style="line-height:30px;" id="tab3">
											<tr style="line-height:30px;">
                                                ...
                                                <th  style="width: 100px;padding-right:10px;"><label>T. Cost</label></th>
											...
											<tr style="margin:5px 0px 5px 0px;" id="row_id[0]">
												...
												<td style="width: 120px;padding-right:10px;"><select name="scat[]" id="scat[0]" class="form-control select2"  style="width: 120px;" onchange="calculatetotal(this.id);fetchprice(this.id);"><?php foreach($itype as $ic){ ?><option value="<?php echo $itype[$ic]."@".$itypes[$ic]; ?>"><?php echo $itypes[$ic]; ?></option><?php } ?></select></td>
												<td <?php if($ifjbwen == 1 || $ifjbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" style="width: 80px;" name="jval[]" id="jval[0]" value="0" class="form-control" onchange="validatebirds(this.id);calculatetotal(this.id);calfinaltotal();emptyval();" onkeyup="validatebirds(this.id);" /></td>
												<td <?php if($ifjbwen == 1 || $ifjbw == 1 || $ifbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" style="width: 80px;" name="bval[]" id="bval[0]" value="0" class="form-control" onkeyup="validatebirds(this.id);" onchange="validatebirds(this.id);calculatetotal(this.id);calfinaltotal();" /></td>
												<td <?php if($ifjbwen == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" style="width: 80px;" name="wval[]" id="wval[0]" value="0" class="form-control" onchange="validateamount(this.id)" onkeyup="validatenum(this.id);calculatetotal(this.id);calfinaltotal();" /></td>
												<td <?php if($ifjbwen == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" style="width: 80px;" name="ewval[]" id="ewval[0]" value="0" class="form-control" onkeyup="validatenum(this.id);" onchange="validateamount(this.id);calculatetotal(this.id);calfinaltotal();" /></td>
												<td style="width: 80px;padding-right:10px;"><input type="text" name="nwval[]" id="nwval[0]" style="width: 80px;" value="0" class="form-control" onchange="validateamount(this.id);" onkeyup="validatenum(this.id);calculatetotal(this.id);calfinaltotal();" /></td>
                                                ...
                                                <td style="width: 100px;padding-right:10px;"><input type="text" name="tcost[]" id="tcost[0]" style="width: 100px;" class="form-control"></td>
									   ...
									   <div class="col-md-12" align="left" style="padding-left:290px">
										...
										<table style="line-height:30px;"> 
											<tr style="line-height:30px;">
												...
												<th <?php if($ifjbwen == 1 || $ifjbw == 1 || $ifbw == 1){ echo $ndisplay; } else { echo $ndisplay; } ?>><label>Total Birds1</label></th>
												...
												<th  <?php  echo $ndisplay; ?>><label>Total N. Weight1</label></th>
												<th  style="width: 80px;padding-right:10px;"><label>Total N. Weight</label></th>
		...
		<script>
			...
			function rowgen(a){
				...
				html+= '<td style="width: 120px;padding-right:10px;"><select name="scat[]" id="scat['+c+']" class="form-control select" style="width: 120px;" onchange="calculatetotal(this.id);fetchprice(this.id);"><?php foreach($itype as $ic){ ?><option value="<?php echo $itype[$ic]."@".$itypes[$ic]; ?>"><?php echo $itypes[$ic]; ?></option><?php } ?></select></td>';
				html+= '<td <?php if($ifjbwen == 1 || $ifjbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" style="width: 80px;"  name="jval[]" id="jval['+c+']" value="0" class="form-control" onkeyup="validatebirds(this.id);" onchange="validatebirds(this.id);calculatetotal(this.id);calfinaltotal();emptyval();" onkeyup="validatebirds(this.id);" /></td>';
				html+= '<td <?php if($ifjbwen == 1 || $ifjbw == 1 || $ifbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" style="width: 80px;"  name="bval[]" id="bval['+c+']" value="0" class="form-control" onkeyup="validatebirds(this.id);" onchange="validatebirds(this.id);calculatetotal(this.id);calfinaltotal();" /></td>';
				html+= '<td <?php if($ifjbwen == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" style="width: 80px;"  name="wval[]" id="wval['+c+']" value="0" class="form-control" onchange="validateamount(this.id);" onkeyup="validatenum(this.id);calculatetotal(this.id);calfinaltotal();" /></td>';
				html+= '<td <?php if($ifjbwen == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" style="width: 80px;"  name="ewval[]" id="ewval['+c+']" value="0" class="form-control" onkeyup="validatenum(this.id);" onchange="validateamount(this.id);calculatetotal(this.id);calfinaltotal();" /></td>';
				html+= '<td style="width: 80px;padding-right:10px;"><input type="text" style="width: 80px;" name="nwval[]" id="nwval['+c+']" value="0" class="form-control" onchange="validateamount(this.id);" onkeyup="calculatetotal(this.id);calfinaltotal();" /></td>';
                ...
                html+= '<td style="width: 100px;padding-right:10px;"><input type="text" name="tcost[]" id="tcost['+c+']" style="width: 100px;" class="form-control"></td>';
