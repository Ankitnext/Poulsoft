...
$sql_customer_sales = "UPDATE `customer_sales` SET `date` = '$date', `bookinvoice` = '$bno', `customercode` = '$cus_code', `jals` = '$jals', `totalweight` = '$totalweight', `emptyweight` = '$emptyweight', `itemcode` = '$itemcode', `birds` = '$birds', `netweight` = '$netweight', `itemprice` = '$cus_iprice', `totalamt` = '$cus_tamt', `roundoff` = '$cus_roundoff', `finaltotal` = '$cus_ftotal', `balance` = '$cus_ftotal', `amtinwords` = '$cus_amtinwds', `trtype` = 'PST', `warehouse` = '$warehouse', `flag` = '0', `authorization` = '0', `tdflag` = '0', `pdflag` = '0', `drivercode` = '$driver', `vehiclecode` = '$vehicle', `discounttype` = '0.00', `discountvalue` = '0.00', `taxtype` = '0.00', `taxvalue` = '0.00', `discountamt` = '0.00', `taxamount` = '0.00', `taxcode` = '0.00', `discountcode` = '0.00', `remarks` = '$remarks', `sms_sent` = '$sms_code', `updatedemp` = '$addedemp', `updated` = '$addedtime', `client` = '$client' WHERE `invoice` = '$id[0]'";
...
if(!mysqli_query($conn, $sql_pur_purchase)) {
	...
	header('location:chicken_display_pursale2.php');
}
else{
	header('location:chicken_display_pursale2.php');
}
