<?php
//chicken_edit_customerreceipt3.php
    ...
    <html>
        ...
        <body>
            ...
            <div class="card border-secondary mb-3">
                ...
                <form action="chicken_modify_customerreceipt3.php" method="post" onsubmit="return checkval();">
                    <div class="card-body">
                        <div class="row">
                            <table align="center">
                                <thead>
            ...
            <script>
                function return_back(){
                    window.location.href = "chicken_display_customerreceipt3.php";
                }
                function checkval(){
