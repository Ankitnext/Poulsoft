<?php
//chicken_display_generalpurchase9.php
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                    ...
                                    $delete_link = $acs_delete_url."?utype=edit&trnum=";
                                    $sql = "SELECT * FROM `pur_purchase` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `trlink` LIKE '$href' ORDER BY `date` ASC";
