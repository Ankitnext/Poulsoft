<?php
//chicken_display_shortagescreen.php
    ...
    <html>
		...
		<section class="content-header">
			<ol class="breadcrumb">
				...
				<li class="active">Display Shoratge Screen</li>
			</ol>
			<h1>Shoratge Screen</h1>
		</section><br/>
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM `item_shortage_screen` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `trlink` LIKE '$href' AND `dflag` = '0' ORDER BY `date`,`trnum` ASC";
                                    ...
                                    <tr>
										...
										<td><?php echo ucfirst($row['a_type']); ?></td>
										<td><?php echo $sec_name[$row['warehouse']]; ?></td>
