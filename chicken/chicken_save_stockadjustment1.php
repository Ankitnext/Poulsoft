<?php
//chicken_save_stockadjustment1.php
...
$trtype = "stockadjustment1";
$trlink = "chicken_display_stockadjustment1.php";
...
for($i = 0;$i < $dsize;$i++){
    ...
    $trno_dt1 = generate_transaction_details($date[$i],"stockadjustment1","SADJ","generate",$_SESSION['dbase']);
    ...
    $sql = "INSERT INTO `item_stock_adjustment` (`incr`,`prefix`,`trnum`,`date`,`warehouse`,`a_type`,`itemcode`,`jals`,`birds`,`nweight`,`price`,`amount`,`remarks`,`flag`,`active`,`dflag`,`trtype`,`trlink`,`addedemp`,`addedtime`,`updatedtime`) 
...
header('location:chicken_display_stockadjustment1.php?ccid='.$ccid);
