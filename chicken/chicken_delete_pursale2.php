...
if(x == true){
	window.location.href = "chicken_display_pursale2.php";
}
else if(x == false) {
	window.location.href = "chicken_display_pursale2.php";
}
	...
	if(!mysqli_query($conn,$sql)){ die("Error:-".mysqli_error($conn)); } else { header('location:chicken_display_pursale2.php'); }
