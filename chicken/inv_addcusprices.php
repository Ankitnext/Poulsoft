<?php
//inv_addcusprices.php
	session_start(); include "newConfig.php";
	include "header_head.php";
	$cid = $_SESSION['dcusprices'];
	$dbname = $_SESSION['dbase'];
	$sql = "SELECT * FROM `item_details` WHERE `active` = '1' ORDER BY `description` ASC"; $query = mysqli_query($conn,$sql);
	while($row = mysqli_fetch_assoc($query)){ $item_code[$row['code']] = $row['code']; $item_name[$row['code']] = $row['description']; }
	$sql = "SELECT * FROM `item_details` WHERE `description` LIKE 'Broiler Bird%' AND `active` = '1' ORDER BY `description` ASC"; $query = mysqli_query($conn,$sql);
	...
	<body class="hold-transition skin-blue sidebar-mini">
		...
		<section class="content">
			<div class="box box-default">
				<div class="box-body">
					<div class="col-md-12">
						<form action="inv_updatecusprices.php" method="post" onsubmit="return checkval()" name="form_name" id = "form_id" >
							<div class="row">
									...
									<table class="table1" style="width:50%;">
										<thead>
											<tr>
												...
												<th <?php if($cus_disc_days_flag == 0){ echo "style='text-align:center;display:none;'"; } else{ echo "style='text-align:center;'"; } ?>><label>Days<b style="color:red;">&nbsp;*</b></label></th>
												<th <?php if($cus_disc_days_flag == 0){ echo "style='text-align:center;display:none;'"; } else{ echo "style='text-align:center;'"; } ?>><label>Type<b style="color:red;">&nbsp;*</b></label></th>
												<th <?php if($cus_disc_days_flag == 0){ echo "style='text-align:center;display:none;'"; } else{ echo "style='text-align:center;'"; } ?>><label>Add/Deduct Price<b style="color:red;">&nbsp;*</b></label></th>
												<th <?php if($cus_jalsfreight_flag == 0){ echo "style='text-align:center;display:none;'"; } else{ echo "style='text-align:center;'"; } ?>><label>Freight per Jals<b style="color:red;">&nbsp;*</b></label></th>
										...
										<tbody id="tbody">
											<tr>
												...
												<td><div class="form-group col-md-12"><select name="idesc0" id="idesc_0" class="form-control select" style="width:150px;"><option value="select">select</option><?php foreach($item_code as $ucode){ ?><option value="<?php echo $ucode; ?>" <?php if($bird_code == $ucode){ echo "selected"; } ?>><?php echo $item_name[$ucode]; ?></option><?php } ?></select></div></td>
												<td><div class="form-group col-md-6"><select name="ptype0" id="ptype0" class="form-control select" style="width:150px;"><option value="select">select</option><option value="A">Add</option><option value="D" selected>Deduct</option><option value="F">Fixed</option><option value="M">Multiply</option></select></div></td>
												...
												<td <?php if($cus_disc_days_flag == 0){ echo $ndisplay; } ?>><div class="form-group col-md-6"><select name="days0" id="days0" class="form-control select" style="width:120px;"><option value="none">None</option><option value="Sunday">Sunday</option><option value="Monday">Monday</option><option value="Tuesday">Tuesday</option><option value="Wednesday">Wednesday</option><option value="Thursday">Thursday</option><option value="Friday">Friday</option><option value="Saturday">Saturday</option></select></div></td>
												<td <?php if($cus_disc_days_flag == 0){ echo $ndisplay; } ?>><div class="form-group col-md-6"><select name="days_ptype0" id="days_ptype0" class="form-control select" style="width:120px;"><option value="select">select</option><option value="A">Add</option><option value="D" selected>Deduct</option></select></div></td>
												<td <?php if($cus_disc_days_flag == 0){ echo $ndisplay; } ?>><div class="form-group col-md-6"><input type="text" name="days_iprice0" id="days_iprice0" class="form-control" style="width:100px;" onkeyup="validatenum(this.id)" onchange="validateamount(this.id)" /></div></td>
												<td <?php if($cus_jalsfreight_flag == 0){ echo $ndisplay; } ?>><div class="form-group col-md-6"><input type="text" name="freight_perjals0" id="freight_perjals0" class="form-control" style="width:100px;" onkeyup="validatenum(this.id)" onchange="validateamount(this.id)" /></div></td>
		...
		<script>
			function rowgen(){
				...
				html+= '<td><div class="form-group col-md-12"><select name="idesc'+a+'" id="idesc_'+a+'" class="form-control select" style="width:150px;"><option value="select">select</option><?php foreach($item_code as $ucode){ ?><option value="<?php echo $ucode; ?>" <?php if($bird_code == $ucode){ echo "selected"; } ?>><?php echo $item_name[$ucode]; ?></option><?php } ?></select></div></td>';
				html+= '<td><div class="form-group col-md-6"><select name="ptype'+a+'" id="ptype'+a+'" class="form-control select" style="width:150px;"><option value="select">select</option><option value="A">Add</option><option value="D" selected>Deduct</option><option value="F">Fixed</option><option value="M">Multiply</option></select></div></td>';
				...
				html+= '<td <?php if($cus_disc_days_flag == 0){ echo $ndisplay; } ?>><div class="form-group col-md-6"><select name="days'+a+'" id="days'+a+'" class="form-control select" style="width:120px;"><option value="none">None</option><option value="Sunday">Sunday</option><option value="Monday">Monday</option><option value="Tuesday">Tuesday</option><option value="Wednesday">Wednesday</option><option value="Thursday">Thursday</option><option value="Friday">Friday</option><option value="Saturday">Saturday</option></select></div></td>';
				html+= '<td <?php if($cus_disc_days_flag == 0){ echo $ndisplay; } ?>><div class="form-group col-md-6"><select name="days_ptype'+a+'" id="days_ptype'+a+'" class="form-control select" style="width:120px;"><option value="select">select</option><option value="A">Add</option><option value="D" selected>Deduct</option></select></div></td>';
				html+= '<td <?php if($cus_disc_days_flag == 0){ echo $ndisplay; } ?>><div class="form-group col-md-6"><input type="text" name="days_iprice'+a+'" id="days_iprice'+a+'" class="form-control" style="width:100px;" onkeyup="validatenum(this.id)" onchange="validateamount(this.id)" /></div></td>';
				html+= '<td <?php if($cus_jalsfreight_flag == 0){ echo $ndisplay; } ?>><div class="form-group col-md-6"><input type="text" name="freight_perjals'+a+'" id="freight_perjals'+a+'" class="form-control" style="width:100px;" onkeyup="validatenum(this.id)" onchange="validateamount(this.id)" /></div></td>';
