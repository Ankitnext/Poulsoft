<?php
//chicken_display_generalsales6.php
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM `customer_sales` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `tdflag` = '0' AND `pdflag` = '0' AND ( `trlink` LIKE '$href' OR `trlink` IS NULL ) ORDER BY `date` ASC";
