<?php
//chicken_save_customerreceipt1.php
...
$file_name = "chicken_display_customerreceipt1.php"; $sms_type = "WappKey"; $wapp_ptrn = "Normal";
...
$trlink = "chicken_display_customerreceipt1.php";
