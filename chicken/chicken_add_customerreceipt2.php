<?php
//chicken_add_customerreceipt2.php
    ...
    <html>
        ...
        <body>
            <div class="card border-secondary mb-3">
                ...
                <form action="chicken_save_customerreceipt2.php" method="post" onsubmit="return checkval();">
                    <div class="card-body">
                        <div class="row">
                            <table align="center">
                                <thead>
                                ...
                                <tbody id="row_body">
                                    <tr style="margin:5px 0px 5px 0px;">
                                        ...
                                        <td><select name="sector[]" id="sector[0]" class="form-control select2" style="width:180px;"><?php foreach($sector_code as $scode){ ?><option value="<?php echo $scode; ?>" <?php echo ($st_code == $scode) ? 'selected' : ''; ?>><?php echo $sector_name[$scode]; ?></option><?php } ?></select></td>
                                        <td><input type="text" name="discount[]" id="discount[0]" class="form-control text-right" style="width:100px;" /></td>
            ...
            <script>
                ...
                function create_row(a){
                    ...
                    html += '<td><select name="sector[]" id="sector['+d+']" class="form-control select2" style="width:180px;"><?php foreach($sector_code as $scode){ ?><option value="<?php echo $scode; ?>" <?php echo ($st_code == $scode) ? 'selected' : ''; ?>><?php echo $sector_name[$scode]; ?></option><?php } ?></select></td>';
                    html += '<td><input type="text" name="discount[]" id="discount['+d+']" class="form-control text-right" style="width:100px;" /></td>';
