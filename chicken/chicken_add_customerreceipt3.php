<?php
//chicken_add_customerreceipt3.php
    ...
    <html>
        ...
        <body>
            <div class="card border-secondary mb-3">
                ...
                <form action="chicken_save_customerreceipt3.php" method="post" onsubmit="return checkval();">
                    <div class="card-body">
                        <div class="row">
                            <table align="center">
                                <thead>
                ...
                function checkval(){
                    ...
                    for(var d = 0;d <= incr;d++){
                        if(l == true){
                            ...
                            if(d > 0 && parseFloat(amount1) == 0){ destroy_row("amount1["+d+"]"); }
                            else{
                                if(date == ""){
