<?php
//chicken_import_customerreceipt1.php
    ...
    <html>
        ...
        <body>
            <div class="card border-secondary mb-3">
                <div class="card-header">Import Receipt</div>
                <form action="chicken_import_customerreceipt1.php" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                            <table align="center">
                                <thead>
                                    <tr>
                                        <td>
                                            <a href="ChickenModule-customer_receipt_import.xlsx" id="download_file" download title="download">
                                                <img src="../images/Excel-Icon_1.png" height="40px"/>Download Format&ensp;
                                            </a>
                                        </td>
                                        <th>Upload Customer Receipt-Excel</th>
                                        <td>
                ...
                if (!empty($_FILES['file_uploads']['name'])) {
                    ...
                    if (in_array($file_ext, $allowed_ext)) {
                        ...
                        for($col = 0;$col < $col_cno;$col++){
                            ...
                            if ($hname == "Date") { $heading_name[$col] = "date"; $html .= '<th style="text-align:center;">Date<b style="color:red;">&nbsp;*</b></th>'; $incr++; }
                            else if ($hname == "Customer") { $heading_name[$col] = "customer"; $html .= '<th style="text-align:center;">Customer<b style="color:red;">&nbsp;*</b></th>'; $incr++; }
                            else if ($hname == "Mode") { $heading_name[$col] = "mode"; $html .= '<th style="text-align:center;">Mode<b style="color:red;">&nbsp;*</b></th>'; $incr++; }
                            else if ($hname == "Cash/Bank") { $heading_name[$col] = "method"; $html .= '<th style="text-align:center;">Cash/Bank<b style="color:red;">&nbsp;*</b></th>'; $incr++; }
                            else if ($hname == "Amount") { $heading_name[$col] = "amount"; $html .= '<th style="text-align:center;">Amount<b style="color:red;">&nbsp;*</b></th>'; $incr++; }
                            else if ($hname == "Doc No.") { $heading_name[$col] = "docno"; $html .= '<th style="text-align:center;">Doc No.</th>'; $incr++; }
                            else if ($hname == "Sector") { $heading_name[$col] = "sector"; $html .= '<th style="text-align:center;">Sector<b style="color:red;">&nbsp;*</b></th>'; $incr++; }
                            else if ($hname == "Remarks") { $heading_name[$col] = "remarks"; $html .= '<th style="text-align:center;">Remarks</th>'; $incr++; }
                        }
                        $html .= '</tr>';
                        ...
                        for($row = 2;$row <= $act_rows;$row++){
                            ...
                            for($col = 0;$col < $col_cno;$col++){
                                ...
                                else if ($heading_name[$col] == "customer") {
                                    $html .= '<td><select name="ccode[]" id="ccode['.$cincr.']" class="form-control select2">';
                                    $html .= '<option value="select">-select-</option>';
                                    foreach ($cus_code as $code => $name) {
                                        $selected = (strtolower($hvalue) == strtolower($cus_name[$code])) ? 'selected' : '';
                                        $html .= '<option value="' . $code . '" ' . $selected . '>' . $cus_name[$code] . '</option>';
                                    }
                                    $html .= '</select></td>';
                                }
                        ...
                        if($cincr > 0){ $cincr--; }
                ?>
                <form action="chicken_import_save_customerreceipt1.php" method="post" onsubmit="return checkval();">
                    <div class="card-body">
                        <div class="row">
                            <table>
                                <?php echo $html; ?>
            ...
            <script>
                function return_back(){
                    window.location.href = "chicken_display_customerreceipt1.php";
                }
                function checkval(){
