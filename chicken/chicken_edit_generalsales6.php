<?php
//chicken_edit_generalsales6.php
    ...
    <html>
        ...
        <body>
            ...
            <div class="card border-secondary mb-3">
                ...
                <form action="chicken_modify_generalsales6.php" method="post" onsubmit="return checkval();">
                    <div class="card-body">
                            ...
                            <table align="center">
                                ...
                                <?php $incr = $c; for($c = 0;$c <= $incr;$c++){  ?>
                                    <tr style="margin:5px 0px 5px 0px;" id="row_no[<?php echo $c; ?>]">
                                        ...
                                        <?php
                                        $colIndex = 1;
                                        if((int)$jals_flag == 1){ echo '<td><input type="text" name="jals[]" id="jals['.$c.']" class="form-control text-right" data-row="'.$c.'" data-col="'.$colIndex++.'" value="'.$jals[$c].'" style="width:90px;" onkeyup="validate_count(this.id);calculate_final_totalamt();" /></td>'; }
                                        if((int)$birds_flag == 1){ echo '<td><input type="text" name="birds[]" id="birds['.$c.']" class="form-control text-right" data-row="'.$c.'" data-col="'.$colIndex++.'" value="'.$birds[$c].'" style="width:90px;" onkeyup="validate_count(this.id);calculate_final_totalamt();" /></td>'; }
                                        ...
                                        <td><input type="text" name="price[]" id="price[<?php echo $c; ?>]" class="form-control text-right" data-row="<?php echo $c; ?>" data-col="<?php echo $colIndex++; ?>" value="<?php echo $price[$c]; ?>" style="width:90px;" onkeyup="validate_num(this.id);calculate_final_totalamt();check_nrow(this.id);" onchange="validate_amount(this.id);" /></td>
                                        ...
                                        <th colspan="<?php echo $colspan; ?>" style="padding-top:0px;text-align:right;">
                                            <table align="right">
                                                <tr>
                                                    <th>
                                                        <label>Remarks</label>
                                                        <textarea name="remarks" id="remarks" class="form-control" style="height:75px;width:450px;"><?php echo $remarks;?></textarea>
                                                    </th>
                                    ...
                                    <tr style="">
                                        <th colspan="<?php echo $colspan; ?>" style="padding-top:0px;text-align:right;">
                                            <table align="right">
                                                <tr>
                                                    <th>
                                                    <button type="submit" name="sub_pt" id="sub_pt" class="btn btn-sm text-white bg-success" >Update & Print</button>&ensp;
            ...
            <script>
                function printSave() {
                    window.location.href = "chicken_generate_saleinv_print1_ta.php?trnum=<?php echo $trnum ?>";
                }
                ...
                function create_row(a){
                    ...
                    if(parseInt(jals_flag) == 1){ html += '<td><input type="text" name="jals[]" id="jals['+d+']" class="form-control text-right" data-row="'+d+'" data-col="'+(colIndex++)+'" style="width:90px;" onkeyup="validate_count(this.id);calculate_final_totalamt();" /></td>'; }
                    if(parseInt(birds_flag) == 1){ html += '<td><input type="text" name="birds[]" id="birds['+d+']" class="form-control text-right" data-row="'+d+'" data-col="'+(colIndex++)+'" style="width:90px;" onkeyup="validate_count(this.id);calculate_final_totalamt();" /></td>'; }
                    ...
                    html += '<td><input type="text" name="price[]" id="price['+d+']" class="form-control text-right" data-row="'+d+'" data-col="'+(colIndex++)+'" style="width:90px;" onkeyup="validate_num(this.id);calculate_final_totalamt();check_nrow(this.id);" onchange="validate_amount(this.id);" /></td>';
