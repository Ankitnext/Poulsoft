...
for($i = 0;$i < $dsize;$i++){
    ...
    $trno_dt1 = generate_transaction_details($date[$i],"debit","DBIT","generate",$_SESSION['dbase']);
    ...
    VALUES ('$incr','$prefix','$trnum','supplier','$date[$i]','$company[$i]','$itemcode[$i]','$quantity[$i]','$price[$i]','$amount[$i]','1','0','0','$trtype','$trlink','$addedemp','$addedtime','$addedtime')";
