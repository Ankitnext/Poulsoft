<?php
//chicken_display_generalsale10.php
    ...
    <html>
		...
		<section class="content-header">
			<ol class="breadcrumb">
				...
				<li><a href="#">CoA</a></li>
				<li class="active">Create Feed Sale</li>
			</ol>
			<h1>Feed Sale</h1>
		</section><br/>
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                    ...
                                    if(in_array("net_amt1", $existing_col_names, TRUE) == ""){ $sql = "ALTER TABLE `customer_sales` ADD `net_amt1` DECIMAL(20,5) NOT NULL DEFAULT '0' AFTER `tcdsamt`"; mysqli_query($conn,$sql); }
                                    ...
                                    $sql = "SELECT * FROM `customer_sales` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' AND `tdflag` = '0' AND `pdflag` = '0' AND `trlink` LIKE '$href' ORDER BY `date` ASC";
                                    ...
                                    <tr>
										...
										<td><?php echo $sup_name[$row['sup_code']]; ?></td>
