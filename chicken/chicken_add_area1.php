	...
	<body class="hold-transition skin-blue sidebar-mini">
		...
		<section class="content">
			<div class="box box-default">
				<div class="box-body">
					<div class="col-md-12">
						<form action="chicken_save_area1.php" method="post" onsubmit="return checkval()">
							...
							<div class="row">
								<div class="col-md-12" align="center">
									<table class="table1" style="line-height:1.5;width:auto;">
										<thead>
											<tr>
												<th style="text-align:center;"><label>Area Name<b style="color:red;">&nbsp;*</b></label></th>
		...
		<script>
			function return_back(){
				var a = '<?php echo $cid; ?>';
				window.location.href = "chicken_display_area1.php?cid="+a;
			}
			function checkval(){
				...
				for(var d = 0;d <= incr;d++){
                    if(l == true){
                        ...
                        if(description == ""){
                            alert("Please enter Area Name in row: "+c);
