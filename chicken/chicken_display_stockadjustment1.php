<?php
//chicken_display_stockadjustment1.php
    ...
    <html>
		...
		<section class="content-header">
			<ol class="breadcrumb">
				...
				<li class="active">Display Stock Adjustment</li>
			</ol>
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM `item_stock_adjustment` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `trlink` LIKE '$href' AND `dflag` = '0' ORDER BY `date`,`trnum` ASC";
