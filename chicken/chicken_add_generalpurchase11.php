<?php
//chicken_add_generalpurchase11.php
...
if($access_error_flag == 0){
    ...
    $incr = 0; $prefix = $trnum = "";
    $trno_dt1 = generate_transaction_details($date,"generalpurchase11","PTI","display",$_SESSION['dbase']);
    ...
    <html>
        ...
        <body>
            <div class="card border-secondary mb-3">
                ...
                <form action="chicken_save_generalpurchase11.php" method="post" onsubmit="return checkval();">
