			...
			?>
				<div class="container mt-5">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="col-md-18">
								<form action="chicken_modify_pursale5.php" method="post" role="form" onsubmit="return checkval()">
									<div class="row">
									...
									<div class="col-md-18">
										<table style="width:103%;line-height:30px;" id="tab3" class="table table-bordered table-striped">
											<tr style="line-height:30px;">
												...
												<?php
													if($ifjbwen == 1 || $ifjbw == 1){ echo "<th><label>cJals</label></th>"; }
													if($ifjbwen == 1 || $ifjbw == 1 || $ifbw == 1){ echo "<th><label>cBirds</label></th>"; }
													if($ifjbwen == 1){ echo "<th><label>cT. Wt.</label></th><th><label>cE. Wt.</label></th>"; }
												?>
												<th style="text-align:center;"><label>Price<b style="color:red;">&nbsp;*</b></label></th>
												<th style="width:1px;visibility:hidden;text-align:center;"></th>
											...
											<tr id="tblrow" style="margin:5px 0px 5px 0px;">
												...
												<td style="width:1px;visibility:hidden;text-align:center;"><input type="text" name="sup_tamt" id="sup_tamt" value="<?php echo $sup_tamt; ?>" class="form-control amount-format"  readonly></td>
												...
												<td <?php if($ifjbwen == 1 || $ifjbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" name="cjval" id="cjval" value="<?php echo $jval; ?>" onkeyup="validate_count(this.id);calfinaltotal();" class="form-control amount-format" /></td>
												<td <?php if($ifjbwen == 1 || $ifjbw == 1 || $ifbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" name="cbval" id="cbval" value="<?php echo $bval; ?>" onkeyup="validate_count(this.id);calfinaltotal();" class="form-control amount-format" /></td>
												<td <?php if($ifjbwen == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" name="cwval" id="cwval" value="<?php echo $wval; ?>" onkeyup="validatenum(this.id);calculatenetwt(this.id);calfinaltotal();" onchange="validateamount(this.id)" class="form-control amount-format" /></td>
												<td><input type="text" name="cus_qty" id="cus_qty" onkeyup="validatenum(this.id);calculatetotal();calfinaltotal();" onchange="validateamount(this.id)" class="form-control amount-format"></td>
												...
												<td style="width:1px;visibility:hidden;text-align:center;"><input type="text" name="cus_tamt" id="cus_tamt" value="<?php echo $cus_tamt; ?>" class="form-control amount-format"  readonly></td>
