    ...
    <html>
        ...
        <body>
            <div class="card border-secondary mb-3">
                ...
                <form action="chicken_save_pursale3.php" method="post" onsubmit="return checkval();">
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th>Purchase Party<b style="color:red;">&nbsp;*</b></th>
                                ...
                                <tbody id="row_body">
                                    <tr style="margin:5px 0px 5px 0px;">
                                        <td><input type="text" name="vehiclecode[]" id="vehiclecode[0]" class="form-control" style="width:130px;" /></td>
                                        ...
                                        <td><select name="supbrh_code[]" id="supbrh_code[0]" class="form-control select2" style="width:180px;"><option value="select">-select-</option></select></td>
                                        <?php
                                        ...
                                        <td style="width:20px;visibility:hidden;"><select name="warehouse[]" id="warehouse[0]" class="form-control select2" style="width:20px;"><?php foreach($sector_code as $scode){ ?><option value="<?php echo $scode; ?>"><?php echo $sector_name[$scode]; ?></option><?php } ?></select></td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
            ...
            <script>
                ...
                function checkval(){
                    ...
                    if(date == ""){
                        ...
                        var vendorcode = warehouse = nweight = icode = fsector = tsector = date = ""; var c = jalqty = price = birdqty = qty = 0;
                ...
                function check_nrow(a){
                    ...
                    if(d == incr){
                        ...
                        if(warehouse != "select" && warehouse != "" && vendorcode != "select" && vendorcode != "" && customercode != "select" && customercode != "" && parseFloat(nweight) > 0 && parseFloat(sup_prc) > 0 && parseFloat(cus_prc) > 0){ create_row(a); }
                    }
                }
                function create_row(a){
                    ...
                    html += '<tr id="row_no['+d+']">';
                    html += '<td><input type="text" name="vehiclecode[]" id="vehiclecode['+d+']" class="form-control" style="width:130px;" /></td>';
                    ...
                    html += '<td style="width:20px;visibility:hidden;"><select name="warehouse[]" id="warehouse['+d+']" class="form-control select2" style="width:20px;"><?php foreach($sector_code as $scode){ ?><option value="<?php echo $scode; ?>"><?php echo $sector_name[$scode]; ?></option><?php } ?></select></td>';
                    html += '</tr>';
            ...
            <script>
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    const interval = setInterval(() => {
                        ...
                        if(itemcode && $(itemcode).hasClass('select2-hidden-accessible')){
