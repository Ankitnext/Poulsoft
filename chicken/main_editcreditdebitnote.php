									...
									<table style="width:100%;line-height:30px;" id="tab3" align="center">
										...
										?>
											<tr style="line-height:30px;">
												...
												<td><input type="text" name="pdate" id="pdate"class="form-control crdr_datepickers" value="<?php echo date("d.m.Y",strtotime($rowedit['date'])); ?>" readonly></td>
												...
												<td><select name="sector" id="sector" class="form-control select2" style="width:100%"> <option value="select">select</option> <?php foreach($wcode as $fcode){ ?> <option <?php if($rowedit['warehouse'] == $wcode[$fcode]){ echo "selected"; } ?> value="<?php echo $wcode[$fcode]; ?>"><?php echo $wdesc[$fcode]; ?></option> <?php } ?> </select></td>
