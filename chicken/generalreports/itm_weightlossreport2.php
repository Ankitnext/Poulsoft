	...
	<head><link rel="stylesheet" type="text/css"href="reportstyle.css">
		<?php
			if($exoption == "exportexcel") {
				...
				echo header("Content-Disposition: attachment; filename=itm_weightlossreport2($fromdate-$todate).xls");
		...
		<?php } ?>
			<section class="content" align="center">
				<div class="col-md-18" align="center">
					<form action="itm_weightlossreport2.php" method="post">
										...
										if($qsize == 1) {
											...
											foreach($addeditemcode as $icodes){
												echo "<tr>";
													...
													if($ifjbwen == 1){ echo "<td colspan='$tc' id='ac'></td>"; }
													if($ifjbwen == 1){ echo "<td colspan='$ec' id='ac'></td>"; }
													echo "<td colspan='$nc' id='ac'>".number_format_ind($addeditemqty[$icodes] - $rmditemqty[$icodes])."</td>";
											...
											foreach($addeditemcode as $icodes){
												echo "<tr>";
													...
													if($ifjbwen == 1){ echo "<td colspan='$tc' id='ac'></td>"; }
													if($ifjbwen == 1){ echo "<td colspan='$ec' id='ac'></td>"; }
													echo "<td colspan='$nc' id='ac'>".number_format_ind($actitemqty[$icodes] - ($addeditemqty[$icodes] - $rmditemqty[$icodes]))."</td>";
											...
											foreach($addeditemcode as $icodes){
												echo "<tr>";
													...
													if((float)$addeditemqty[$icodes] > 0){
														echo "<td colspan='$nc' id='ac' title='$addeditemqty[$icodes] - $rmditemqty[$icodes]) / $addeditemqty[$icodes]'>".number_format_ind((($addeditemqty[$icodes] - $rmditemqty[$icodes]) / $addeditemqty[$icodes]) * 100)."</td>";
													}
													else{
