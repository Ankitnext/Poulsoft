<?php
	//CustomerMultipleLedgerMaster.php
			...
			<table align="center" class="reportheadermenu">
				...
				<tr>
					<td align="center" colspan="2">
						<h3>Customer Multi-Ledger Report</h3>
					</td>
				</tr>
			</table>
		</header>
			...
			<div class="col-md-12" align="center">
				<table class="table1" style="min-width:auto;line-height:23px;">
					<thead class="thead1" style="background-color: #98fb98;">
						<form action="CustomerMultipleLedgerMaster.php?cid=<?php echo $cid; ?>" method="post" onsubmit="return checkval()">
							<tr>
								<td colspan="3">
					...
					<form action="CustomerMultipleLedgerDisplayMaster.php?cid=<?php echo $cid; ?>" method="post" onsubmit="return checkval()">
						<thead class="thead1" style="background-color: #98fb98;">
							<tr>
								<td colspan="3">
