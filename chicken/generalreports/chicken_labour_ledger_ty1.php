...
if($db == ''){
    ...
    $form_reload_page = "chicken_labour_ledger_ty1.php";
}
else{
                    ...
                    <?php } ?>
                        ...
                        if(isset($_POST['submit']) == true){
                           ...
                           // $opening_bal = $opamount - $op_adv;
                            ...
                            $sql = "SELECT * FROM `employee_sale_wages` WHERE  `to_coa` = '$ewage_code' AND `active` = '1' AND `dflag` = '0'".$sec_fltr1." ";
                           // echo $sql;
                            ...
                            foreach($arr as $r){
                               // echo "<br/>".$r."@".$esw_sale_qty[$r]."@".$esw_amount[$r]."@".$final_amt[$r]."@".$fadv[$r];
                                  ...
                                  $html .= '<tr>';
                                    ...
                                    $html .= '<td style="text-align:right">'.$r.'</td>';
