	...
	<body>
		...
		<?php } ?>
			<section class="content" align="center">
				...
				<?php if($db == ''){?>
				<form action="item_WeightLossWCC2_bkp.php" method="post">
					<?php } else { ?>
					<form action="item_WeightLossWCC2_bkp.php?db=<?php echo $db; ?>" method="post">
					<?php } ?>
						<table class="contentmenu">
							...
							<thead>
								<tr>
									...
									<td colspan='3' style='text-align:center;font-weight:bold;background-color: #98fb98;'>Mortality</td>
							...
							<thead>
								<tr style='font-weight:bold;background-color: #98fb98;'>
									...
									<td>Birds</td><td>Quantity</td><td>Amount</td>
									<td>Birds</td><td>Quantity</td><td>Amount</td>
									<td>Birds</td><td>Quantity</td><td>Amount</td>
									<td>Birds</td><td>Quantity</td><td>Amount</td>
									<td>Birds</td><td>Quantity</td><td>Amount</td>
