<?php
	//SalesReceiptReportMaster_ta.php
 ...
 background-color: #98fb98;
	...
	<?php } ?>
		<section class="content" align="center">
				...
				<?php if($db == ''){?>
				<form action="SalesReceiptReportMaster_ta.php" method="post" onsubmit="return checkval()">
					<?php } else { ?>
					<form action="SalesReceiptReportMaster_ta.php?db=<?php echo $db; ?>&emp_code=<?php echo $_GET['emp_code']; ?>" method="post" onSubmit="return checkval()">
					<?php } ?>
