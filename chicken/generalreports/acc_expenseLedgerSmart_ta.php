...
<html>
	...
	<?php } ?>
		<section class="content" align="center">
				...
				<?php if($db == ''){?>
					<form action="acc_expenseLedgerSmart_ta.php" method="post" onSubmit="return checkval()">
					<?php } else { ?>
					<form action="acc_expenseLedgerSmart_ta.php?db=<?php echo $db; ?>" method="post" onSubmit="return checkval()">
					<?php } ?>
