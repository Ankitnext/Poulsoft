...
if($db == ''){
    ...
    $form_reload_page = "chicken_day_book1_ta.php";
}
else{
    include "APIconfig.php";
    $dbname = $db;
    $users_code = $_GET['emp_code'];
    $form_reload_page = "chicken_day_book1_ta.php?db=".$db;
}
...
// BIRDS Flag
$sql = "SELECT * FROM `master_itemfields`";
$query = mysqli_query($conn,$sql); //$avou_flag = 1;
while($row = mysqli_fetch_assoc($query)){ 
    if($row['jals_flag'] == 0 || $row['jals_flag'] == '0'){ $jals_flag = 0; } else { $jals_flag = 1;} 
    if($row['birds_flag'] == 0 || $row['birds_flag'] == '0'){ $birds_flag = 0; } else { $birds_flag = 1;} 
    if($row['tweight_flag'] == 0 || $row['tweight_flag'] == '0'){ $tweight_flag = 0; } else { $tweight_flag = 1;} 
    if($row['eweight_flag'] == 0 || $row['eweight_flag'] == '0'){ $eweight_flag = 0; } else { $eweight_flag = 1;} 
    if($row['nweight_flag'] == 0 || $row['nweight_flag'] == '0'){ $nweight_flag = 0; } else { $nweight_flag = 1;} 
} 
				...
				<form action="<?php echo $form_reload_page; ?>" method="post" onsubmit="return checkval()">
                    ...
                    <?php } ?>
                        ...
                        if(isset($_POST['submit']) == true){
                            ...
                            $nhtml .= '<th style="text-align:center;">Stock Point</th>'; $fhtml .= '<th style="text-align:center; id="order">Stock Point</th>';
                            $nhtml .= '<th style="text-align:center;">Item</th>'; $fhtml .= '<th style="text-align:center;" id="order">Item</th>';
                            if($jals_flag > 0){  $nhtml .= '<th style="text-align:center;" >Jals</th>'; $fhtml .= '<th style="text-align:center;" id="order">Jals</th>'; }
                            if($birds_flag > 0){ $nhtml .= '<th style="text-align:center;" >Birds</th>'; $fhtml .= '<th style="text-align:center;" id="order">Birds</th>'; }
                            if($tweight_flag > 0){  $nhtml .= '<th style="text-align:center;" >T.wt</th>'; $fhtml .= '<th style="text-align:center;" id="order_num">T.wt</th>'; }
                            if($eweight_flag > 0){ $nhtml .= '<th style="text-align:center;" >E.wt</th>'; $fhtml .= '<th style="text-align:center;" id="order_num">E.wt</th>'; }
                            if($nweight_flag > 0){  $nhtml .= '<th style="text-align:center;" >N.wt</th>'; $fhtml .= '<th style="text-align:center;" id="order_num">N.wt</th>'; }
                            $nhtml .= '<th style="text-align:center;" >Rate</th>'; $fhtml .= '<th style="text-align:center;" id="order_num">Rate</th>';
                            $nhtml .= '<th style="text-align:center;" >Amount</th>'; $fhtml .= '<th style="text-align:center;" id="order_num">Amount</th>';
                            $nhtml .= '<th style="text-align:center;" >User</th>'; $fhtml .= '<th style="text-align:center;" id="order">User</th>';
                            ...
                            while($row = mysqli_fetch_assoc($query)){
                                ...
                                $html .= '<td style="text-align:left;">'.$sname.'</td>';
                                $html .= '<td style="text-align:left;">'.$iname.'</td>';
                               if($jals_flag > 0){ $html .= '<td style="text-align:right;">'.number_format_ind($jals).'</td>'; }
                               if($birds_flag > 0){ $html .= '<td style="text-align:right;">'.number_format_ind($birds).'</td>'; }
                               if($tweight_flag > 0){ $html .= '<td style="text-align:right;">'.number_format_ind($totalweight).'</td>'; }
                               if($eweight_flag > 0){ $html .= '<td style="text-align:right;">'.number_format_ind($emptyweight).'</td>'; }
                               if($nweight_flag > 0){ $html .= '<td style="text-align:right;">'.number_format_ind($netweight).'</td>'; }
                                $html .= '<td style="text-align:right;">'.number_format_ind($price).'</td>';
                                $html .= '<td style="text-align:right;">'.number_format_ind($amount).'</td>';
                                $html .= '<td style="text-align:left;">'.$addedemp.'</td>';
                                $html .= '<td style="text-align:left;">'.date("d.m.Y H:i:s", strtotime($addedtime)).'</td>';
                               ...
                               $html .= '</tbody>';
                                ...
                                $html .= '<th colspan="2">Total</th>';
                                // Output the overall total for all weeks
                                if($jals_flag > 0){ $html .= '<th style="text-align:right;">' . number_format_ind(round($tjals, 2)) . '</th>'; }
                                if($birds_flag > 0){ $html .= '<th style="text-align:right;">' . number_format_ind(round($tbirds, 2)) . '</th>'; }
                                if($tweight_flag > 0){ $html .= '<th style="text-align:right;">' . number_format_ind(round($ttotalweight, 2)) . '</th>'; }
                                if($eweight_flag > 0){ $html .= '<th style="text-align:right;">' . number_format_ind(round($temptyweight, 2)) . '</th>'; }
                                if($nweight_flag > 0){ $html .= '<th style="text-align:right;">' . number_format_ind(round($tnetweight, 2)) . '</th>'; }
                                ...
                                $html .= '</tbody>';
                                    ...
                                    $html .= '<th colspan="2">Total</th>';
                                    // Output the overall total for all weeks
                                   if($jals_flag > 0){ $html .= '<th style="text-align:right;">' . number_format_ind(round($tjals_sales, 2)) . '</th>'; }
                                   if($birds_flag > 0){  $html .= '<th style="text-align:right;">' . number_format_ind(round($tbirds_sales, 2)) . '</th>'; }
                                   if($tweight_flag > 0){ $html .= '<th style="text-align:right;">' . number_format_ind(round($ttotalweight_sales, 2)) . '</th>'; }
                                   if($eweight_flag > 0){ $html .= '<th style="text-align:right;">' . number_format_ind(round($temptyweight_sales, 2)) . '</th>'; }
                                   if($nweight_flag > 0){ $html .= '<th style="text-align:right;">' . number_format_ind(round($tnetweight_sales, 2)) . '</th>'; }
                                ...
                                $sql = "SELECT * FROM `pur_payments` WHERE `tdflag` = '0' AND `date` >= '$fdate' AND `date` <= '$tdate' AND `pdflag` = '0' AND `active` = '1' ORDER BY `date` ASC";
                                $query = mysqli_query($conn,$sql); $tot_qty = $tot_amt = 0;
                                while($row = mysqli_fetch_assoc($query)){
                                    $date = date("d.m.Y",strtotime($row['date']));
                                    $addedtime = $row['addedtime'];
                                ...
                                $html .= '</tbody>';
                                    ...
                                    while($row = mysqli_fetch_assoc($query)){
                                        ...
                                        $html .= '<td style="text-align:left;">'.$sname.'</td>';
                                        $html .= '<td style="text-align:left;">'.$addedemp.'</td>';
                                        $html .= '<td colspan="3" style="text-align:left;">'.date("d.m.Y H:i:s", strtotime($addedtime)).'</td>';
                                    ...
                                    $sql = "SELECT * FROM `item_stocktransfers` WHERE `tdflag` = '0' AND `date` >= '$fdate' AND `date` <= '$tdate' AND `pdflag` = '0' AND `active` = '1' ORDER BY `date`,`trnum` ASC";
                                    $query = mysqli_query($conn,$sql); $tot_qty = $tot_amt = 0;
                                    while($row = mysqli_fetch_assoc($query)){
                                        $date = date("d.m.Y",strtotime($row['date']));
                                        $addedtime = $row['addedtime'];
                                    ...
                                    $sql = "SELECT * FROM `main_mortality` WHERE `dflag` = '0' AND `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' ORDER BY `date` ASC";
                                    $query = mysqli_query($conn,$sql); $tot_qty = $tot_amt = 0;
                                    while($row = mysqli_fetch_assoc($query)){
                                        $date = date("d.m.Y",strtotime($row['date']));
                                        $addedtime = $row['addedtime'];
                                    ...
                                    $html .= '</tbody>';
                                        ...
                                        $nhtml .= '<th style="text-align:center;" >Amount</th>'; $fhtml .= '<th style="text-align:center;" id="order_num">Amount</th>';
                                        $nhtml .= '<th style="text-align:center;" >User</th>'; $fhtml .= '<th style="text-align:center;" id="order">User</th>';
                                        $nhtml .= '<th colspan="6" style="text-align:center;" >Entry Time</th>'; $fhtml .= '<th colspan="6" style="text-align:center;" id="order">Entry Time</th>';
                                        $nhtml .= '</tr>';
                                        $fhtml .= '</tr>';
                                        $html .= $fhtml;
                                        $html .= '</thead>';
                                    ...
                                    $sql = "SELECT * FROM `acc_vouchers` WHERE `active` = '1' AND `date` >= '$fdate' AND `date` <= '$tdate'  ORDER BY `date` ASC";
                                    $query = mysqli_query($conn,$sql); $tot_qty = $tot_amt = 0;
                                    while($row = mysqli_fetch_assoc($query)){
                                        $date = date("d.m.Y",strtotime($row['date']));
                                        $addedtime = $row['addedtime'];
                                       ...
                                       // $amount = (float)$quantity * (float)$price;
                                        ...
                                        $html .= '<td style="text-align:right;">'.number_format_ind($amount).'</td>';
                                        $html .= '<td style="text-align:left;">'.$addedemp.'</td>';
                                        $html .= '<td colspan="6" style="text-align:left;">'.date("d.m.Y H:i:s", strtotime($addedtime)).'</td>';
