...
<html>
	...
	<?php } ?>
		<section class="content" align="center">
				...
				<?php if($db == ''){?>
				<form action="acc_ledgerreport.php" method="post" onsubmit="return checkval()">
					<?php } else { ?>
					<form action="acc_ledgerreport.php?db=<?php echo $db; ?>" method="post" onsubmit="return checkval()">
					<?php } ?>
