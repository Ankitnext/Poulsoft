<?php
	...
	$sectors = array(); $sectors["all"] = "all"; $sec_all_flag = 0;
					...
					<?php } ?>
						...
						<?php if($exoption == "displaypage" || $exoption == "exportpdf") { ?>
							...
							<?php
								...
								if($count14 > 0){
									$obsql = "SELECT * FROM `customer_sales` WHERE `date` < '$fdate' AND `customercode` = '$cus_names' AND `active` = '1' AND `tdflag` = '0' AND `pdflag` = '0'".$secct_fltr." ORDER BY `date`,`invoice` ASC";
								...
								if($count13 > 0){
								$obsql = "SELECT * FROM `customer_receipts` WHERE `date` < '$fdate' AND `ccode` = '$cus_names' AND `active` = '1' AND `tdflag` = '0'".$secct_fltr." AND `pdflag` = '0'";
								...
								$sales = array();
								if($count14 > 0){
									$sequence = "SELECT * FROM `customer_sales` WHERE `date` >= '$fdate' AND `date` <= '$tdate'"; $flags = " AND `active` = '1' AND `tdflag` = '0' AND `pdflag` = '0'".$secct_fltr." ORDER BY `date`,`invoice` ASC";
								...
								if($count14 > 0){
									$sql = "SELECT * FROM `customer_sales` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' AND `tdflag` = '0' AND `pdflag` = '0'".$secct_fltr." ORDER BY `date`,`invoice` ASC";
								...
								$receipts  = array();
								if($count13 > 0){
									$rctseq = "SELECT * FROM `customer_receipts` WHERE `date` >= '$fdate'".$secct_fltr." AND `date` <= '$tdate'"; $flags = " AND `active` = '1' AND `tdflag` = '0' AND `pdflag` = '0'";
								...
								$returns = array();
								if($count40 > 0){
									$rtnsql = "SELECT * FROM `main_itemreturns` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `vcode` = '$cname'".$secct_fltr." AND `mode` = 'customer' AND `active` = '1' AND `dflag` = '0'";
								...
								$mortalities  = array();
								if($count13 > 0){
									$mortseq = "SELECT * FROM `main_mortality` WHERE `date` >= '$fdate' AND `date` <= '$tdate'".$secct_fltr." AND `mtype` = 'customer'"; $flags = " AND `active` = '1' AND `dflag` = '0'";
								...
								if($count32 > 0){
									$crdrseq = "SELECT * FROM `main_crdrnote` WHERE `mode` IN ('CDN','CCN') AND `date` >= '$fdate'".$secct_fltr." AND `date` <= '$tdate'"; $flags = " AND `active` = '1' AND `tdflag` = '0' AND `pdflag` = '0'";
								...
								$purchases = array();
								if($count57 > 0){
									$sequence = "SELECT * FROM `pur_purchase` WHERE `date` >= '$fdate' AND `date` <= '$tdate'"; $flags = " AND `active` = '1'".$secct_fltr." AND `tdflag` = '0' AND `pdflag` = '0' ORDER BY `date`,`invoice` ASC";
								...
								if($count57 > 0){
									$sql = "SELECT * FROM `pur_purchase` WHERE `date` >= '$fdate' AND `date` <= '$tdate'".$secct_fltr." ORDER BY `date`,`invoice` ASC"; $query = mysqli_query($conn,$sql);
									while($row = mysqli_fetch_assoc($query)){
								...
								$payments = array();
								if($count56 > 0){
									$rctseq = "SELECT * FROM `pur_payments` WHERE `date` >= '$fdate' AND `date` <= '$tdate'"; $flags = " AND `active` = '1' AND `tdflag` = '0'".$secct_fltr." AND `pdflag` = '0'";
									$rctname = $_POST['cname']; $i = 0; if($rctname == "all") { $rctnames = ""; } else { $rctnames = " AND `ccode` = '$cname'"; } $rctsql = $rctseq."".$rctnames."".$flags; $rctquery = mysqli_query($conn,$rctsql);
									while($row = mysqli_fetch_assoc($rctquery)){
								...
								$sreturns = array();
								if($count40 > 0){
									$rtnsql = "SELECT * FROM `main_itemreturns` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `vcode` = '$cname'".$secct_fltr." AND `mode` = 'supplier' AND `active` = '1' AND `dflag` = '0'";
									$rtnquery = mysqli_query($conn,$rtnsql); $i = 0;
									while($row = mysqli_fetch_assoc($rtnquery)){
										$avgwt = 0;
								...
								$smortalities  = array();
								if($count13 > 0){
									$mortseq = "SELECT * FROM `main_mortality` WHERE `date` >= '$fdate' AND `date` <= '$tdate'".$secct_fltr." AND `mtype` = 'supplier'"; $flags = " AND `active` = '1' AND `dflag` = '0'";
									$mortname = $_POST['cname']; $i = 0; if($mortname == "all") { $mortnames = ""; } else { $mortnames = " AND `ccode` = '$cname'"; } $mortsql = $mortseq."".$mortnames."".$flags; $mortquery = mysqli_query($conn,$mortsql);
									while($row = mysqli_fetch_assoc($mortquery)){
