<?php
	...
	if($db == ''){
        ...
        $form_reload_page = "SalesReportMaster3.php";
	}
	else{
        ...
        $form_reload_page = "SalesReportMaster3.php?db=".$db;
	}
	...
	$sql = "SELECT *  FROM `main_linkdetails` WHERE `href` LIKE '%SalesReportMaster3.php%'"; $query = mysqli_query($conn,$sql);
