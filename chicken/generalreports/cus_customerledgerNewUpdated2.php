...
<html>
	<head><link rel="stylesheet" type="text/css"href="reportstyle.css">
		<?php
			if($exoption == "exportexcel") {
				...
				echo header("Content-Disposition: attachment; filename=cus_customerledgerNewUpdated2($fromdate-$todate).xls");
	...
	<?php } ?>
		<section class="content" align="center">
				...
				<?php if($db == ''){?>
				<form action="cus_customerledgerNewUpdated2.php?cid=<?php echo $cid; ?>" method="post" >
					<?php } else { ?>
					<form action="cus_customerledgerNewUpdated2.php?cid=<?php echo $cid; ?>&db=<?php echo $db; ?>&emp_code=<?php echo $users_code; ?>" method="post" >
					<?php } ?>
