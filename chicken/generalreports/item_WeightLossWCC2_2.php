...
if($db == ''){
    ...
    $form_reload_page = "item_WeightLossWCC2_2.php";
}
else{
    include "APIconfig.php";
    $dbname = $db;
    $users_code = $_GET['emp_code'];
    $form_reload_page = "item_WeightLossWCC2_2.php?db=".$db;
}
                    ...
                    <?php } ?>
                        ...
                        foreach($mainfilter as $mf){
                          ...
                          //  echo $dates."@".$icodes."<br/>";
                            ...
                            if(number_format_ind($openingdetails[$pre_code]) == "0.00" && number_format_ind($mrt_qty) == "0.00" && number_format_ind($pur_qty[$id]) == "0.00" && number_format_ind($pur_birds[$id]) == "0.00" && (number_format_ind($inv_qty[$id]) == "0.00" && $inv_birds[$id] == 0) && number_format_ind($openingdetails[$id]) == "0.00" && number_format_ind($tin_qty[$id]) == "0.00" && number_format_ind($tou_qty[$id]) == "0.00"){
                                //echo "<br/>".$dates;
                            }
                            else{
