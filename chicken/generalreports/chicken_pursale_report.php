<?php
	...
	if($db == ''){
        ...
        $form_reload_page = "chicken_pursale_report.php";
	}
	else{
        ...
        $form_reload_page = "chicken_pursale_report.php?db=".$db;
	}
    $file_name = "Purchase Sale Report";
				...
				<form action="<?php echo $form_reload_page; ?>" method="post" onsubmit="return checkval()">
                    ...
                    <table class="main-table table-sm table-hover" id="main_table">
                        ...
                        if(isset($_POST['submit']) == true){
                            ...
                            $sql = "SELECT * FROM `customer_sales` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `trtype` = 'PST'".$item_filter."".$sector_filter." AND `tdflag` = '0' AND `pdflag` = '0' ORDER BY `id` DESC";
                            ...
                            $html .= '<tr>';
                            $html .= '<th style="text-align:left;" colspan="5">Grand Total</th>';
