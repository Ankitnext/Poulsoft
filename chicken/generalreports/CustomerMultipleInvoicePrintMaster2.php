<?php
	//CustomerMultipleInvoicePrintMaster2.php
			...
			<div class="col-md-12" align="center">
				<table class="table1" style="min-width:auto;line-height:23px;">
					<thead class="thead1" style="background-color: #98fb98;">
						<form action="CustomerMultipleInvoicePrintMaster2.php?cid=<?php echo $cid; ?>" method="post" onsubmit="return checkval()">
							<tr>
								<td colspan="3">
					...
					<form action="../printformatlibrary/Examples/CustomerMultipleInvoicePrint2.php?cid=<?php echo $cid; ?>" method="post" onsubmit="return checkval()">
						<thead class="thead1" style="background-color: #98fb98;">
							<tr>
								<td colspan="3">
