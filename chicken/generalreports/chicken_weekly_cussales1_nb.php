...
if($db == ''){
    ...
    $form_reload_page = "chicken_weekly_cussales1_nb.php";
}
else{
                    ...
                    <?php } ?>
                        ...
                        if(isset($_POST['submit']) == true || isset($_POST['pre']) == true || isset($_POST['next']) == true){
                            ...
                            foreach($week_no as $key => $value){
                                ...
                                $html .= '<td style="text-align:right;">'.number_format_ind(round($sql_qty[$key] - $ret_qty[$key],2)).'</td>';
                                ...
                                $html .= '<td style="text-align:right;">'.number_format_ind(round($ret_amt[$key],2)).'</td>';
                            ...
                            $html .= '<th style="text-align:right;">'.number_format_ind(round($totreturn,2)).'</th>';
