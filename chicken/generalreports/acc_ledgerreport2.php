<?php 
	...
	$today = date("Y-m-d");
	$sql = "SELECT * FROM `acc_coa` WHERE `active` = '1' ORDER BY `description` ASC"; $query = mysqli_query($conn,$sql); $allCoA = "";
	...
	if(isset($_POST['submit']) == true){
		$exl_fdate = $_POST['fromdate']; $exl_tdate = $_POST['todate']; $exl_coa = $_POST['coa']; $exl_sec = $_POST['whname'];
	}
	else{
		$exl_fdate = $exl_tdate = $today; $exl_coa = $exl_sec = "all";
	}
	$url = "../PHPExcel/Examples/CoALedgerReport-Excel.php?fromdate=".$exl_fdate."&todate=".$exl_tdate."&coa=".$exl_coa."&sector=".$exl_sec;
?>
<html>
	...
	<?php } ?>
		<section class="content" align="center">
				...
				<?php if($db == ''){?>
				<form action="acc_ledgerreport2.php" method="post" onsubmit="return checkval()">
					<?php } else { ?>
					<form action="acc_ledgerreport2.php?db=<?php echo $db; ?>" method="post" onsubmit="return checkval()">
					<?php } ?>
						...
						?>
								...
								while($row = mysqli_fetch_assoc($query)){
									$grp_cn_acc[$row['code']] = $row['controlaccount'];
									$grp_pp_acc[$row['code']] = $row['prepayaccount'];
									$grp_name[$row['code']] = $row['description'];
									$grp_code[$row['code']] = $row['code'];
								}
								$sql = "SELECT * FROM `item_category`"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									$itm_cia_acc[$row['code']] = $row['iac'];
									$itm_ccg_acc[$row['code']] = $row['cogsac'];
									$itm_csa_acc[$row['code']] = $row['sac'];
									$itm_csr_acc[$row['code']] = $row['srac'];
									$itm_ia_acc[$row['iac']] = $row['iac'];
									$itm_cg_acc[$row['cogsac']] = $row['cogsac'];
									$itm_sa_acc[$row['sac']] = $row['sac'];
									$itm_sr_acc[$row['srac']] = $row['srac'];
									$itm_cat_name[$row['code']] = $row['description'];
									$itm_cat_code[$row['code']] = $row['code'];
								}
								$sql = "SELECT SUM(totalamt) as tamt,itemcode FROM `customer_sales` WHERE `date` < '$fdate' AND `active` = '1' GROUP BY `itemcode`,`customercode` ORDER BY `itemcode` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									$pre_item_amt[$row['itemcode']] = $row['tamt'];
								}
								$sql = "SELECT SUM(totalamt) as tamt,itemcode FROM `pur_purchase` WHERE `date` < '$fdate' AND `active` = '1' GROUP BY `itemcode`,`vendorcode` ORDER BY `itemcode` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									$pre_item_amt[$row['itemcode']] = $row['tamt'];
								}*/
								...
								foreach($coacode as $accode){
									...
									echo "<tr>";
										...
										echo "<td style='text-align:left;'>".$coaname[$accode]."</td>";
								...
								?>
									...
									<thead>
										<tr class="foottr">
											<td colspan="2" align="center" style="background-color: #98fb98;"><b>Grand Total</b></td>
											<td><b></b></td>
											<td><b></b></td>
											<td><b></b></td>
											<td><b></b></td>
						...
						<?php
								...
								$fdate = date("Y-m-d",strtotime($_POST['fromdate']));
								$tdate = date("Y-m-d",strtotime($_POST['todate']));
								$coa = $_POST['coa']; $wname = $_POST['whname'];
								$sql = "SELECT SUM(amount) as tamt FROM `pur_payments` WHERE `date` < '$fdate' AND `active` = '1' AND `method` = '$coa' ORDER BY `ccode` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){ $pre_pur_pay_amt = $row['tamt']; }
								$sql = "SELECT SUM(amount) as tamt FROM `customer_receipts` WHERE `date` < '$fdate' AND `active` = '1' AND `method` = '$coa' ORDER BY `ccode` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){ $pre_cus_rct_amt = $row['tamt']; }
								$sql = "SELECT SUM(amount) as tamt,mode FROM `main_crdrnote` WHERE `date` < '$fdate' AND `active` = '1' AND `coa` = '$coa' GROUP BY `mode` ORDER BY `ccode` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
								...
								$sql = "SELECT SUM(amount) as tamt,prefix FROM `acc_vouchers` WHERE `date` < '$fdate' AND `active` = '1' AND `fcoa` = '$coa' GROUP BY `prefix` ORDER BY `fcoa` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
								...
								$sql = "SELECT SUM(amount) as tamt,prefix FROM `acc_vouchers` WHERE `date` < '$fdate' AND `active` = '1' AND `tcoa` = '$coa' GROUP BY `prefix` ORDER BY `tcoa` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
								...
								$c = 0;
								$bt_pur_pay_amt = $bt_cus_rct_amt = $bt_ccn_amt = $bt_cdn_amt = $bt_scn_amt = $bt_sdn_amt = $bt_oth_amt = $bt_fpv_amt = $bt_frv_amt = $bt_fjv_amt = 
								$bt_foth_vou_amt = $bt_tpv_amt = $bt_trv_amt = $bt_tjv_amt = $bt_toth_vou_amt = array();
								$sql = "SELECT * FROM `pur_payments` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' AND `method` = '$coa' ORDER BY `incr` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									$c = $c + 1;
								...
								$c = 0;
								$sql = "SELECT * FROM `customer_receipts` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' AND `method` = '$coa' ORDER BY `incr` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									$c = $c + 1;
								...
								$c = $d = $e = $f = $g = 0;
								$sql = "SELECT * FROM `main_crdrnote` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' AND `coa` = '$coa' ORDER BY `incr` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									if($row['mode'] == "CCN"){
										$c = $c + 1;
								...
								$c = $d = $e = $f = $g = 0;
								$sql = "SELECT * FROM `acc_vouchers` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' AND `fcoa` = '$coa' ORDER BY `incr` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									if($row['prefix'] == "PV"){
										$c = $c + 1;
								...
								$c = $d = $e = $f = $g = 0;
								$sql = "SELECT * FROM `acc_vouchers` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' AND `tcoa` = '$coa' ORDER BY `incr` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									if($row['prefix'] == "PV"){
										$c = $c + 1;
						...
						?>
								...
								<tbody class="tbody1" id="myTable" style="background-color: #f4f0ec;">
									<tr>
										<td style='text-align:right;' colspan="2"><b>Previous Balance</b></td>
										<td colspan="6"></td>
										<td><?php //echo number_format_ind($pre_paid); ?></td>
										<td><?php //echo number_format_ind($pre_received); ?></td>
										<td style='text-align:right;'><?php echo number_format_ind($closing_amt); ?></td>
									</tr>
									<?php
										...
										for ($currentDate = $fdate; $currentDate <= $tdate; $currentDate += (86400)) {
											...
											for($i = 1;$i <=$ccount;$i++){
												if($bt_cus_rct_amt[$date_asc."@".$i] != ""){
													...
													echo "<td style='text-align:right;'>".number_format_ind($bt_cus_rct_val[6])."</td>";
													echo "<td></td>";
													$bt_received = $bt_received + $bt_cus_rct_val[6];
													$closing_amt = $closing_amt + $bt_cus_rct_val[6];
													echo "<td style='text-align:right;'>".number_format_ind($closing_amt)."</td>";
													echo "</tr>";
												}
												else{
											...
											for($i = 1;$i <=$ccount;$i++){
												if($bt_ccn_amt[$date_asc."@".$i] != ""){
													...
													echo "<td>Customer Credit Note</td>";
													...
													echo "<td style='text-align:right;'>".number_format_ind($bt_ccn_val[4])."</td>";
													echo "<td></td>";
											...
											for($i = 1;$i <=$ccount;$i++){
												if($bt_scn_amt[$date_asc."@".$i] != ""){
													...
													echo "<td>Supplier Credit Note</td>";
													...
													echo "<td style='text-align:right;'>".number_format_ind($bt_scn_val[4])."</td>";
													echo "<td></td>";
											...
											for($i = 1;$i <=$ccount;$i++){
												if($bt_pur_pay_amt[$date_asc."@".$i] != ""){
													...
													echo "<td></td>";
													echo "<td style='text-align:right;'>".number_format_ind($bt_pur_pay_val[6])."</td>";
											...
											for($i = 1;$i <=$ccount;$i++){
												if($bt_cdn_amt[$date_asc."@".$i] != ""){
													...
													echo "<td>Customer Debit Note</td>";
													...
													echo "<td></td>";
													echo "<td style='text-align:right;'>".number_format_ind($bt_cdn_val[4])."</td>";
											...
											for($i = 1;$i <=$ccount;$i++){
												if($bt_sdn_amt[$date_asc."@".$i] != ""){
													...
													echo "<td>Supplier Debit Note</td>";
													...
													echo "<td></td>";
													echo "<td style='text-align:right;'>".number_format_ind($bt_sdn_val[4])."</td>";
						...
						<?php
								...
								$tdate = date("Y-m-d",strtotime($_POST['todate']));
								$coa = $_POST['coa']; $wname = $_POST['whname'];
								$sql = "SELECT SUM(amount) as tamt FROM `pur_payments` WHERE `date` < '$fdate' AND `active` = '1' AND `method` = '$coa' AND `warehouse` = '$wname' ORDER BY `ccode` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){ $pre_pur_pay_amt = $row['tamt']; }
								$sql = "SELECT SUM(amount) as tamt FROM `customer_receipts` WHERE `date` < '$fdate' AND `active` = '1' AND `method` = '$coa' AND `warehouse` = '$wname' ORDER BY `ccode` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){ $pre_cus_rct_amt = $row['tamt']; }
								$sql = "SELECT SUM(amount) as tamt,mode FROM `main_crdrnote` WHERE `date` < '$fdate' AND `active` = '1' AND `coa` = '$coa' AND `warehouse` = '$wname' GROUP BY `mode` ORDER BY `ccode` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									if($row['mode'] == "CCN"){ $pre_ccn_amt = $row['tamt']; }
									else if($row['mode'] == "CDN"){ $pre_cdn_amt = $row['tamt']; }
									else if($row['mode'] == "SCN"){ $pre_scn_amt = $row['tamt']; }
								...
								$sql = "SELECT SUM(amount) as tamt,prefix FROM `acc_vouchers` WHERE `date` < '$fdate' AND `active` = '1' AND `fcoa` = '$coa' AND `warehouse` = '$wname' GROUP BY `prefix` ORDER BY `fcoa` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									if($row['prefix'] == "PV"){ $pre_fpv_amt = $row['tamt']; }
									else if($row['prefix'] == "RV"){ $pre_frv_amt = $row['tamt']; }
									else if($row['prefix'] == "JV"){ $pre_fjv_amt = $row['tamt']; }
								...
								$sql = "SELECT SUM(amount) as tamt,prefix FROM `acc_vouchers` WHERE `date` < '$fdate' AND `active` = '1' AND `tcoa` = '$coa' AND `warehouse` = '$wname' GROUP BY `prefix` ORDER BY `tcoa` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									if($row['prefix'] == "PV"){ $pre_tpv_amt = $row['tamt']; }
									else if($row['prefix'] == "RV"){ $pre_trv_amt = $row['tamt']; }
									else if($row['prefix'] == "JV"){ $pre_tjv_amt = $row['tamt']; }
								...
								$bt_pur_pay_amt = $bt_cus_rct_amt = $bt_ccn_amt = $bt_cdn_amt = $bt_scn_amt = $bt_sdn_amt = $bt_oth_amt = $bt_fpv_amt = $bt_frv_amt = $bt_fjv_amt = 
								$bt_foth_vou_amt = $bt_tpv_amt = $bt_trv_amt = $bt_tjv_amt = $bt_toth_vou_amt = array();
								$sql = "SELECT * FROM `pur_payments` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' AND `method` = '$coa' AND `warehouse` = '$wname' ORDER BY `date` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									$c = $c + 1;
									$bt_pur_pay_amt[$row['date']."@".$c] = $row['trnum']."@".$row['date']."@".$row['ccode']."@".$row['docno']."@".$row['cdate']."@".$row['cno']."@".$row['amount']."@".$row['vtype']."@".$row['warehouse']."@".$row['remarks'];
								}
								$c = 0;
								$sql = "SELECT * FROM `customer_receipts` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' AND `method` = '$coa' AND `warehouse` = '$wname' ORDER BY `ccode` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									$c = $c + 1;
									$bt_cus_rct_amt[$row['date']."@".$c] = $row['trnum']."@".$row['date']."@".$row['ccode']."@".$row['docno']."@".$row['cdate']."@".$row['cno']."@".$row['amount']."@".$row['vtype']."@".$row['warehouse']."@".$row['remarks'];
								}
								$c = $d = $e = $f = $g = 0;
								$sql = "SELECT * FROM `main_crdrnote` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' AND `coa` = '$coa' AND `warehouse` = '$wname' ORDER BY `ccode` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									if($row['mode'] == "CCN"){
										$c = $c + 1;
										$bt_ccn_amt[$row['date']."@".$c] = $row['trnum']."@".$row['date']."@".$row['ccode']."@".$row['docno']."@".$row['amount']."@".$row['vtype']."@".$row['warehouse']."@".$row['remarks'];
								...
								$c = $d = $e = $f = $g = 0;
								$sql = "SELECT * FROM `acc_vouchers` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' AND `fcoa` = '$coa' AND `warehouse` = '$wname' ORDER BY `fcoa` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									if($row['prefix'] == "PV"){
										$c = $c + 1;
										$bt_fpv_amt[$row['date']."@".$c] = $row['trnum']."@".$row['date']."@".$row['tcoa']."@".$row['dcno']."@".$row['amount']."@".$row['warehouse']."@".$row['remarks'];
								...
								$c = $d = $e = $f = $g = 0;
								$sql = "SELECT * FROM `acc_vouchers` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' AND `tcoa` = '$coa' AND `warehouse` = '$wname' ORDER BY `tcoa` ASC"; $query = mysqli_query($conn,$sql);
								while($row = mysqli_fetch_assoc($query)){
									if($row['prefix'] == "PV"){
										$c = $c + 1;
										$bt_tpv_amt[$row['date']."@".$c] = $row['trnum']."@".$row['date']."@".$row['fcoa']."@".$row['dcno']."@".$row['amount']."@".$row['warehouse']."@".$row['remarks'];
