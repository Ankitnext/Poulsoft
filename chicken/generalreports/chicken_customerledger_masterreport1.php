...
if($db == ''){
    ...
    $form_reload_page = "chicken_customerledger_masterreport1.php";
}
else{
                                            ...
                                            for($j = 1;$j <= $ccount;$j++){
                                                ...
                                                if(empty($acname[$key1]) || $acname[$key1] == ""){ }
                                                    ...
                                                    if(empty($tbl_col_name[$cname]) || $tbl_col_name[$cname] == ""){ } else{
                                                        ...
                                                        else if($tcname == "trns_type2"){ $html .= '<td title="'.$rpt_col_name[$cname].'" style="text-align:left;">Debit Note / '.$tr_info[8].'</td>'; }
                                                        else{ }
                                                    }
                                                }
                                            }
