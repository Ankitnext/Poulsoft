<?php
	//chicken_datewise_useractivityj.php
...
<html>
	...
	<?php } ?>
		<section class="content" align="center">
				...
				<?php if($db == ''){?>
					<form action="chicken_datewise_useractivityj.php?cid=<?php echo $cid; ?>" method="post" onsubmit="return checkval()">
					<?php } else { ?>
						<form action="chicken_datewise_useractivityj.php?cid=<?php echo $cid; ?>&db=<?php echo $db; ?>" method="post" onsubmit="return checkval()">
					<?php } ?>
