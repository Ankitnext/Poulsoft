<?php
//chicken_weekly_cussales1_new2.php
...
if($db == ''){
    ...
    $form_reload_page = "chicken_weekly_cussales1_new2.php?db=".$db;
}
...
// Default date
$sql = "SELECT * FROM `extra_access` WHERE `field_name` = 'chicken_weekly_cussales1_new2.php' AND `field_function` = 'sec_default date' AND `flag` = '1'";
