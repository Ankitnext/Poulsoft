<?php
    //SuppliercumCustomerLedgerReport.php
	...
	$sql = "SELECT * FROM `extra_access` WHERE `field_name` LIKE 'SuppliercumCustomerLedgerReport.php' AND `field_function` LIKE 'Purchase Sale Sorting' AND `user_access` LIKE 'all' AND `flag` = '1'";
...
<html>
	...
	<?php } ?>
		<section class="content" align="center">
				...
				<?php if($db == ''){?>
				<form action="SuppliercumCustomerLedgerReport.php" method="post">
					<?php } else { ?>
					<form action="SuppliercumCustomerLedgerReport.php?db=<?php echo $db; ?>" method="post">
					<?php } ?>
