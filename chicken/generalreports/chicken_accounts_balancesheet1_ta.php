<?php
//chicken_accounts_balancesheet1_ta.php
...
if($db == ''){
    ...
    $form_reload_page = "chicken_accounts_balancesheet1_ta.php";
}
else{
    include "APIconfig.php";
    $dbname = $db;
    $users_code = $_GET['emp_code'];
    $form_reload_page = "chicken_accounts_balancesheet1_ta.php?db=".$db;
}
