...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<section class="content" align="center">
		<div class="col-md-12" align="center">
			<?php if ($db == '') { ?>
				<form action="SupplierLedgerReportAll_ta.php" method="post" onsubmit="return checkval()">
				<?php } else { ?>
					<form action="SupplierLedgerReportAll_ta.php?db=<?php echo $db; ?>" method="post" onsubmit="return checkval()">
					<?php } ?>
