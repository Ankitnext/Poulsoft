<?php
//chicken_display_ctc_transfer1.php
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM `chicken_ctc_stktransfer` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `dflag` = '0' AND `trlink` LIKE '$href' ORDER BY `date` ASC";
                                    ...
                                    <tr>
										...
										<td><?php echo $cus_name[$row['from_vcode']]; ?></td>
										<td><?php echo $item_name[$row['itemcode']]; ?></td>
										<td><?php echo $cus_name[$row['to_vcode']]; ?></td>
