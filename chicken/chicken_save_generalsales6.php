<?php
//chicken_save_generalsales6.php
...
$trno_dt1 = generate_transaction_details($date,"generalsales6","GSIN","generate",$_SESSION['dbase']);
...
$file_name = "chicken_display_generalsales6.php"; $sms_type = "WappKey"; $wapp_ptrn = "Normal";
...
?>
    <script>
        ...
        window.location.href = 'chicken_add_generalsales6.php';
    </script>
<?php
exit;
}
else{
    header('Location: chicken_add_generalsales6.php');
    exit;
}