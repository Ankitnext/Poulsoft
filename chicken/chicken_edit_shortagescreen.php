<?php
//chicken_edit_shortagescreen.php
...
?>
    <html>
        ...
        <body>
            <?php
            $ids = $_GET['trnum'];
            $sql = "SELECT * FROM `item_shortage_screen` WHERE `trnum` = '$ids' AND `trlink` = 'chicken_display_shortagescreen.php' AND `dflag` = '0'";
            ...
            <div class="card border-secondary mb-3">
                <div class="card-header">Edit Shoratge Screen</div>
                <form action="chicken_modify_shortagescreen.php" method="post" onsubmit="return checkval();">
                    <div class="card-body">
                        <div class="row">
                            <table align="center">
                                <thead>
                                ...
                                <tbody id="row_body">
                                    <tr style="margin:5px 0px 5px 0px;">
                                        ...
                                        <td style="display:none;"><select name="a_type" id="a_type" class="form-control select2" style="width:180px;"><option value="deduct" <?php if($a_type == "deduct"){ echo "selected"; } ?>>-Deduct-</option></select></td>
