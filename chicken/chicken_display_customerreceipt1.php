<?php
//chicken_display_customerreceipt1.php
    ...
    <html>
		...
		<section class="content-header">
            ...
            <div class="row" style="margin: 10px 10px 0 10px;">
                ...
                <div align="right">
                    <?php if((int)$iport_cflag == 1){ ?><button type="button" class="btn btn-success" id="import_page" value="chicken_import_customerreceipt1.php" onclick="add_page(this.id)" ><i class="fa-solid fa-circle-down"></i> Import</button><?php } ?>
