...
foreach($inv_nos as $inv_no){
	...
	if($inv_no != ""){
		...
		$paper_rate = mysqli_fetch_assoc(mysqli_query($conn,"SELECT new_price  FROM `main_dailypaperrate` WHERE `date` = '$odate'"))['new_price'];

		$cus_remarks = mysqli_fetch_assoc(mysqli_query($conn,"SELECT obremarks FROM `main_contactdetails`  where code = '$ccode'"))['obremarks'];
		if($paper_rate == ''){
			$paper_rate = 0;
		}
		...
		$html .= '<b align="left"><br/>Prop:'."Imtiyaz".'</b>';
		$html .= '</th>';
		$html .= '<th colspan="4" style="padding-right: 10px;text-align:right;">';
		$html .= '<b align="right"><br/>Mob:'." 97408 19466<br/>99167 54052".'</b>';
		$html .= '</th>';	
		$html .= '</tr>';*/
		$html .= '<tr>';
		...
		$html .= '</tr>';
		/*$html .= '<tr>';
		$html .= '<td colspan="7">Tenders Fresh Chicken, Nati & Broiler, Very Reasonable Rates for Hotels & Other Functions. We undertake Bulk order for Marriage.<br/></td>';
		$html .= '</tr>';*/
		$html .= '<tr>';
		$html .= '<th colspan="3" style="padding-left: 10px;text-align:left;">';
		$html .= '<b align="left">Invoice No.: '.$inv.'</b>';
		$html .= '</th>';
		$html .= '<th colspan="4" style="padding-right: 10px;text-align:right;">';
		$html .= '<b align="right">Date: '.$dt.'</b>';
		$html .= '</th>';
		$html .= '</tr>';
		/*$html .= '<tr>';
		//$html .= '<th colspan="7" style="padding-left: 10px;text-align:left;">';
		//$html .= '<b style="padding-left: 10px;text-align:left;">Paper Rate:</b>'.number_format_ind($paper_rate).'<br/>';
		//$html .= '</th>';
		$html .= '<th colspan="7" style="padding-right: 10px;text-align:right;">';
		$html .= '<b align="right">Paper Rate:</b>'.number_format_ind($paper_rate);
		$html .= '</th>';
		$html .= '</tr>';*/
		$html .= '<tr>';
		$html .= '<th colspan="7" style="padding-left: 10px;text-align:left;">';
		...
		//$html .= '<th colspan="4" style="padding-right: 10px;text-align:right;">';
		//$html .= '<b align="right">Paper Rate:</b>'.number_format_ind($paper_rate).'<br/>';
		//$html .= '</th>';
		$html .= '</tr>';
		$html .= '<tr>';
		$html .= '<th colspan="7" style="padding-left: 10px;text-align:left;">';
		...
		$html .= '<th colspan="2.5" style="border: 1px solid black;">Particulars</th>';
		$html .= '<th style="border: 1px solid black;">Quantity</th>';
		$html .= '<th style="border: 1px solid black;">Rate</th>';
		$html .= '<th colspan="1.5" style="border: 1px solid black;">Amount</th>';
		$html .= '</tr>';*/
		$html .= '</table>';
		...
		$html .= '<tr>';
			...
			$html .= '<td rowspan="1" colspan="2.5">'.$inames.'</td>';
			$html .= '<td rowspan="1" style="padding:5px;text-align:center;">'.$qtys.'</td>';
			$html .= '<td style="padding:5px;text-align:center;">'.$prices.'</td>';
			$html .= '<td colspan="1.5" style="padding:5px;text-align:center;">'.$amts.'</td>';
		$html .= '</tr>';
		/*$html .= '<tr>';
		...
		$html .= '</tr>';*/
		$html .= '<tr>';
			$html .= '<th colspan="3.5"><br/>Invoice Total</th>';
			$html .= '<td colspan="1" style="padding:5px;text-align:center;"><br/>'.number_format_ind($tot_qty).'</td>';
			$html .= '<td colspan="1" style="padding:5px;text-align:center;"><br/></td>';
			$html .= '<td colspan="1.5" style="padding:5px;text-align:center;"><br/>'.number_format_ind($famt).'</td>';
		$html .= '</tr>';
		$html .= '<tr>';
			//$html .= '<td colspan="4"><br/><br/><b>Amount in words:</b> '.$amtwds.'.<br/></td>';
			$html .= '<td colspan="3.5"><br/><br/><b>Amount in words:</b> '.convert_number_to_words($famt).' Rupees Only.<br/></td>';
			$html .= '<th colspan="3.5" style="margin:5px;padding:5px;text-align:right;"><br/><br/>This Bill Amount : '.number_format_ind($famt).'<br/>Previous Balance: '.number_format_ind($post).'<br/>Received Amount : '.number_format_ind($current_orct).'<br/>Closing Balance : '.number_format_ind($camt).'</th>';
		$html .= '</tr>';
