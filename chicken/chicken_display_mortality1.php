<?php
//chicken_display_mortality1.php
    ...
    <html>
		...
		<section class="content-header">
			<ol class="breadcrumb">
				...
				<li class="active">Display Mortality</li>
			</ol>
			<h1>Mortality</h1>
		</section><br/>
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php
                                    ...
                                    $sql = "SELECT * FROM `item_closingstock` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `tdflag` = '0' AND `pdflag` = '0' ORDER BY `id` DESC";
