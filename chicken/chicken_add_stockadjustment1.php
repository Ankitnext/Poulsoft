<?php
//chicken_add_stockadjustment1.php
    ...
    <html>
        ...
        <body>
            <div class="card border-secondary mb-3">
                ...
                <form action="chicken_save_stockadjustment1.php" method="post" onsubmit="return checkval();">
                    <div class="card-body">
                        <div class="row">
                            <table align="center">
                                <thead>
                                ...
                                <tbody id="row_body">
                                    <tr style="margin:5px 0px 5px 0px;">
                                        ...
                                        <?php if($jals_flag == 1) { echo '<td><input type="text" name="jals[]" id="jals[0]" class="form-control text-right" style="width:90px;" onkeyup="validate_count(this.id);calculate_row_amt(this.id);" /></td>'; } ?>
                                        <?php if($birds_flag == 1) { echo '<td><input type="text" name="birds[]" id="birds[0]" class="form-control text-right" style="width:90px;" onkeyup="validate_count(this.id);calculate_row_amt(this.id);" /></td>'; } ?>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th></th>
                                        <th></th>
                                        <?php if($jals_flag == 1) { echo '<th><input type="text" name="tot_jals" id="tot_jals" class="form-control text-right" style="width:90px;" readonly /></th>'; } ?>
                                        <?php if($birds_flag == 1) { echo '<th><input type="text" name="tot_birds" id="tot_birds" class="form-control text-right" style="width:90px;" readonly /></th>'; } ?>
            ...
            <script>
                ...
                function create_row(a){
                    ...
                    if(parseInt(jals_flag) == 1){ html += '<td><input type="text" name="jals[]" id="jals['+d+']" class="form-control text-right" style="width:90px;" onkeyup="validate_count(this.id);calculate_row_amt(this.id);" /></td>'; }
                    if(parseInt(birds_flag) == 1){ html += '<td><input type="text" name="birds[]" id="birds['+d+']" class="form-control text-right" style="width:90px;" onkeyup="validate_count(this.id);calculate_row_amt(this.id);" /></td>'; }
