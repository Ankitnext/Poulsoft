...
$sql = "UPDATE `customer_sales` SET `date` = '$date', `bookinvoice` = '$bno', `customercode` = '$cus_code', `jals` = '$cjal', `totalweight` = '$ctotalweight', `emptyweight` = '$cemptyweight', `itemcode` = '$itemcode', `birds` = '$cbird', `netweight` = '$cus_qty', `itemprice` = '$cus_iprice', `totalamt` = '$cus_tamt', `roundoff` = '$cus_roundoff', `finaltotal` = '$cus_ftotal', `balance` = '$cus_ftotal', `amtinwords` = '$cus_amtinwds', `trtype` = 'PST', `warehouse` = '$warehouse', `flag` = '0', `authorization` = '0', `tdflag` = '0', `pdflag` = '0', `drivercode` = '$driver', `vehiclecode` = '$vehicle', `discounttype` = '0.00', `discountvalue` = '0.00', `taxtype` = '0.00', `taxvalue` = '0.00', `discountamt` = '0.00', `taxamount` = '0.00', `taxcode` = '0.00', `discountcode` = '0.00', `remarks` = '$remarks', `sms_sent` = '$sms_code', `updatedemp` = '$addedemp', `updated` = '$addedtime', `client` = '$client' WHERE `invoice` = '$id'";
if(!mysqli_query($conn,$sql)){ die("Error:-".mysqli_error($conn)); } else { }

// Update purchase
$sql = "UPDATE `pur_purchase` SET `date` = '$date', `bookinvoice` = '$bno', `vendorcode` = '$sup_code', `supbrh_code` = '$supbrh_code', `jals` = '$jal', `totalweight` = '$totalweight', `emptyweight` = '$emptyweight', `itemcode` = '$itemcode', `birds` = '$bird', `netweight` = '$netweight', `itemprice` = '$sup_iprice', `totalamt` = '$sup_tamt', `roundoff` = '$sup_roundoff', `finaltotal` = '$sup_ftotal', `balance` = '$sup_ftotal', `amtinwords` = '$sup_amtinwds', `warehouse` = '$warehouse', `flag` = '0', `authorization` = '0', `tdflag` = '0', `pdflag` = '0', `drivercode` = '$driver', `vehiclecode` = '$vehicle', `discounttype` = '0.00', `discountvalue` = '0.00', `taxtype` = '0.00', `taxvalue` = '0.00', `discountamt` = '0.00', `taxamount` = '0.00', `taxcode` = '0.00', `discountcode` = '0.00', `remarks` = '$remarks', `updatedemp` = '$addedemp', `updated` = '$addedtime', `client` = '$client' WHERE `link_trnum` = '$id'";
if(!mysqli_query($conn,$sql)){ die("Error:-".mysqli_error($conn)); } else { }

	header('location:chicken_display_pursale6.php');
