<?php
//pur_updatepurchaseinvoice_ta.php
	...
	$trtype = "purchase-1";
	$trlink = "pur_displaypurchases_ta.php";
...
".$cdetails;
		...
		<script>
			...
			if(x == true){
				window.location.href = "pur_addpurchases_ta.php";
			}
			else if(x == false){
				window.location.href = "pur_displaypurchases_ta.php";
			}
		</script>
		<?php
	}
		...
		if($updatetype == "edit"){ header('location:pur_editpurchases_ta.php?id='.$id); }
			...
			if($ccount > 0){
				...
				if(!mysqli_query($conn,$sql)){
					...
					header('location:pur_displaypurchases_ta.php');
				}
			}
			else {
			?>
			...
			if(!mysqli_query($conn,$sql)){ die("Error:-".mysqli_error($conn)); } else { header('location:pur_displaypurchases_ta.php'); }
		}
