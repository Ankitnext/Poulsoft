					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<div class="col-md-18">
								...
								<form action="main_modifypursale.php" method="post" role="form" onsubmit="return checkval()">
									...
									<div class="col-md-18">
										...
										<table style="width:103%;line-height:30px;" id="tab3">
											...
											<tr id="tblrow[0]" style="margin:5px 0px 5px 0px;">
												...
												<td style="width: 150px;padding-right:5px;"><select name="snames[]" id="snames[0]" class="form-control select2" style="width: 150px;"><option value="select">-select-</option><?php foreach($sup_code as $cc){ ?><option value="<?php echo $sup_code[$cc]."@".$sup_name[$cc]; ?>" <?php if($snames == $cc){ echo "selected"; } ?>><?php echo $sup_name[$cc]; ?></option><?php } ?></select></td>

												<td><input type="text" name="bno[]" id="bno[0]" value="<?php echo $bno; ?>" class="form-control" /></td>

												<td style="width: 150px;padding-right:5px;"><select name="scat[]" id="scat[0]" class="form-control select2" style="width:150px;" onchange="checkitemtype(this.id);fetchprice(this.id);"><?php foreach($item_code as $ic){ ?><option value="<?php echo $item_code[$ic]."@".$item_name[$ic]; ?>" <?php if($scat == $ic){ echo "selected"; } ?>><?php echo $item_name[$ic]; ?></option><?php } ?></select></td>

												<td <?php if($ifjbwen == 1 || $ifjbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" name="jval[]" id="jval[0]" value="<?php echo $jval; ?>" onkeyup="validatenum(this.id);calfinaltotal();" onchange="validateamount(this.id)" class="form-control" /></td>

												<td <?php if($ifjbwen == 1 || $ifjbw == 1 || $ifbw == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" name="bval[]" id="bval[0]" value="<?php echo $bval; ?>" onkeyup="validatenum(this.id);calfinaltotal();" onchange="validateamount(this.id)" class="form-control" /></td>

												<td <?php if($ifjbwen == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" name="wval[]" id="wval[0]" value="<?php echo $wval; ?>" onkeyup="validatenum(this.id);calculatenetwt(this.id);calfinaltotal();" onchange="validateamount(this.id)" class="form-control" /></td>

												<td <?php if($ifjbwen == 1){ echo $idisplay; } else { echo $ndisplay; } ?>><input type="text" name="ewval[]" id="ewval[0]" value="<?php echo $ewval; ?>" onkeyup="validatenum(this.id);calculatenetwt(this.id);calfinaltotal();" onchange="validateamount(this.id)" class="form-control" /></td>

												<td><input type="text" name="nwval[]" id="nwval[0]" value="<?php echo $nwval; ?>" onkeyup="validatenum(this.id);calculatetotal();calfinaltotal();" onchange="validateamount(this.id)" class="form-control" /></td>

												<td><input type="text" name="sup_iprice[]" id="sup_iprice[0]" value="<?php echo $sup_iprice; ?>" onkeyup="validatenum(this.id);calculatetotal();calfinaltotal();" onchange="validateamount(this.id)" class="form-control"></td>

												<td><input type="text" name="sup_tamt[]" id="sup_tamt[0]" value="<?php echo $sup_tamt; ?>" class="form-control" readonly></td>
												...
												<td><input type="text" name="sup_famt[]" id="sup_famt[0]" value="<?php echo $sup_famt; ?>" class="form-control" readonly></td>
												...
												<td><input type="text" name="cus_iprice[]" id="cus_iprice[0]" value="<?php echo $cus_iprice; ?>" onkeyup="validatenum(this.id);calculatetotal();calfinaltotal();" onchange="validateamount(this.id)" class="form-control"></td>

												<td><input type="text" name="cus_tamt[]" id="cus_tamt[0]" value="<?php echo $cus_tamt; ?>" class="form-control" readonly></td>
												...
												<td><input type="text" name="cus_famt[]" id="cus_famt[0]" value="<?php echo $cus_famt; ?>" class="form-control" readonly></td>

												<td><input type="text" name="vehicle[]" id="vehicle[0]" value="<?php echo $vehicle; ?>" class="form-control" ></td>

												<!-- <td><input type="text" name="driver[]" id="driver[0]" value="<?php echo $driver; ?>" class="form-control" ></td> -->
