<?php
//chicken_add_generalpurchase10.php
include "newConfig.php";
include "chicken_generate_trnum_details.php";
$path = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH); $href = basename($path);
global $ufile_name; $ufile_name = 'chicken_add_generalpurchase10.php'; include "chicken_check_accessmaster.php";

if($access_error_flag == 0){
    $date = date("Y-m-d");
    //Generate Transaction No.
    $incr = 0; $prefix = $trnum = "";
    $trno_dt1 = generate_transaction_details($date,"generalpurchase10","GPP","display",$_SESSION['dbase']);
    ...
    <html>
        ...
        <body>
            <div class="card border-secondary mb-3">
                ...
                <form action="chicken_save_generalpurchase10.php" method="post" onsubmit="return checkval();">
                    <div class="card-body">
                            ...
                            <table align="center">
                                ...
                                <tbody id="row_body">
                                    <tr style="margin:5px 0px 5px 0px;">
                                        ...
                                        <td><select name="gst[]" id="gst[0]" class="form-control select2" style="width:100px;" onchange="calculate_final_totalamt(this.id);"><option value="select">Select</option><option value="5">GST@5%</option><option value="12">GST@12%</option></select></td>
                                        ...
                                        <td style="visibility: hidden;"><input type="text" name="amount1[]" id="amount1[0]" class="form-control text-right" style="width:90px;" readonly /></td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
            ...
            <script>
                ...
                function create_row(a){
                    ...
                    html += '<td style="visibility:hidden;"><input type="text" name="amount1[]" id="amount1['+d+']" class="form-control text-right" style="width:90px;" readonly /></td>';
