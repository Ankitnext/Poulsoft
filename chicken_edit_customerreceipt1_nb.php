<?php
//chicken_edit_customerreceipt1_nb.php
    ...
    <html>
        ...
        <body>
            ...
            <div class="card border-secondary mb-3">
                ...
                <form action="chicken_modify_customerreceipt1_nb.php" method="post" onsubmit="return checkval();">
                    <div class="card-body">
                        <div class="row">
                            <table align="center">
                                <thead>
                                    <tr>
                                        ...
                                        <!-- <th>Doc No</th> -->
                                        <th style="visibility:hidden;">Sector<b style="color:red;">&nbsp;*</b></th>
                                        <th>Remarks</th>
                                ...
                                <tbody id="row_body">
                                    <tr style="margin:5px 0px 5px 0px;">
                                        ...
                                        <!-- <td><input type="text" name="dcno" id="dcno" class="form-control" value="<?php echo $dcno; ?>" style="width:90px;" onkeyup="validate_name(this.id);" /></td> -->
                                        <td style="visibility:hidden;"><select name="sector" id="sector" class="form-control select2" style="width:180px;"><option value="select">-select-</option><?php foreach($sector_code as $scode){ ?><option value="<?php echo $scode; ?>" <?php if($warehouse == $scode){ echo "selected"; } ?>><?php echo $sector_name[$scode]; ?></option><?php } ?></select></td>
