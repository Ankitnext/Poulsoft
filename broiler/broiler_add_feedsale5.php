...
if($link_active_flag > 0){
    ...
    if($acount == 1){
        ...
        $trno_dt1 = generate_transaction_details($date,"feedsale5","FSIN","display",$_SESSION['dbase']);
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="m-0 p-2 card-body">
                            <div class="col-md-18">
                                <form action="broiler_save_feedsale5.php" method="post" role="form" onSubmit="return checkval()">
                                    <div class="row">
                                    ...
                                    <table>
                                        ...
                                        <tbody id="row_body">
                                            <tr>
                                                <td><select name="icode[]" id="icode[0]" class="form-control select2" style="width:180px;" onchange="fetch_stock_master(this.id);fetch_bags(this.id);"><option value="select">select</option><?php foreach($item_code as $icode){ ?><option value="<?php echo $icode; ?>"><?php echo $item_name[$icode]; ?></option><?php } ?></select></td>
                                                <td><input type="text" name="nof_bags[]" id="nof_bags[0]" class="form-control text-right" style="width:90px;" onkeyup="validatenum(this.id);calculate_total_amt(this.id);" onchange="validateamount(this.id);" ></td>
                                                <td><input type="text" name="rcd_qty[]" id="rcd_qty[0]" class="form-control text-right" style="width:90px;" onkeyup="validatenum(this.id);calculate_total_amt(this.id);" onchange="validateamount(this.id);" readonly></td>
                                                <td><input type="text" name="mrp_prc[]" id="mrp_prc[0]" class="form-control text-right" style="width:90px;" onkeyup="validatenum(this.id);calculate_total_amt(this.id)" onchange="validateamount(this.id);" ></td>
                                                <td><input type="text" name="dis_pper[]" id="dis_pper[0]" class="form-control text-right" placeholder="%" style="width:80px;" onkeyup="validatenum(this.id);fetch_discount_amount(this.id);"></td>
                                                <td><input type="text" name="dis_pamt[]" id="dis_pamt[0]" class="form-control text-right" placeholder="&#8377" style="width:80px;" onkeyup="validatenum(this.id);fetch_discount_amount(this.id);"></td>
                                                <td><input type="text" name="bag_rate[]" id="bag_rate[0]" class="form-control text-right" style="width:90px;" readonly ></td>
                                                <td><input type="text" name="item_tamt[]" id="item_tamt[0]" class="form-control text-right" style="width:90px;" readonly ></td>
                                                <!-- <td style="width:105px;visibility:hidden;"><select name="gst_val[]" id="gst_val[0]" class="form-control select2" onchange="calculate_total_amt(this.id);" style="width:100px;"><option value="select">select</option><?php foreach($gst_code as $gsts){ $gst_cval = $gsts."@".$gst_value[$gsts]."@".$gst_coa[$gsts]; ?><option value="<?php echo $gst_cval; ?>"><?php echo $gst_name[$gsts]; ?></option><?php } ?></select></td> -->
                                                ...
                                                <td style="visibility:visible;"><input type="text" name="avl_stk_qty[]" id="avl_stk_qty[0]" class="form-control text-right" style="width:60px;" readonly ></td>
                                                <td style="visibility:visible;"><input type="text" name="avl_stk_prc[]" id="avl_stk_prc[0]" class="form-control text-right" style="width:60px;" readonly ></td>
                                                <td><input type="text" name="farm_mnu_name[]" id="farm_mnu_name[0]" class="form-control" style="width:80px;" /></td>
                                                <td><input type="text" name="batch_mnu_name[]" id="batch_mnu_name[0]" class="form-control" style="width:80px;" /></td>
                                                <td style="visibility:hidden;"><input type="text" name="gst_amt[]" id="gst_amt[0]" class="form-control text-right" style="width:20px;" ></td>
                                                <td style="visibility:hidden;"><input type="text" name="bag_size[]" id="bag_size[0]" class="form-control text-right" style="width:20px;" ></td>
                                                <td style="visibility:hidden;"><input type="text" name="rate[]" id="rate[0]" class="form-control text-right" style="width:20px;" readonly ></td>
                                            </tr>
                                        </tbody>
                                    </table><br/>
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="freight_amount" id="freight_amount" class="form-control text-right" onkeyup="validatenum(this.id);calculate_final_total_amount();" onchange="validateamount(this.id)" />
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group" style="visibility:visible;">
                                                ...
                                                <input type="text" name="round_off" id="round_off" class="form-control text-right" readonly />
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 form-group">
                                                ...
                                                <input type="text" name="final_total" id="final_total" class="form-control text-right" readonly />
                                            </div>
                                            <div class="col-md-2"></div>
                                        </div>
                                    </div>
