    ...
    <body class="m-0 hold-transition">
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Add Line Sales</h3></div>
                        </div>
                        <div class="m-0 p-2 card-body">
                            <div class="col-md-18">
                                <form action="broiler_save_linesale.php" method="post" role="form" onSubmit="return checkval()">
                                    <div class="row">
                                    ...
                                    <table>
                                        ...
                                        <tbody id="row_body">
                                            <tr>
                                                <td><select name="icode[]" id="icode[0]" class="form-control select2" style="width:180px;" ><?php foreach($item_code as $prod_code){ ?><option value="<?php echo $prod_code; ?>"><?php echo $item_name[$prod_code]; ?></option><?php } ?></select></td>
                                                <td><input type="text" name="birds[]" id="birds[0]" class="form-control" placeholder="0.00" style="width:90px;" onKeyUp="validatenum(this.id);" ></td>
                                                <td><input type="text" name="rcd_qty[]" id="rcd_qty[0]" class="form-control" placeholder="0.00" style="width:90px;" onKeyUp="validatenum(this.id);calculate_total_amt(this.id);call_avgwt(this.id);" onChange="validateamount(this.id);" ></td>
                                                <td><input type="text" name="avg_wt[]" id="avg_wt[0]" class="form-control" placeholder="0.00" style="width:90px;" readonly ></td>
                                    ...
                                    <div class="row" style="margin-bottom:3px;">
                                        <div class="col-md-3 form-group">
                                            ...
                                            <select name="freight_pay_acc" id="freight_pay_acc" class="form-control select2">
                                                <option value="select">select</option>
                                                <?php //foreach($transport_code as $prod_code){ ?><option value="<?php //echo $prod_code; ?>"><?php //echo $transport_name[$prod_code]; ?></option><?php //} ?>
                                            </select>
                                        </div>
                                        <div class="col-md-3 form-group">
                                            <label>Transportation Cost</label>
                                            <input type="text" name="transport_cost" id="transport_cost" class="form-control" placeholder="0.00" onkeyup="calculate_final_total_amount()" >
                                        </div>
                                        <div class="col-md-3 form-group">
        ...
        <script>
            ...
            function create_row(a){
                ...
                html += '<tr id="row_no['+d+']">';
                html += '<td><select name="icode[]" id="icode['+d+']" class="form-control select2" style="width:180px;" ><?php foreach($item_code as $prod_code){ ?><option value="<?php echo $prod_code; ?>"><?php echo $item_name[$prod_code]; ?></option><?php } ?></select></td>';
                html += '<td><input type="text" name="birds[]" id="birds['+d+']" class="form-control" placeholder="0.00" style="width:90px;" onKeyUp="validatenum(this.id);" ></td>';
                ...
                html += '<td><input type="text" name="avg_wt[]" id="avg_wt['+d+']" class="form-control" placeholder="0.00" style="width:90px;" readonly ></td>';
