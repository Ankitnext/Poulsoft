<?php
//broiler_save_purchase23.php
session_start(); include "newConfig.php";
$dbname = $_SESSION['dbase'];
$addedemp = $_SESSION['userid'];
date_default_timezone_set("Asia/Kolkata");
$addedtime = date('Y-m-d H:i:s');
$ccid = $_SESSION['purchase23'];
...
$mnu_tds_edit = $_POST['mnu_tds_edit'];
...
for($i = 0;$i < $dsize;$i++){
    ...
    if(!mysqli_query($conn,$sql)){ die("Error 1:-".mysqli_error($conn)); }
        ...
        $prices = 0; $prices = $amount / $rcd_qty[$i];
        /* ***** Supplier Quantity ***** */
        ...
        VALUES ('CR','$coa_Cr','$date','$vcode','$trnum','$icode[$i]','$rcd_qty[$i]','$prices','$amount','$warehouse[$i]','$farm_batch','$remarks','0','Purchase-RcvQty','0','1','0','$addedemp','$addedtime','$addedtime')";
        if(!mysqli_query($conn,$from_post)){ die("Error 2:-".mysqli_error($conn)); } else{ }

        /* ***** Free Quantity ***** */
        if($fre_qty[$i] > 0){
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('CR','$coa_Cr','$date','$vcode','$trnum','$icode[$i]','$fre_qty[$i]','0','0','$warehouse[$i]','$farm_batch','$remarks','0','Purchase-FreeQty','0','1','0','$addedemp','$addedtime','$addedtime')";
        ...
        $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
        VALUES ('DR','$coa_Dr','$date','$vcode','$trnum','$icode[$i]','$item_stock_qty','$item_avg_price','$item_avg_amount','$warehouse[$i]','$farm_batch','$remarks','0','Purchase-RcvQty','0','1','0','$addedemp','$addedtime','$addedtime')";
        if(!mysqli_query($conn,$from_post)){ die("Error 3:-".mysqli_error($conn)); } else{ }

        /* ***** GST ***** */
        if($gst_amt[$i] > 0){
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('CR','$coa_Cr','$date','$vcode','$trnum','$icode[$i]','0','$gst_value[$i]','$gst_amt[$i]','$warehouse[$i]','$farm_batch','$remarks','0','Purchase-GST','0','1','0','$addedemp','$addedtime','$addedtime')";
            if(!mysqli_query($conn,$from_post)){ die("GST Error 1:-".mysqli_error($conn)); } else{ }
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('DR','$gst_acc','$date','$vcode','$trnum','$icode[$i]','0','$gst_value[$i]','$gst_amt[$i]','$warehouse[$i]','$farm_batch','$remarks','0','Purchase-GST','0','1','0','$addedemp','$addedtime','$addedtime')";
            if(!mysqli_query($conn,$from_post)){ die("GST Error 2:-".mysqli_error($conn)); } else{ }
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('CR','$gst_acc','$date','$vcode','$trnum','$icode[$i]','0','$gst_value[$i]','$gst_amt[$i]','$warehouse[$i]','$farm_batch','$remarks','0','Purchase-GST','0','1','0','$addedemp','$addedtime','$addedtime')";
        ...
        if($dis_amt[$i] > 0){
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('DR','$discount_code','$date','$vcode','$trnum','$icode[$i]','0','$dis_per[$i]','$dis_amt[$i]','$warehouse[$i]','$farm_batch','$remarks','0','Purchase-Discount','0','1','0','$addedemp','$addedtime','$addedtime')";
            if(!mysqli_query($conn,$from_post)){ die("Discount Error:-".mysqli_error($conn)); } else{ }
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('CR','$discount_code','$date','$vcode','$trnum','$icode[$i]','0','$dis_per[$i]','$dis_amt[$i]','$warehouse[$i]','$farm_batch','$remarks','0','Purchase-Discount','0','1','0','$addedemp','$addedtime','$addedtime')";
            if(!mysqli_query($conn,$from_post)){ die("Discount Error:-".mysqli_error($conn)); } else{ }
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('DR','$coa_Cr','$date','$vcode','$trnum','$icode[$i]','0','$dis_per[$i]','$dis_amt[$i]','$warehouse[$i]','$farm_batch','$remarks','0','Purchase-Discount','0','1','0','$addedemp','$addedtime','$addedtime')";
            if(!mysqli_query($conn,$from_post)){ die("Discount Error:-".mysqli_error($conn)); } else{ }
        }
...
/* ***** TCS ***** */
if($tcds_amt > 0){
    $sql = "SELECT * FROM `main_tcds` WHERE `type` = 'TCS' AND `fdate` <='$date' AND `tdate` >= '$date'"; $query = mysqli_query($conn,$sql);
    while($row = mysqli_fetch_assoc($query)){ $tds_code = $row['coa']; }
    $coa_Cr = $control_acc_group[$contact_group[$vcode]];
    $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
    VALUES ('CR','$coa_Cr','$date','$vcode','$trnum','','0','0','$tcds_amt','','','$remarks','0','Purchase-TCS','0','1','0','$addedemp','$addedtime','$addedtime')";
    if(!mysqli_query($conn,$from_post)){ die("TCS Error 1:-".mysqli_error($conn)); }
    else{
        $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
        VALUES ('DR','$tds_code','$date','$vcode','$trnum','','0','0','$tcds_amt','','','$remarks','0','Purchase-TCS','0','1','0','$addedemp','$addedtime','$addedtime')";
        if(!mysqli_query($conn,$from_post)){ die("TCS Error 2:-".mysqli_error($conn)); } else{ }
        if((int)$tcson_item_flag == 1){
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('CR','$tds_code','$date','$vcode','$trnum','','0','0','$tcds_amt','','','$remarks','0','Purchase-TCS','0','1','0','$addedemp','$addedtime','$addedtime')";
            if(!mysqli_query($conn,$from_post)){ die("TCS Error 2:-".mysqli_error($conn)); } else{ }
        }
    }
}
header('location:broiler_display_purchase23.php?ccid='.$ccid);
?>