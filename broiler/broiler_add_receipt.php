<?php
//broiler_add_receipt.php
include "newConfig.php";
date_default_timezone_set("Asia/Kolkata");
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $ccid = $_SESSION['receipt'];
    ...
    <body class="m-0 p-0 hold-transition">
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Add Receipt</h3></div>
                        </div>
                        <div class="p-0 pt-5 card-body">
                            <div class="col-md-12">
                                <form action="broiler_save_receipt.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                        ...
                                        <div class="form-group" style="width:170px;">
							                ...
							                <select name="sector" id="sector" class="form-control select2" style="width:160px;" ><option value="select">select</option><?php foreach($wcode as $fcode){ ?> <option value="<?php echo $wcode[$fcode]; ?>" <?php if($fcode == $sec_hcode){ echo "selected"; } ?>><?php echo $wdesc[$fcode]; ?></option> <?php } ?> </select>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group" style="width:170px;">
                                        ...
                                        <div class="form-group" style="width:110px;">
							                ...
							                <input type="text" name="amount[]" id="amount[0]" class="form-control" style="width:100px;" onkeyup="getamountinwords();validatenum(this.id);" onchange="validateamount(this.id);">
                                        </div>
                                        <div class="form-group" style="width:110px;">
                                            <label>Reference No</label>
							                <input type="text" name="dcno[]" id="dcno[0]" class="form-control" style="width:100px;" onkeyup="validatename(this.id);" />
                                        </div>
                                        <div class="form-group" style="width:130px;">
                                            <label>Remarks</label>
							                <textarea name="remark[]" id="remark[0]" class="form-control" style="width:120px;height:23px;" onkeyup="validatename(this.id);"></textarea>
                                        </div>
        ...
        <script>
            function return_back(){
                ...
                window.location.href = 'broiler_display_receipt.php?ccid='+ccid;
            }
            function create_row(a){
                ...
                html += '<div class="form-group" style="width:110px;"><label class="labelrow" style="display:none;">Reference No<b style="color:red;">&nbsp;*</b></label><input type="text" name="dcno[]" id="dcno['+c+']" class="form-control" style="width:100px;" onkeyup="validatename(this.id);"></div>';
                ...
                html += '<div class="form-group" style="width:130px;"><label class="labelrow" style="display:none;">Remarks</label><textarea name="remark[]" id="remark['+c+']" class="form-control" style="width:120px;height:23px;" onkeyup="validatename(this.id);"></textarea></div>';
                ...
                html += '<div class="form-group" style="width:60px;visibility:hidden;"><label class="labelrow" style="display:none;">G-total<b style="color:red;">&nbsp;*</b></label><input type="text" name="gtamtinwords[]" id="gtamtinwords['+c+']" class="form-control" style="width:50px;"></div>';
                html += '</div>';
                    ...
                    for (var j=0;j<=a;j++){
                        if(k == true){
                            ...
                            if(b.match("select")){
                                ...
                                alert("Please select mode of receipt in row : "+l);
