<?php
//breeder_display_stocktransfer1.php
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM `item_stocktransfers` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `dflag` = '0' AND `trtype` = 'stocktransfer1' AND `trlink` = 'breeder_display_stocktransfer1.php' ORDER BY `id` DESC";
        ...
        <script>
			function checkdelete(x){
                ...
                if(trnum != ""){
                    ...
                    var method = "GET";
                    var url = "breeder_check_stocktransfer1.php?trnum="+trnum;
                    //window.open(url);
