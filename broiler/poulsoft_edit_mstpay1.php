...
<html lang="en">
    ...
    <body class="m-0 hold-transition">
        <?php
        $ids = $_GET['trnum']; $mdate = date("Y-m-d",strtotime($rng_sdate));
        $sql = "SELECT * FROM `master_payments` WHERE `date` >= '$mdate' AND `trnum` = '$ids' AND `dflag` = '0' AND `trlink` = 'poulsoft_display_mstpay1.php'";
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="pl-2 card-body">
                            <form action="poulsoft_modify_mstpay1.php" method="post" role="form" onsubmit="return checkval()">
