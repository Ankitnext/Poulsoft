<?php
//broiler_display_feedsale_lsfi.php
include "newConfig.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $cid = $_GET['ccid'];
if($cid != ""){ $_SESSION['feedsale_lsfi'] = $cid; } else{ $cid = $_SESSION['feedsale_lsfi']; }
...
<html lang="en">
    ...
    <body class="m-0 hold-transition sidebar-mini">
        ...
        if($acount == 1){
            ...
            $sale_print1 = 0;
            $sql = "SELECT * FROM `extra_access` WHERE `field_name` = 'broiler_display_feedsale_lsfi.php' AND `field_function` = 'Sale Invoice Format-1' AND `user_access` LIKE 'all' AND `flag` = '1'";
