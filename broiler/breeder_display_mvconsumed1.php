<?php
//breeder_display_mvconsumed1.php
                    ...
                    <div class="m-0 p-0 card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        $sql = "SELECT * FROM `breeder_shed_allocation` WHERE `dflag` = '0' AND `cls_flag` = '0' ORDER BY `description` ASC";
                                        ...
                                        $sql = "SELECT * FROM `breeder_medicine_consumed` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `dflag` = '0' AND `trtype` = 'mvconsumed1' AND `trlink` = 'breeder_display_mvconsumed1.php' ORDER BY `id` DESC"; $query = mysqli_query($conn,$sql); $c = 0;
                                        while($row = mysqli_fetch_assoc($query)){
                                            $id = $row['trnum'];
        ...
        <script>
			function checkdelete(x){
                ...
                if(trnum != ""){
                    ...
                    var method = "GET";
                    var url = "breeder_check_mvconsumed1.php?trnum="+trnum+"&flock="+flock+"&iname="+iname+"&iqty="+iqty;
                    //window.open(url);
