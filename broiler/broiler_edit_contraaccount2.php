<?php
//broiler_edit_contraaccount2.php
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="m-0 p-2 card-body">
                            <div class="col-md-18">
                                <form action="broiler_modify_contraaccount2.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                    <table>
                                        <thead>
            ...
            function checkval(){
				...
				if(b.match("select")){
                 ...
                 // Check if the selected values are the same
                    ...
                    alert("The selected values in From CoA and To CoA cannot be the same  ");
                    document.getElementById("tcoa").value = "select"; // Reset the tcoa dropdown
                    document.getElementById("tcoa").focus();
                    k = false;
                }
