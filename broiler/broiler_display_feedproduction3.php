<?php
//broiler_display_feedproduction3.php
...
if($cid != ""){ $_SESSION['feedproduction3'] = $cid; } else{ $cid = $_SESSION['feedproduction3']; }
...
<html lang="en">
    ...
    <body class="m-0 hold-transition sidebar-mini">
        ...
        if($acount == 1){
            ...
            $sql = "SELECT * FROM `extra_access` WHERE `field_name` = 'broiler_display_feedproduction3.php' AND `field_function` = 'Converting Feed To Bags' AND `flag` = '1'";
