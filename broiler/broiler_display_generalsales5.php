...
<html lang="en">
    ...
    <body class="m-0 hold-transition sidebar-mini">
        ...
        if($acount == 1){
            ...
            if(in_array("dmobile_no", $existing_col_names, TRUE) == ""){ $sql = "ALTER TABLE `broiler_sales` ADD `dmobile_no` VARCHAR(300) NULL DEFAULT NULL COMMENT '' AFTER `driver_mobile`"; mysqli_query($conn,$sql); }
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        while($row = mysqli_fetch_assoc($query)){
                                            ...
                                            $print_dt = "?vcode=".$row['vcode']."&trnum=".$id."&warehouse=".$row['warehouse']."&date=".$row['date'];

                                            // $ref_docs = "";
                                            // if($row['file_path1'] != ""){
                                            //     $ref_docs .= '<a href="../'.$row["file_path1"].'" download title="download"><i class="fa-solid fa-angles-down" style="font-size:15px;"></i></a>&ensp;';
                                            // }
                                            // if($row['file_path2'] != ""){
                                            //     $ref_docs .= '<a href="../'.$row["file_path2"].'" download title="download"><i class="fa-solid fa-angles-down" style="font-size:15px;"></i></a>&ensp;';
                                            // }
                                            // if($row['file_path3'] != ""){
                                            //     $ref_docs .= '<a href="../'.$row["file_path3"].'" download title="download"><i class="fa-solid fa-angles-down" style="font-size:15px;"></i></a>&ensp;';
                                            // }
                                    ?>
                                    <tr>
