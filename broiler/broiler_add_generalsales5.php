...
if($link_active_flag > 0){
    ...
    if($acount == 1){
        ...
        $trno_dt1 = generate_transaction_details($date,"generalsales5","GGS","display",$_SESSION['dbase']);
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="m-0 p-2 card-body">
                            <div class="col-md-18">
                                <form action="broiler_save_generalsales5.php" method="post" role="form" enctype="multipart/form-data" onSubmit="return checkval()">
                                    <div class="row">
