<?php
//broiler_edit_growingcharge_spfp.php
include "newConfig.php";
date_default_timezone_set("Asia/Kolkata");
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $ccid = $_SESSION['growingcharge_spfp'];
...
<html lang="en">
    ...
    <body class="m-0 p-0 hold-transition">
        ...
        while($row = mysqli_fetch_assoc($query)){
            ...
            $actual_birds = $row['actual_birds']; if($actual_birds == ""){ $actual_birds = 0;}
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="p-0 pt-2 card-body">
                            <div class="col-md-12">
                                <form action="broiler_modify_growingcharge_spfp.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align:right;"><label>S.FCR</label></td>
                                                    <td><input type="text" name="sfcr" id="fcr" class="form-control" value="<?php echo round($sfcr,3); ?>" readonly /></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="text-align:right;"><label>Actual Birds</label></td>
                                                    <td><input type="text" name="actual_birds" id="actual_birds" class="form-control" value="<?php echo round($actual_birds,2); ?>" readonly /></td>
  ...
  <span></span>
        ...
        <script>
            function return_back(){
                ...
                window.location.href = 'broiler_display_growingcharge_spfp.php?ccid='+ccid;
            }
            function checkval(){
            ...
            function fetch_farmdetails(){
                ...
                if(!farm_code.match("select")){
					...
					var method = "GET";
					var url = "broiler_fetch_rearingcharge_spfp2.php?farm_code="+farm_code+"&batch_code="+batch_code;
                    //window.open(url);
					...
					fetchgc.onreadystatechange = function(){
						if(this.readyState == 4 && this.status == 200){
							...
							if(bbal == "") {
                                ...
                                document.getElementById("days7_mort_count").value = farm_details[94];
                                document.getElementById("days30_mort_count").value = farm_details[95];
                                document.getElementById("days31_mort_count").value = farm_details[96];
                                document.getElementById("actual_birds").value = farm_details[97];
                                document.getElementById("sfcr").value = farm_details[98];

                                document.getElementById('mortality_deduction').title = "Total Mortality Deduction Qty: "+farm_details[93]+", Amount: "+farm_details[88]+"\n2 Week Culls Qty: "+farm_details[89]+"\u205f\u205f, Amount: "+farm_details[90]+"\n>45 Mortality Qty: "+farm_details[91]+"\u205f\u205f, Amount"+farm_details[92]+"\nFinal Deduction Amount: "+farm_details[60];
