                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="m-0 p-2 card-body">
                            <div class="col-md-18">
                                <form action="broiler_modify_purchase23.php" method="post" role="form" enctype="multipart/form-data" onsubmit="return checkval()">
                                    <div class="row">
                                    ...
                                    <div class="row" style="margin-bottom:3px;" id="row_no[<?php echo $i; ?>]">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="item_tamt[]" id="item_tamt[<?php echo $i; ?>]" value="<?php echo $item_tamt[$i]; ?>" class="form-control" placeholder="0.00" style="width:90px;" onkeyup="validatenum(this.id);cal_prc(this.id);" >
                                        </div>
                                        <div class="form-group">
