...
if($ccount > 0){ ?>
	<script>
		...
		if(x == true){ window.location.href = "broiler_add_item1.php?ccid="+ccid; } else if(x == false) { window.location.href = "broiler_add_item1.php?ccid="+ccid; } else { window.location.href = "broiler_add_item.php?ccid="+ccid; }
	</script>
<?php
}
else {
	...
	('$incrs','$prefix','$ctype','$sub_category','$hsn_code','$code','$cdesc','$cunits','$cunits','$einv_units','$item_size','$offals_flag','$bfamf_flag','$sector_access','$ob_stock','$price','$amount','$ob_date','$gst_code','$lsflag','$lsqty','$addedemp','$addedtime')";
