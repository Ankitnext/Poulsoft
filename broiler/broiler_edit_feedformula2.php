    ...
    <body class="m-0 hold-transition">
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Edit Feed Formula</h3></div>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="broiler_modify_feedformula2.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                    ...
                                    <div class="row" id="row_no[<?php echo $c; ?>]">
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <?php if($c == 0){ echo '<label>Quantity<b style="color:red;">&nbsp;*</b></label>'; } ?>
							                    <input type="text" name="item_qty[]" id="item_qty[<?php echo $c; ?>]" class="form-control" value="<?php echo round($row['item_qty'],3); ?>" onkeyup="validatenum(this.id);calculatetotal(); val_amt();" onchange="validateamount(this.id)" >
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                            <?php if($c == 0){ echo '<label>Rate<b style="color:red;">&nbsp;*</b></label>'; } ?>
							                    <input type="text" name="rate[]" id="rate[<?php echo $c; ?>]" class="form-control" value="<?php echo round($row['rate'],3); ?>" onkeyup="validatenum(this.id);calculatetotal_rate(); val_amt();" onchange="validateamount(this.id)" >
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                            <?php if($c == 0){ echo '<label>Amount<b style="color:red;">&nbsp;*</b></label>'; } ?>
							                    <input type="text" name="amount[]" id="amount[<?php echo $c; ?>]" class="form-control" value="<?php echo round($row['amount'],3); ?>" onkeyup="validatenum(this.id);calculatetotal_amt();" onchange="validateamount(this.id)" >
                                            </div>
                                        </div>
                                        <?php
                                            if($c == 0 && $c == $isize - 1){
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
							                    ...
							                    <input type="text" name="total_rate" id="total_rate" class="form-control" value="<?php echo $total_rate; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
        ...
        <script>
            ...
            function create_row(a){
                ...
                html+= '<div class="col-md-1"><div class="form-group"><input type="text" name="amount[]" id="amount['+d+']" class="form-control" onkeyup="validatenum(this.id);calculatetotal();" onchange="validateamount(this.id)" ></div></div>';
            ...
            function val_amt(){
                ...
                for(var b = 0;b <= a;b++){
                    ...
                    c = parseFloat(d) * parseFloat(r);
                     document.getElementById("amount["+b+"]").value = c;
                } 
                calculatetotal_amt();
            }
