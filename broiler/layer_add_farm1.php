            ...
            <section class="m-0 p-0 content">
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="layer_save_farm1.php" method="post" role="form" onsubmit="return checkval()">
        ...
        <script>
			...
			function check_duplicate(a){
				...
				if(description != ""){
					...
					var method = "GET";
					var url = "layer_fetch_farm1_duplicates.php?description="+description+"&type="+type+"&row_count="+d;
                    //window.open(url);
