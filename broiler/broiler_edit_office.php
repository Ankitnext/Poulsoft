...
<html lang="en">
    ...
    <body class="m-0 hold-transition">
        <?php
		$id = $_GET['id'];
		$sql = "SELECT * FROM `inv_sectors` WHERE `id` = '$id'"; $query = mysqli_query($conn,$sql);
		while($row = mysqli_fetch_assoc($query)){
			$description = $row['description'];
			$type = $row['type'];
			$location = $row['location'];
			$sector_address = $row['sector_address'];
			$smanager = $row['smanager'];
			$mobile = $row['mobile'];
			$email = $row['email'];
			$address = $row['address'];
			$state = $row['state'];
			$brd_sflag = $row['brd_sflag'];
			$lyr_sflag = $row['lyr_sflag'];
		}
		?>
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Edit Office</h3></div>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="broiler_modify_office.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                        <div class="col-md-4"></div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                            <label>Sector Description<b style="color:red;">&nbsp;*</b></label>
							                <input type="text" name="idesc" id="idesc" class="form-control" placeholder="Enter description..." value="<?php echo $description; ?>" onkeyup="validatename(this.id)" onchange="check_duplicate()">
                                            </div>
                                        </div>
                                        <div class="col-md-4"></div>
                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="stype" id="stype" class="form-control select2" style="width: 100%;" onchange="addretailinfo()">
                                                    ...
                                                    <?php
                                                        ...
                                                        while($row = mysqli_fetch_assoc($query)){
                                                    ?>
                                                            <option <?php if($type == $row['code']){ echo 'selected'; } ?> value="<?php echo $row['code']; ?>"><?php echo $row['description']; ?></option>
                                                    <?php
                                                        }
                                                    ?>
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="sloc" id="sloc" class="form-control" value="<?php echo $location; ?>" placeholder="Enter Location..." onkeyup="validatename(this.id)">
                                        </div>
                                        <div class="col-md-4"></div>
                                    </div>
                                    ...
                                    <div class="row justify-content-center align-items-center">
                                        <div class="form-group">
                                            <label for="brd_sflag"><input type="checkbox" name="brd_sflag" id="brd_sflag" <?php if($brd_sflag == 1){ echo "checked"; } ?> />&nbsp;Breeder</label>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <div class="row justify-content-center align-items-center">
                                        <div class="form-group">
                                            <label for="lyr_sflag"><input type="checkbox" name="lyr_sflag" id="lyr_sflag" <?php if($lyr_sflag == 1){ echo "checked"; } ?> />&nbsp;layer</label>
                                        </div>
                                    </div>
                                    <?php } ?>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <Textarea name="sector_address" id="sector_address" rows="4" cols="50" maxlength="300"  class="form-control" onkeyup="validatename(this.id)"><?php echo $sector_address; ?></Textarea>
                                        </div>
                                        <div class="col-md-4"></div>
                                    </div>
                                    <div class="col-md-12" id="shop_details" <?php if($type == $shop_code){ echo 'style="visibility:visible;"'; } else{ echo 'style="visibility:hidden;"'; } ?>>
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="form-group col-md-4">
                                                    <label>Shop Manager</label>
                                                    <input type="text" name="shop_manager" id="shop_manager" class="form-control" placeholder="Manager Name..." value="<?php echo $smanager; ?>">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label>Phone/Mobile</label>
                                                    <input type="text" name="shop_mobile" id="shop_mobile" class="form-control" placeholder="Mobile No..." value="<?php echo $mobile; ?>">
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label>State</label>
                                                    <input type="text" name="shop_state" id="shop_state" class="form-control" placeholder="State..." value="<?php echo $state; ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label>Address</label>
                                                    <input type="text" name="shop_address" id="shop_address" class="form-control" placeholder="Enter Address..." value="<?php echo $address; ?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label>Email</label>
                                                    <input type="text" name="shop_email" id="shop_email" class="form-control" placeholder="Enter Email..." value="<?php echo $email; ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
			...
			function check_duplicate(){
				...
				if(!b.length == 0){
					...
					var method = "GET";
					var url = "broiler_fetch_sector_duplicates.php?cname="+b+"&type="+c+"&id="+d;
                    //window.open(url);
