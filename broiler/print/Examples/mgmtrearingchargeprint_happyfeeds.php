<?php
//mgmtrearingchargeprint_happyfeeds.php
...
$actual_gc_amt = round(($grow_charge_exp_prc * $sold_weight));
...
$total_earnings = round((($actual_gc_amt) +($sales_incentive_amt) +($mortality_incentive_amt) +($fcr_incentive_amt) +($other_incentive) +($ifft_charges)),2);


$sql_record = "SELECT sum(transport_cost) as transport_cost FROM `item_stocktransfers` WHERE towarehouse = '$farm_code' AND to_batch = '$batch_code' AND dflag = 0 ANd active = 1";
$query = mysqli_query($conn,$sql_record); 
while($row = mysqli_fetch_assoc($query)){
    $transportation_charges = $row['transport_cost'];
}
...
if($b1no > 0){
    ...
    $sql_record = "SELECT sum(transport_cost) as transport_cost FROM `item_stocktransfers` WHERE towarehouse = '$farm_code' AND to_batch = '$b1_Batch_code' AND dflag = 0 ANd active = 1";
    $query = mysqli_query($conn,$sql_record); $b1_transport_amt = 0;
    while($row = mysqli_fetch_assoc($query)){
        $b1_transport_amt = $row['transport_cost'];
    }
    ...
    while($row = mysqli_fetch_assoc($query)){
        ...
        if($row['sold_weight'] != 0){
            $b1_actual_prod_cost = round((($row['actual_chick_cost'] + $row['actual_feed_cost'] + $row['actual_medicine_cost'] + $row['admin_cost_amt'] + $row['total_amount_payable'] + $b1_transport_amt) / $row['sold_weight']),2);
        }
        else{
            $b1_actual_prod_cost = 0;
        }
        $b1_amount_payable = $row['amount_payable'];
        $b1_gap_days = (INT)((strtotime($start_date) - strtotime($row['liquid_date'])) / 60 / 60 / 24);
    }
}
if($b2no > 0){
    ...
    $sql_record = "SELECT sum(transport_cost) as transport_cost FROM `item_stocktransfers` WHERE towarehouse = '$farm_code' AND to_batch = '$b2_Batch_code' AND dflag = 0 ANd active = 1";
    $query = mysqli_query($conn,$sql_record); $b2_transport_amt = 0;
    while($row = mysqli_fetch_assoc($query)){
        $b2_transport_amt = $row['transport_cost'];
    }
    ...
    while($row = mysqli_fetch_assoc($query)){
        ...
        $b2_eef = $row['eef'];
        if($row['sold_weight'] != 0){
            $b2_actual_prod_cost = round((($row['actual_chick_cost'] + $row['actual_feed_cost'] + $row['actual_medicine_cost'] + $row['admin_cost_amt'] + $row['total_amount_payable'] + $b2_transport_amt) / $row['sold_weight']),2);
        }
        else{
            $b2_actual_prod_cost = 0;
        }
        $b2_amount_payable = $row['amount_payable'];
        $b2_gap_days = (INT)((strtotime($start_date) - strtotime($row['liquid_date'])) / 60 / 60 / 24);
    }
}
...
$sql = "SELECT * FROM `main_access` WHERE `db_emp_code` = '$sup_code' AND `active` = '1'"; $query = mysqli_query($conn,$sql);
while($row = mysqli_fetch_assoc($query)){ $log_emp_code = $row['empcode']; }

$sql = "SELECT * FROM `broiler_daily_record` WHERE `farm_code` = '$farm_code' AND  `batch_code` = '$batch_code' AND (`addedemp` LIKE '$sup_code' OR `addedemp` LIKE '$log_emp_code') AND `active` = '1' AND `dflag` = '0'";
$query = mysqli_query($conn,$sql); $sup_vcnt = 0;
while($row = mysqli_fetch_assoc($query)){ $sup_vcnt++; }
...
$html .= '</th>';
$html .= '<td colspan="2" style="padding-right: 10px;text-align:right;color:red;"><b>'.$supervisor_name.'</b></td>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;border-left: 1px solid black;">';
...
$html .= '</th>';
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;"><b>'.$grade.'</b></td>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;border-left: 1px solid black;">';
...
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;"><b>'.number_format_ind(round($total_mort,2)).'</b></td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;">';
$html .= '<b style="padding-left: 10px;text-align:left;">Housed Chicks: </b>';
$html .= '</th>';
$html .= '<td colspan="2" style="padding-left: 10px;text-align:right;color:green;"><b>'.number_format_ind(round($placed_birds)).'</b></td>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;border-left: 1px solid black;">';
$html .= '<b style="padding-left: 10px;text-align:left;color:purple;">FCR</b>';
$html .= '</th>';
$html .= '<td colspan="2" style="padding-left: 10px;text-align:right;color:green;"><b>'.number_format_ind(round($fcr,2)).'</b></td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;">';
...
$html .= '</th>';
$html .= '<td colspan="2" style="padding-left: 10px;text-align:right;color:green;"><b>'.number_format_ind(round($cfcr,2)).'</b></td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;">';
...
$html .= '</th>';
$html .= '<td colspan="2" style="padding-left: 10px;text-align:right;color:green;"><b>'.number_format_ind(round($avg_wt,2)).'</b></td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;">';
...
$html .= '</th>';
$html .= '<td colspan="2" style="padding-left: 10px;text-align:right;color:green;"><b>'.number_format_ind(round($mean_age,2)).'</b></td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;">';
...
$html .= '</th>';
$html .= '<td colspan="2" style="padding-left: 10px;text-align:right;color:green;"><b>'.number_format_ind(round($day_gain,2)).'</b></td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;">';
...
$html .= '</th>';
$html .= '<td colspan="2" style="padding-left: 10px;text-align:right;color:green;"><b>'.number_format_ind(round(($sale_rate),2)).'</b></td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;"><b style="padding-left: 10px;text-align:left;">Supervisor Visits</b></th>';
$html .= '<td colspan="2" style="padding-left: 10px;text-align:right;color:green;">'.str_replace(".00","",number_format_ind(round($sup_vcnt,2))).'</td>';
...
$html .= '<td colspan="2" style="padding-left: 10px;text-align:right;color:green;"><b></b></td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;"><b style="padding-left: 10px;text-align:left;">Gap Days</b></th>';
$html .= '<td colspan="2" style="padding-left: 10px;text-align:right;color:green;">'.str_replace(".00","",number_format_ind(round($b1_gap_days,2))).'</td>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;border-left: 1px solid black;"><b style="padding-left: 10px;text-align:left;"></b></th>';
$html .= '<td colspan="2" style="padding-left: 10px;text-align:right;color:green;"><b></b></td>';
$html .= '</tr>';
$html .= '<tr>';
...
$html .= '<td colspan="1" style="padding-right: 10px;text-align:right;color:green;"><b>'.number_format_ind(round(($t1),2)).'</b></td>';
...
if((float)$sold_weight != 0){ $t1 = $actual_medicine_cost / $sold_weight; } else{ $t1 = 0; }
...
if((float)$sold_weight != 0){ $t1 = $admin_cost_amt / $sold_weight; } else{ $t1 = 0; }
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;">'.round(($t1),2).'</td>';
...
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;border-left: 1px solid black;"><b style="padding-left: 10px;text-align:left;">Transport Cost</b></th>';
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;">'."".'</td>';
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;">'.number_format_ind(round($transportation_charges,2)).'</td>';
$html .= '</tr>';
$html .= '<tr>';
...
$actual_prod_amount = $actual_chick_cost + $actual_feed_cost + $actual_medicine_cost + $admin_cost_amt + $transportation_charges;
...
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;">'.number_format_ind(round((((float)$amount_payable) / (float)$sold_weight),2)).'</td>';
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;">'.number_format_ind(round(((float)$amount_payable),2)).'</td>';
$html .= '</tr>';
...
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;border-left: 1px solid black;"><b style="padding-left: 10px;text-align:left;">Other Sales</b></th>';
$pkg_amt = (round(((float)$total_amount_payable / (float)$sold_weight),2));
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;"></td>';
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;">'.number_format_ind(round($other_sales,2)).'</td>';
$html .= '</tr>';
...
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;border-left: 1px solid black;"><b style="padding-left: 10px;text-align:left;">Net Payable</b></th>';
$pkg_amt = (round(((float)$total_amount_payable / (float)$sold_weight),2));
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;"><b>'.number_format_ind(round($pkg_amt,2)).'</b></td>';
...
$html .= '<td colspan="2" style="padding-left: 10px;text-align:right;color:green;">'.number_format_ind(round(($actual_chick_cost + $actual_feed_cost + $actual_medicine_cost + $admin_cost_amt + $transportation_charges + $total_amount_payable + $farmer_sale_deduction),2)).'</td>';
$html .= '</tr>';
...
if((float)$sold_weight != 0){ $t1 = ($actual_prod_amount + $total_amount_payable + $farmer_sale_deduction) / $sold_weight; } else{ $t1 = 0; }
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;"><b>'.number_format_ind(round(($t1),2)).'</b></td>';
$html .= '</tr>';
...
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;border-left: 1px solid black;"><b style="padding-left: 10px;text-align:left;color:purple;">Sale Amount</b></th>';
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;">'.number_format_ind(round(($sale_rate),2)).'</td>';
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;">'.number_format_ind(round(($sale_amount),2)).'</td>';
$html .= '</tr>';

$html .= '<tr>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;">';
$html .= '<b style="padding-left: 10px;text-align:left;color:purple;font-weight:bold;"></b>';
$html .= '</th>';
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;border-left: 1px solid black;"></td>';
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;border-left: 1px solid black;"></td>';
$html .= '<th style="width:130px;padding-left: 10px;text-align:left;border-left: 1px solid black;"><b style="padding-left: 10px;text-align:left;color:purple;">Profit / Loss</b></th>';
$pal_amt = (($sale_amount) - ($actual_chick_cost + $actual_feed_cost + $actual_medicine_cost + $admin_cost_amt + $transportation_charges + $total_amount_payable + $farmer_sale_deduction));
if((float)$sold_weight != 0){ $t1 = ( $pal_amt / $sold_weight); } else{ $t1 = 0; }
if((float)$pal_amt > 0){
    $html .= '<td style="width:70px;padding-right: 10px;text-align:right;color:green;"><b>'.number_format_ind(round($t1,2)).'</b></td>';
    $html .= '<td style="width:70px;padding-right: 10px;text-align:right;color:green;"><b>'.number_format_ind(round($pal_amt,2)).'</b></td>';
}
else{
    $html .= '<td style="width:70px;padding-right: 10px;text-align:right;color:red;"><b>'.number_format_ind(round($t1,2)).'</b></td>';
    $html .= '<td style="width:70px;padding-right: 10px;text-align:right;color:red;"><b>'.number_format_ind(round($pal_amt,2)).'</b></td>';
}
$html .= '</tr>';

/*$html .= '<tr>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;">';
$html .= '<b style="padding-left: 10px;text-align:left;font-weight:bold;">Gap Days</b>';
$html .= '</th>';
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;border-left: 1px solid black;">'.$b2_gap_days.'</td>';
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;border-left: 1px solid black;">'.$b1_gap_days.'</td>';
$html .= '<th colspan="3" style="padding-left: 10px;text-align:left;border-left: 1px solid black;"><b style="padding-left: 10px;text-align:left;color:purple;"></b></th>';
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;"></td>';
$html .= '</tr>';*/
$html .= '<tr>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;border-left: 1px solid black;"><b style="padding-left: 10px;text-align:left;"></b></th>';
...
$html .= '<td colspan="1" style="padding-right: 10px;text-align:right;color:green;border-left: 1px solid black;"></td>';
$html .= '<th style="width:60px;text-align:left;border-left: 1px solid black;"><b style="padding-left: 10px;text-align:left;"></b></th>';
$html .= '<td style="width:70px;text-align:right;color:green;"></td>';
$html .= '</tr>';
$html .= '<tr>';
