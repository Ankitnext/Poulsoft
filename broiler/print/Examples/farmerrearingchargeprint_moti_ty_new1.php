...
$query = mysqli_query($conn,$sql); $lmbird = $lmbwt = $abwt = 0;
while($row = mysqli_fetch_assoc($query)){
    if($row['lb_flag'] == '1'){
...
// $sql = "SELECT * FROM `broiler_farmer` WHERE `code` LIKE '$farm_code'";
// $query = mysqli_query($conn,$sql);
// while($row = mysqli_fetch_assoc($query)){
//     echo $row['panno'];
// }
...
$html .= '<table width="100%" >
    ...
    <tr>
        ...
        <td style="width:100px;">'.$farm_name[$farm_code].'</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td width="100%" valign="top">
            <table width="90%" >
                <tr>
                    <td style="width:60px;"><strong>Bank Name </strong></td>
                    <td style="width:10px;">:</td>
                    <td style="width:80px;">'.$fmr_bank_name.'</td>
                </tr>
                <tr>
...
<table style="width: 100%; border-collapse: collapse; text-align: center; font-family: Arial, sans-serif;">
    ...
    <tbody>';
       ...
       $html .= ' <tr>
            ...
            <td style=";width:140px;text-align:left; ">Chicks Cost @ '.number_format_ind(round(($t1),2)).' </td>
            <td style=";width:10px; ">:</td>
            <td style=";;width:55px;text-align:right ">'.number_format_ind(round($chick_cost_amt,2)).'</td>
...
if($actual_prod_cost < 89){ $prod_incentive = "50%"; }else { $prod_incentive = ""; }
    $html .= '    <tr>
            ...
            <td style=";width:140px;text-align:left; ">Feed Cost @ '.number_format_ind(round(($t1),2)).'</td>
            <td style=";width:10px; ">:</td>
            <td style=";text-align:right ">'.number_format_ind(round($feed_cost_amt,2)).'</td>
...
$totalfinal =  round(($standard_gc_amt + $sales_incentive_amt + $actual_charge_exp_amt),2);
     $html .= '    <tr>
      ...
      $html .='   <tr>
            ...
            <td style=";width:140px;text-align:left; ">Total Cost Amount</td>
            <td style=";width:10px; ">:</td>
            <td style=";text-align:right; ">'.number_format_ind(round(($total_cost_amt),2)).'</td>
...
if((float)$sold_weight != 0){ $t1 = $actual_prod_amount / $sold_weight; } else{ $t1 = 0; }
      $html .= '   <tr>
            ...
            <td style=";width:10px; ">:</td>
            <td style=";text-align:right;border:1px solid black; ">'.number_format_ind(round($actual_prod_cost,2)).'</td>
         ...
         <tr>
            ...
            <td style=";width:140px;text-align:left;text-decoration: underline; ">Deductable Details</td>
            <td style="; "></td>
            <td style=";width:10px; "></td>
             <td style="; "></td>
            <td style="; "></td>
        ...
        <tr>
            ...
            <td style=";width:140px;text-align:left; ">Advance</td>
            <td style="; "></td>
            <td style=";width:10px; ">:</td>
             <td style="; "></td>
            <td style="; ">'.number_format_ind(round($advance_deduction,2)).'</td>
        </tr>

         <tr>
            <td style=";width:140px;text-align:left; ">Avg. Sales Price /kg</td>
            <td style=";width:10px; ">:</td>
            <td style=";text-align:right; "> '.number_format_ind(round($sale_rate,2)).'</td>
            <td style="; "></td>
            ...
            <td style=";width:140px;text-align:left; ">Sale in Farm A/c</td>
            <td style="; "></td>
            <td style=";width:10px; ">:</td>
             <td style="; "></td>
            <td style="; "></td>
         ...
         <tr>
            ...
            <td style=";width:140px;text-align:left; ">Penalty for Chicks</td>
            <td style="; "></td>
            <td style=";width:10px; ">:</td>
             <td style="; "></td>
            <td style="; "></td>
         ...
         <tr>
            ...
            <td style=";width:140px;text-align:left; ">Penalty for Feeds</td>
            <td style="; "></td>
            <td style=";width:10px; ">:</td>
             <td style="; "></td>
            <td style="; "></td>
        ...
        <tr>
            ...
            <td style=";width:140px;text-align:left; ">Penalty for Medicine</td>
            <td style="; "></td>
            <td style=";width:10px; ">:</td>
             <td style="; "></td>
            <td style="; "></td>
        ...
        <tr>
            ...
            <td style=";width:140px;text-align:left; ">Penalty for Birds</td>
            <td style="; "></td>
            <td style=";width:10px; ">:</td>
             <td style="; "></td>
            <td style="; "></td>
         ...
         <tr>
            ...
            <td style=";width:140px;text-align:left; ">Birds Shortage Deduction</td>
            <td style="; "></td>
            <td style=";width:10px; ">:</td>
             <td style="; ">'.$birds_shortage.'</td>
            <td style="; "></td>
        </tr>
...
<tr>
    ...
    <td style="; width: 140px; text-align: left;">Less Total Deductable Amt</td>
    <td style="; width: 50px;"></td>
    <td style="; width: 15px;">:</td>
    <td style="; width: 50px;"></td>
    <td style="; width: 50px;">'.number_format_ind(round($farmer_sale_deduction,2)).'</td>
</tr>
         ...
         <tr>
            ...
            <td style=";width:51px;text-align:left; "></td>
           

            <td style=";width:100px;text-align:left; ">Penalty for Birds</td>
            <td style="; "></td>
            <td style=";width:10px; ">:</td>
             <td style="; "></td>
            <td style="; "></td>
         ...
         <tr>
            <td style=";width:82pxt; "></td>
            <td style=";width:82px; "></td>
            <td style=";width:82px; "></td>
            <td style=";width:82px; "></td>
            <td style=";width:82px; "></td>

            <td style=";width:52px;text-align:left; "></td>
           ...
           <tr>
            ...
            <td style=";width:52px;text-align:left; "></td>
             ...
             <td style="; width: 140px; text-align: left;">Net Payment Amount</td>
    <td style=" width: 50px;"></td>
    <td style=" width: 15px;">:</td>
    <td style=" width: 50px;"></td>
    <td style=" width: 50px;text-align:right;border-top:2px solid black;border-bottom:2px solid black;">'.number_format_ind(round($finamt1 - $farmer_sale_deduction - $birds_shortage - $advance_deduction,2)).'</td>
        </tr>
      

        <tr>
            <td style="width:82pxt; ">Small</td>
            <td style="width:82px; "></td>
            <td style="width:82px; "></td>
            <td style="width:82px; "></td>
            <td style="width:82px; "></td>
        ...
        // number_format_ind(round((((($avg_wt * $lmbird)-$lmbwt)/($avg_wt * $lmbird))*100),2))
       $html .= '<tr>
        ...
        <tr>
         ...
         <tr>
            <td style="width:82pxt;border-top:1px solid black; "></td>
            <td style="width:82px;border-top:1px solid black; "></td>
            <td style="width:82px;border-top:1px solid black; "></td>
            <td style="width:82px;border-top:1px solid black; "></td>
            <td style="width:82px;border-top:1px solid black; "></td>
