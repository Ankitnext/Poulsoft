...
if($einv_gflag > 0){
    ...
    if((int)$e_cnt > 0){
        ...
        $ebill_info .= '<th style="width:180px;text-align:center;border-top:1px sold black;" rowspan="5"><br/><br/>'.$ebill_qring.'<br/></th>';
        $ebill_info .= '<th style="width:382px;text-align:left;border-top:1px sold black;"><br/><br/><br/>IRN : <b>'.$e_irn_no.'</b><br/></th>';
        $ebill_info .= '</tr>';
        $ebill_info .= '<tr style="line-height: 1.1;">';
        $ebill_info .= '<th style="width:382px;text-align:left;"><br/>Ack No. : <b>'.$e_ack_no.'</b><br/></th>';
        $ebill_info .= '</tr>';
        $ebill_info .= '<tr style="line-height: 1.1;">';
        $ebill_info .= '<th style="width:382px;text-align:left;"><br/>Ack Date : <b>'.$e_ack_date.'</b><br/></th>';
        $ebill_info .= '</tr>';
        $ebill_info .= '<tr style="line-height: 1.1;">';
        $ebill_info .= '<th style="width:382px;text-align:left;color:#ababab;"><br/>e-invoicing detail(s) generated from the Government\'s e-invoicing system.<br/><br/><br/><br/><br/></th>';
        $ebill_info .= '</tr>';
...
<b></b>'.$ven_saddress.'<br/><br/><br/><br/><br/><br/>
<b>Supply State: </b>'.$state_name.'&ensp;&ensp;
</th>';
$v_header .= '</tr>';
...
$d_header .= '<th style="width:45px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>Qty</b><br/></th>';
...
$d_header .= '<th style="width:39px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>Price</b><br/></th>';
...
$fit_footer .= '<th style="width:321px;text-align:center;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>Final Total</b><br/></th>';
$fit_footer .= '<th style="width:52px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>'.number_format_ind($tot_rqty).'</b></th>';
...
$fit_footer .= '<th style="width:45px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>'.number_format_ind($tot_damt).'</b></th>';
$fit_footer .= '<th style="width:62px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>'.number_format_ind($tot_tamt).'</b></th>';
$fit_footer .= '</tr>';

$frt_footer .= '<tr style="line-height: 0.6;">';
$frt_footer .= '<th style="width:321px;text-align:left;border-top:1px sold black;border-right:1px sold black;"><br/><br/><br/></th>';
...
$tcs_footer .= '<th style="width:321px;text-align:left;border-right:1px sold black;"><br/><br/>Acc. Holder name :<b> '.$bank_accname.'</b><br/></th>';
$tcs_footer .= '<th style="width:122px;text-align:right;"><br/><br/><b>TCS Amount</b><br/></th>';
$tcs_footer .= '<th style="width:119px;text-align:right;border-right:1px sold black;"><br/><br/>'.number_format_ind($tcds_amt[0]).'<br/></th>';
$tcs_footer .= '</tr>';

$cgst_footer .= '<tr style="line-height: 0.6;">';
$cgst_footer .= '<th style="width:321px;text-align:left;border-right:1px sold black;"><br/><br/>Account Number :<b> '.$bank_accno.'</b><br/></th>';
$cgst_footer .= '<th style="width:122px;text-align:right;"><br/><br/><b>CGST</b><br/></th>';
$cgst_footer .= '<th style="width:119px;text-align:right;border-right:1px sold black;"><br/><br/>'.number_format_ind(round(($gst_amt[0] / 2),2)).'<br/></th>';
$cgst_footer .= '</tr>';

$sgst_footer .= '<tr style="line-height: 0.6;">';
$sgst_footer .= '<th style="width:321px;text-align:left;border-right:1px sold black;"><br/><br/>Bank Name : <b>'.$bank_name.'</b><br/></th>';
$sgst_footer .= '<th style="width:122px;text-align:right;"><br/><br/><b>SGST</b><br/></th>';
$sgst_footer .= '<th style="width:119px;text-align:right;border-right:1px sold black;"><br/><br/>'.number_format_ind(round(($gst_amt[0] / 2),2)).'<br/></th>';
$sgst_footer .= '</tr>';

$roff_footer .= '<tr style="line-height: 0.6;">';
$roff_footer .= '<th style="width:321px;text-align:left;border-right:1px sold black;"><br/><br/>Branch : <b>'.$bank_branch.'</b><br/></th>';
if($round_off[0] >= 0){
...
$roff_footer .= '<th style="width:119px;text-align:right;border-right:1px sold black;"><br/><br/>'.number_format_ind($round_off[0]).'<br/></th>';
$roff_footer .= '</tr>';

$ft_footer .= '<tr style="line-height: 0.6;">';
$ft_footer .= '<th style="width:321px;text-align:left;border-right:1px sold black;"><br/><br/>IFSC Code: <b>'.$bank_ifsc.'</b><br/></th>';
$ft_footer .= '<th style="width:122px;text-align:right;"><br/><br/><b>Total</b><br/></th>';
$ft_footer .= '<th style="width:119px;text-align:right;border-right:1px sold black;"><br/><br/><b>'.number_format_ind($finl_amt[0]).'</b><br/></th>';
$ft_footer .= '</tr>';
...
$aob_footer .= '<th style="width:323px;text-align:left;"><br/><br/><br/>Total In Words<br/><b>Rs.(in Words): '.convert_number_to_words($finl_amt[0]).'</b><br/></th>';
$aob_footer .= '<th style="width:239px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b></b><br/></th>';
$aob_footer .= '</tr>';
...
//date("d.m.Y",strtotime($row['date']))
    ...
    $html .= '<th style="width:45px;text-align:right;border-right:1px solid black;"><br/><br/>'.number_format_ind($rcd_qty[$i]).'<br/></th>';
    ...
    $html .= '<th style="width:39px;text-align:right;border-right:1px solid black;"><br/><br/>'.number_format_ind($rate[$i]).'<br/></th>';
    $html .= '<th style="width:39px;text-align:right;border-right:1px solid black;"><br/><br/>'.number_format_ind($gst_per[$i]).'<br/></th>';
    $html .= '<th style="width:47px;text-align:right;border-right:1px solid black;"><br/><br/>'.number_format_ind($dis_amt[$i]).'<br/></th>';
    $html .= '<th style="width:60px;text-align:right;border-right:1px solid black;"><br/><br/>'.number_format_ind($item_tamt[$i]).'<br/></th>';
    $html .= '</tr>';
    }
    else{
