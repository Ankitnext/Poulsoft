...
while($row = mysqli_fetch_assoc($query)){
    ...
    $fbatch_no[$i] = $row['fbatch_no'];
    $i++;
    $vendor = $row['vcode'];
}

$sql = "SELECT * FROM `broiler_ebill_shipping_details` WHERE `vcode` = '$vendor'"; $query = mysqli_query($conn,$sql);
		while($row = mysqli_fetch_assoc($query)){
...
$query = mysqli_query($conn,$sql); $einv_gflag = mysqli_num_rows($query); $ebill_info = '';

if($einv_gflag > 0){
    $sql = "SELECT * FROM `broiler_ebill_invoice_status` WHERE `trnum` LIKE '$trnum[0]' AND `irn_status` LIKE 'ACT' AND `active` = '1' AND `dflag` = '0' AND `id` IN (SELECT MAX(id) as id FROM `broiler_ebill_invoice_status` WHERE `trnum` LIKE '$trnum[0]')";
    $query = mysqli_query($conn,$sql); $e_cnt = mysqli_num_rows($query);
    if((int)$e_cnt > 0){
        while($row = mysqli_fetch_assoc($query)){
            $e_gstin_no = $row['gstin_no'];
            $e_irn_no = $row['irn_no'];
            $e_ack_no = $row['ack_no'];
            $e_ack_date = $row['ack_date'];
            $e_signed_qr_code = $row['signed_qr_code'];
            $e_signed_invoice = $row['signed_invoice'];
        }
        file_put_contents('temp_qr_code.png', base64_decode($e_signed_qr_code));

        $ebill_qring = '<img src="temp_qr_code.png" style="height:110px;" />';
        $ebill_info .= '<tr style="line-height: 1.1;width:100%">';
        $ebill_info .= '<th style="width:120px;text-align:center;border-top:1px sold black;" rowspan="5"><br/><br/>'.$ebill_qring.'<br/></th>';
        $ebill_info .= '<th style="width:440px;text-align:left;border-top:1px sold black;"><br/><br/><br/>IRN : <b>'.$e_irn_no.'</b><br/></th>';
        $ebill_info .= '</tr>';
        $ebill_info .= '<tr style="line-height: 1.1;">';
        $ebill_info .= '<th style="width:440px;text-align:left;"><br/>Ack No. : <b>'.$e_ack_no.'</b><br/></th>';
        $ebill_info .= '</tr>';
        $ebill_info .= '<tr style="line-height: 1.1;">';
        $ebill_info .= '<th style="width:400px;text-align:left;"><br/>Ack Date : <b>'.$e_ack_date.'</b><br/></th>';
        $ebill_info .= '</tr>';
        $ebill_info .= '<tr style="line-height: 1.1;">';
        $ebill_info .= '<th style="width:400px;text-align:left;color:#ababab;"><br/>e-invoicing detail(s) generated from the Government\'s e-invoicing system.<br/><br/><br/><br/><br/></th>';
        $ebill_info .= '</tr>';
...
$l_header .= '<tr style="line-height: 1.3;">';
$l_header .= '<th  style="width:145px;text-align:center;"><br/><br/><br/><img src="../../'.$img_path.'" height="80px" /></th>';
$l_header .= '<th  style="width:317px;text-align:left;"><br/>'.$cdetail.'</th>';
$l_header .= '<th  style="width:100px;text-align:right;border-right:1px sold black;"><br/><br/><br/><br/><br/><br/><br/><br/><h1>Tax Invoice</h1></th>';
...
$l_header .= '<tr style="line-height: 1.1;">';
$l_header .= '<th style="width:265px;text-align:left;border-top:1px sold black;border-right:1px sold black;"><br/><br/>Invoice No: <b>'.$billno[0].'</b><br/></th>';
$l_header .= '<th style="width:297px;text-align:left;border-top:1px sold black;border-right:1px sold black;"><br/><br/>Po No:<b>'.$pono.'</b><br/></th>'; //<b>Eway Bill No: </b>'.$billno[0].'
$l_header .= '</tr>';

$l_header .= '<tr style="line-height: 1.1;">';
$l_header .= '<th style="width:265px;text-align:left;border-right:1px sold black;">Date: <b>'.$date[0].'</b><br/></th>';
$l_header .= '<th style="width:297px;text-align:left;border-right:1px sold black;">Po Date:<b>'.$ponodate.'</b><br/></th>'; //<b>Eway Bill No: </b>'.$billno[0].'
$l_header .= '</tr>';

$l_header .= '<tr style="line-height: 1.1;">';
$l_header .= '<th style="width:265px;text-align:left;border-right:1px sold black;">Transporter: <b>'.$vehicle_code[0].'</b><br/></th>';
$l_header .= '<th style="width:297px;text-align:left;border-right:1px sold black;">Delivery challan: <b>'.$trnums[0].'</b><br/></th>';
$l_header .= '</tr>';

$l_header .= '<tr style="line-height: 0.5;">';
$l_header .= '<th style="width:265px;text-align:left;border-top:1px sold black;border-right:1px sold black;"><br><br><b>Bill To </b><br/></th>';
$l_header .= '<th style="width:297px;text-align:left;border-top:1px sold black;border-right:1px sold black;"><br><br><b>Ship To </b><br/></th>';
$l_header .= '</tr>';

$v_header .= '<tr>';
$v_header .= '<th style="width:265px;text-align:left;border-top:1px sold black;border-right:1px sold black;"><br/>
<b>Consignee:</b> <b>'.$ven_name.'</b><br/>
Address: '.$ven_baddress.'<br/>
Contact Person: <br/>
Phone No: '.$ven_mobile.'<br/>
GSTIN: '.$ven_gstin.'<br/><br/>
<b>Supply State: </b>'.$state_name.'&ensp;&ensp;
</th>';
$saddr1 = rtrim($saddr1, ',');
$parts = explode(',', $saddr1);
$formatted = '';
foreach ($parts as $i => $part) {
    $formatted .= trim($part);
    if (($i + 1) % 2 == 0 && $i != count($parts) - 1) {
        $formatted .= '<br/>';
...
<b></b>'.$formatted.'<br/>'.$slocation.'<br/>'.$spincode.'<br/><br/><br/>
<b>Supply State: </b>'.$estate_name[$sstate].'&ensp;&ensp;
</th>';
$v_header .= '</tr>';


$d_header .= '<tr style="line-height: 0.6;">';
$d_header .= '<th style="width:27px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>S&nbsp;No</b><br/></th>';
...
$d_header .= '<th style="width:63px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>Description</b><br/></th>';
...
$d_header .= '<th style="width:50px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>Batch No</b><br/></th>';
...
$d_header .= '<th style="width:35px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>UOM</b><br/></th>';
...
$d_header .= '<th style="width:47px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>Price</b><br/></th>';
...
$d_header .= '<th style="width:34px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>Disc</b><br/></th>';
$d_header .= '<th style="width:61px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>Amount</b><br/></th>';
$d_header .= '</tr>';
...
$fit_footer .= '<th style="width:331px;text-align:center;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>Final Total</b><br/></th>';
...
$fit_footer .= '<th style="width:47px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>'.number_format_ind($tot_price).'</b></th>';
$fit_footer .= '<th style="width:39px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><br/></th>';
$fit_footer .= '<th style="width:34px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>'.number_format_ind($tot_damt).'</b></th>';
$fit_footer .= '<th style="width:61px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>'.number_format_ind($tot_tamt).'</b></th>';
$fit_footer .= '</tr>';

$frt_footer .= '<tr style="line-height: 0.6;">';
$frt_footer .= '<th style="width:331px;text-align:left;border-top:1px sold black;border-right:1px sold black;"><br/><br/><br/></th>';
$frt_footer .= '<th style="width:122px;text-align:right;border-top:1px sold black;"><br/><br/><b>Freight</b><br/></th>';
$frt_footer .= '<th style="width:109px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/>'.number_format_ind($freight_amt[0]).'<br/></th>';
$frt_footer .= '</tr>';

$tcs_footer .= '<tr style="line-height: 0.6;">';
$tcs_footer .= '<th style="width:331px;text-align:left;border-right:1px sold black;"><br/><br/>Acc. Holder name :<b> '.$bank_accname.'</b><br/></th>';
$tcs_footer .= '<th style="width:122px;text-align:right;"><br/><br/><b>TCS Amount</b><br/></th>';
$tcs_footer .= '<th style="width:109px;text-align:right;border-right:1px sold black;"><br/><br/>'.number_format_ind($tcds_amt[0]).'<br/></th>';
$tcs_footer .= '</tr>';

$cgst_footer .= '<tr style="line-height: 0.6;">';
$cgst_footer .= '<th style="width:331px;text-align:left;border-right:1px sold black;"><br/><br/>Account Number :<b> '.$bank_accno.'</b><br/></th>';
$cgst_footer .= '<th style="width:122px;text-align:right;"><br/><br/><b>CGST</b><br/></th>';
$cgst_footer .= '<th style="width:109px;text-align:right;border-right:1px sold black;"><br/><br/>'.number_format_ind(round(($gst_amt[0] / 2),2)).'<br/></th>';
$cgst_footer .= '</tr>';

$sgst_footer .= '<tr style="line-height: 0.6;">';
$sgst_footer .= '<th style="width:331px;text-align:left;border-right:1px sold black;"><br/><br/>Bank Name : <b>'.$bank_name.'</b><br/></th>';
$sgst_footer .= '<th style="width:122px;text-align:right;"><br/><br/><b>SGST</b><br/></th>';
$sgst_footer .= '<th style="width:109px;text-align:right;border-right:1px sold black;"><br/><br/>'.number_format_ind(round(($gst_amt[0] / 2),2)).'<br/></th>';
$sgst_footer .= '</tr>';

$roff_footer .= '<tr style="line-height: 0.6;">';
$roff_footer .= '<th style="width:331px;text-align:left;border-right:1px sold black;"><br/><br/>Branch : <b>'.$bank_branch.'</b><br/></th>';
if($round_off[0] >= 0){
    $roff_footer .= '<th style="width:122px;text-align:right;"><br/><br/><b>Round Off(add)</b><br/></th>';
}
else{
    $roff_footer .= '<th style="width:122px;text-align:right;"><br/><br/><b>Round Off(deduct)</b><br/></th>';
}
$roff_footer .= '<th style="width:109px;text-align:right;border-right:1px sold black;"><br/><br/>'.number_format_ind($round_off[0]).'<br/></th>';
$roff_footer .= '</tr>';

$ft_footer .= '<tr style="line-height: 0.6;">';
$ft_footer .= '<th style="width:331px;text-align:left;border-right:1px sold black;"><br/><br/>IFSC Code: <b>'.$bank_ifsc.'</b><br/></th>';
$ft_footer .= '<th style="width:122px;text-align:right;"><br/><br/><b>Total</b><br/></th>';
$ft_footer .= '<th style="width:109px;text-align:right;border-right:1px sold black;"><br/><br/><b>'.number_format_ind($finl_amt[0]).'</b><br/></th>';
$ft_footer .= '</tr>';
...
$aob_footer .= '<th style="width:331px;text-align:left;"><br/><br/><br/>Total In Words<br/><b>Rs.(in Words): '.convert_number_to_words($finl_amt[0]).'</b><br/></th>';
$aob_footer .= '<th style="width:231px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b></b><br/></th>';
$aob_footer .= '</tr>';

$tax_footer .= '<tr style="line-height: 1.2;">';
$tax_footer .= '<th style="width:562px;text-align:left;"><br/><br/>Notes<br/></th>';
$tax_footer .= '</tr>';

$tax_footer .= '<tr style="line-height: 1.2;">';
$tax_footer .= '<th style="width:562px;text-align:left;"><br/><br/>Thanks For Your business<br/></th>';
$tax_footer .= '</tr>';


$tcn_footer .= '<tr style="line-height: 1.1;">';
$tcn_footer .= '<th style="width:350px;text-align:left;"><br/><b>Terms & Conditions: </b><div style="font-size:8px;">'.$note.'</div><br/><br/></th>';
//$tcn_footer .= '<th style="width:212px;text-align:left;border-right:1px sold black;"><br/><b>Narration: </b><br/>'.$remarks[0].'<br/><br/><br/><br/></th>';
$tcn_footer .= '</tr>';
...
for($i = 0; $i < max($dsize,15); $i++){
    ...
    $html .= '<th style="width:27px;text-align:center;border-right:1px solid black;"><br/><br/>'.$j.'<br/></th>';
    ...
    $html .= '<th style="width:63px; text-align:center;border-right:1px solid black;"><br/><br/>'.$item_name[$icode[$i]].'<br/></th>';
//date("d.m.Y",strtotime($row['date']))
    ...
    $html .= '<th style="width:50px;text-align:center;border-right:1px sold black;"><br/><br/>'.$fbatch_no[$i].'<br/></th>';

    $html .= '<th style="width:50px;text-align:center;border-right:1px solid black;"><br/><br/>'.$item_hsn[$icode[$i]].'<br/></th>';
    $html .= '<th style="width:35px;text-align:center;border-right:1px solid black;"><br/><br/>'.$item_uom[$icode[$i]].'<br/></th>';
    $html .= '<th style="width:50px;text-align:right;border-right:1px solid black;"><br/><br/>'.number_format_ind($rcd_qty[$i]).'<br/></th>';
    ...
    $html .= '<th style="width:47px;text-align:right;border-right:1px solid black;"><br/><br/>'.number_format_ind($rate[$i]).'<br/></th>';
    $html .= '<th style="width:39px;text-align:right;border-right:1px solid black;"><br/><br/>'.number_format_ind($gst_per[$i]).'<br/></th>';
    $html .= '<th style="width:34px;text-align:right;border-right:1px solid black;"><br/><br/>'.number_format_ind($dis_amt[$i]).'<br/></th>';
    $html .= '<th style="width:61px;text-align:right;border-right:1px solid black;"><br/><br/>'.number_format_ind($item_tamt[$i]).'<br/></th>';
    $html .= '</tr>';
    }
    else{
    ...
    if($icount == 15 && $j < max($dsize,15)){
       ...
       // $icount = 0;
        ...
        //     $t_rqty = $t_dqty = $t_iqty = $t_prc = 0;
        // }
      //  $html .= $fit_footer."".$frt_footer."".$tcs_footer."".$cgst_footer."".$sgst_footer."".$roff_footer."".$ft_footer."".$aob_footer."".$tax_footer."".$tcn_footer."".$bank_footer."".$sign_footer."".$ebill_info."".$t_footer;

        $html .= $fit_footer.$frt_footer.$tcs_footer.$cgst_footer.$sgst_footer.$roff_footer.$ft_footer.$aob_footer.$tax_footer.$tcn_footer.$bank_footer.$sign_footer;
$html .= '</table><div style="page-break-before:always;"></div><table style="border:1px solid black;width:100%;">';
$html .= $ebill_info;
$html .= $t_footer;
...
if($einv_gflag > 0){ if((int)$e_cnt > 0){ unlink('temp_qr_code.png'); } }
?>