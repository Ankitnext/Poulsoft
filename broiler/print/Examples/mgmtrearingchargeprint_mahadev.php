<?php
//mgmtrearingchargeprint_mahadev.php
...
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;border-left: 1px solid black;">';
$html .= '<b style="padding-left: 10px;text-align:left;">Book No.</b>';
$html .= '</th>';
$html .= '<td colspan="2" style="padding-right: 10px;text-align:right;color:green;">'.$batch_book[$batch_code].'</td>';
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;">';
...
$html .= '</tr>';
$html .= '<tr>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;"></th>';
$html .= '<td colspan="2" style="padding-right: 10px;text-align:right;color:green;"></td>';
$html .= '<th colspan="2" style="padding-left: 10px;text-align:left;border-left: 1px solid black;">';
...
$html .= '<td colspan="1" style="padding-right: 10px;text-align:right;color:green;">'.number_format_ind(round(($actual_chick_cost / $placed_birds),2)).'</td>';
...
$html .= '</th>';
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;">'.round(($actual_feed_cost / $feed_consume_kgs),2).'</td>';
...
$html .= '<td colspan="1" style="padding-right: 10px;text-align:right;color:green;">'.round(($actual_medicine_cost / $placed_birds),2).'</td>';
...
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;">'.round(($admin_cost_amt / $placed_birds),2).'</td>';
...
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;">'.number_format_ind(round(($actual_prod_amount / $sold_weight),2)).'</td>';
} else {
...
if($sold_weight != 0 || $sold_weight != "0") {
$html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;">'.number_format_ind(round((($actual_prod_amount + $total_amount_payable) / $sold_weight),2)).'</td>';
} else {
    $html .= '<td colspan="1" style="padding-left: 10px;text-align:right;color:green;">0</td>';
}
$html .= '</tr>';
...
if($sold_weight != 0 || $sold_weight != "0") {
$html .= '<td colspan="1" style="padding-right: 10px;text-align:right;color:green;">'.number_format_ind(round(((($sale_amount) - ($actual_chick_cost + $actual_feed_cost + $actual_medicine_cost + $admin_cost_amt + $total_amount_payable)) / $sold_weight),2)).'</td>';
} else {
    $html .= '<td colspan="1" style="padding-right: 10px;text-align:right;color:green;">0</td>';
}
