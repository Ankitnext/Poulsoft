...
$l_header .= '<th style="width:265px;text-align:left;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>Invoice No: </b>'.$billno[0].'<br/></th>';
$l_header .= '<th style="width:297px;text-align:left;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>Po No:</b><br/>'.$pono.'</th>'; //<b>Eway Bill No: </b>'.$billno[0].'
$l_header .= '</tr>';

$l_header .= '<tr style="line-height: 1.1;">';
$l_header .= '<th style="width:265px;text-align:left;border-right:1px sold black;"><b>Date: </b>'.$date[0].'<br/></th>';
$l_header .= '<th style="width:297px;text-align:left;border-right:1px sold black;"><b>Po Date:</b><br/>'.$ponodate.'</th>'; //<b>Eway Bill No: </b>'.$billno[0].'
$l_header .= '</tr>';

$l_header .= '<tr style="line-height: 1.1;">';
$l_header .= '<th style="width:265px;text-align:left;border-right:1px sold black;"><b>Transporter: </b>'.$vehicle_code[0].'<br/></th>';
$l_header .= '<th style="width:297px;text-align:left;border-right:1px sold black;"><b>Delivery challan: </b>'.$trnums[0].'<br/></th>';
$l_header .= '</tr>';
...
$frt_footer .= '<th style="width:323px;text-align:left;border-top:1px sold black;border-right:1px sold black;"><br/><br/><br/></th>';
$frt_footer .= '<th style="width:120px;text-align:right;border-top:1px sold black;"><br/><br/><b>Freight</b><br/></th>';
...
$tcs_footer .= '<th style="width:323px;text-align:left;border-right:1px sold black;"><br/><br/><b>Acc. Holder name : '.$bank_accname.'</b><br/></th>';
$tcs_footer .= '<th style="width:120px;text-align:right;"><br/><br/><b>TCS Amount</b><br/></th>';
...
$cgst_footer .= '<th style="width:323px;text-align:left;border-right:1px sold black;"><br/><br/><b>Account Number : '.$bank_accno.'</b><br/></th>';
$cgst_footer .= '<th style="width:120px;text-align:right;"><br/><br/><b>CGST</b><br/></th>';
...
$sgst_footer .= '<th style="width:323px;text-align:left;border-right:1px sold black;"><br/><br/><b>Bank Name : '.$bank_name.'</b><br/></th>';
$sgst_footer .= '<th style="width:120px;text-align:right;"><br/><br/><b>SGST</b><br/></th>';
...
$roff_footer .= '<th style="width:323px;text-align:left;border-right:1px sold black;"><br/><br/><b>Branch : '.$bank_branch.'</b><br/></th>';
if($round_off[0] >= 0){
    $roff_footer .= '<th style="width:120px;text-align:right;"><br/><br/><b>Round Off(add)</b><br/></th>';
}
else{
    $roff_footer .= '<th style="width:120px;text-align:right;"><br/><br/><b>Round Off(deduct)</b><br/></th>';
}
...
$ft_footer .= '<th style="width:323px;text-align:left;border-right:1px sold black;"><br/><br/><b>IFSC Code: '.$bank_ifsc.'</b><br/></th>';
$ft_footer .= '<th style="width:120px;text-align:right;"><br/><br/><b>Total</b><br/></th>';
...
$tcn_footer .= '<th style="width:350px;text-align:left;"><br/><b>Terms & Conditions: </b><div style="font-size:9px;">'.$note.'</div><br/><br/></th>';
...
for($i = 0; $i < max($dsize,15); $i++){
    ...
    $html .= '<th style="width:100px; text-align:center;border-right:1px solid black;"><br/><br/>'.$item_name[$icode[$i]].'<br/></th>';
//date("d.m.Y",strtotime($row['date']))
    ...
    $html .= '<th style="width:40px;text-align:center;border-right:1px solid black;"><br/><br/>'.$item_uom[$icode[$i]].'<br/></th>';
    ...
    $html .= '<th style="width:43px;text-align:right;border-right:1px solid black;"><br/><br/>'.number_format_ind($rate[$i]).'<br/></th>';
