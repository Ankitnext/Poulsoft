...
$l_header .= '<th rowspan="1" style="width:152px;text-align:left;border-right:1px sold black;"><br/><b>Invoice No: </b><br/>'.$trnum[0].'  ('.$billno[0].')</th>';
...
$d_header .= '<th style="width:37px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>Sl. No.</b><br/></th>';
...
$d_header .= '<th style="width:150px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>Description</b><br/></th>';
$d_header .= '<th style="width:59px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>HSN</b><br/></th>';
$d_header .= '<th style="width:49px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>UOM</b><br/></th>';
$d_header .= '<th style="width:60px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>Qty</b><br/></th>';
...
$d_header .= '<th style="width:49px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>Price</b><br/></th>';
...
$d_header .= '<th style="width:55px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>Discount</b><br/></th>';
$d_header .= '<th style="width:64px;text-align:center;border-top:1px sold black;border-right:1px sold black;border-bottom:1px sold black;"><br/><br/><b>Amount</b><br/></th>';
$d_header .= '</tr>';
...
$fit_footer .= '<th style="width:295px;text-align:center;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>Final Total</b><br/></th>';
$fit_footer .= '<th style="width:60px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>'.number_format_ind($tot_rqty).'</b></th>';
...
$fit_footer .= '<th style="width:49px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>'.number_format_ind($tot_price).'</b></th>';
$fit_footer .= '<th style="width:39px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><br/></th>';
$fit_footer .= '<th style="width:55px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>'.number_format_ind($tot_damt).'</b></th>';
$fit_footer .= '<th style="width:64px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>'.number_format_ind($tot_tamt).'</b></th>';
$fit_footer .= '</tr>';
...
$aob_footer .= '<th style="width:200px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/><b>Opening Balance: '.number_format_ind($op_bal).'</b><br/><b>Outstanding Balance: '.number_format_ind($ob_bal).'</b><br/></th>';
$aob_footer .= '</tr>';
...
for($i = 0; $i < max($dsize,15); $i++){
    ...
    $html .= '<th style="width:37px;text-align:center;border-right:1px sold black;"><br/><br/>'.$j.'<br/></th>';
    ...
    $html .= '<th style="width:150px;text-align:center;border-right:1px sold black;"><br/><br/>'.$item_name[$icode[$i]].'<br/></th>';
    $html .= '<th style="width:59px;text-align:center;border-right:1px sold black;"><br/><br/>'.$item_hsn[$icode[$i]].'<br/></th>';
    $html .= '<th style="width:49px;text-align:center;border-right:1px sold black;"><br/><br/>'.$item_uom[$icode[$i]].'<br/></th>';
    $html .= '<th style="width:60px;text-align:right;border-right:1px sold black;"><br/><br/>'.number_format_ind($rcd_qty[$i]).'<br/></th>';
    ...
    $html .= '<th style="width:49px;text-align:right;border-right:1px sold black;"><br/><br/>'.number_format_ind($rate[$i]).'<br/></th>';
    $html .= '<th style="width:39px;text-align:right;border-right:1px sold black;"><br/><br/>'.number_format_ind($gst_per[$i]).'<br/></th>';
    $html .= '<th style="width:55px;text-align:right;border-right:1px sold black;"><br/><br/>'.number_format_ind($dis_amt[$i]).'<br/></th>';
    $html .= '<th style="width:64px;text-align:right;border-right:1px sold black;"><br/><br/>'.number_format_ind($item_tamt[$i]).'<br/></th>';
    $html .= '</tr>';
    }
    else{
         $html .= '<tr style="line-height: 0.6;">';
    $html .= '<th style="width:37px;text-align:center;border-right:1px sold black"><br/><br/><br/></th>';
    //$html .= '<th style="width:55px;text-align:center;border-top:1px sold black;border-right:1px sold black;"><br/><br/>'.$item_code[$icode[$i]].'<br/></th>';
    $html .= '<th style="width:150px;text-align:center;border-right:1px sold black"><br/><br/></th>';
    $html .= '<th style="width:59px;text-align:center;border-right:1px sold black"></th>';
    $html .= '<th style="width:49px;text-align:center;border-right:1px sold black"></th>';
    $html .= '<th style="width:60px;text-align:right;border-right:1px sold black"></th>';
    //$html .= '<th style="width:44px;text-align:right;border-top:1px sold black;border-right:1px sold black;"><br/><br/>'.number_format_ind($fre_qty[$i]).'<br/></th>';
    $html .= '<th style="width:49px;text-align:right;border-right:1px sold black"></th>';
    $html .= '<th style="width:39px;text-align:right;border-right:1px sold black"></th>';
    $html .= '<th style="width:55px;text-align:right;border-right:1px sold black"></th>';
    $html .= '<th style="width:64px;text-align:right;border-right:1px sold black"></th>';
    $html .= '</tr>';
