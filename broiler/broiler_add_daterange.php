    ...
    <body class="m-0 hold-transition">
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Add Date Range</h3></div>
                        </div>
                        <div class="pl-2 card-body">
                            <form action="broiler_save_daterange.php" method="post" role="form" onsubmit="return checkval()">
        ...
        <script>
			function checkval(){
                ...
                var user_code = file_name = ""; var e = min_days = max_days = 0;
                ...
                for(var d = 0;d <= incr;d++){
                    if(l == true){
                        ...
                        if(user_code == "" || user_code == "select"){
                            alert("Please select User in row: "+e);
                            document.getElementById("user_code["+d+"]").focus();
                            l = false;
                        }
                        else if(file_name == "" || file_name == "select"){
