<?php
//broiler_add_placementplanning2.php
            ...
            <section class="m-0 p-0 content">
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="broiler_save_placementplanning2.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                        ...
                                        <table class="m-0 p-0 table-bordered">
                                            ...
                                            <tbody id="row_body">
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="chicks_place[]" id="chicks_place[0]" class="form-control" style="width:70px;" ></td>
                                                    <td><textarea name="remarks[]" id="remarks[0]" class="form-control" style="width:120px;height:23px;"></textarea></td>
                                                   
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="lb_fcr[]" id="lb_fcr[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="lb_cfcr[]" id="lb_cfcr[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="lb_mort[]" id="lb_mort[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="lb_avg_bodywt[]" id="lb_avg_bodywt[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="lb_mean_age[]" id="lb_mean_age[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="lb_gc_date[]" id="lb_gc_date[0]" class="form-control" style="width:80px;" readonly ></td>
                                                    
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="blb_fcr[]" id="blb_fcr[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="blb_cfcr[]" id="blb_cfcr[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="blb_mort[]" id="blb_mort[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="blb_avg_bodywt[]" id="blb_avg_bodywt[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="blb_mean_age[]" id="blb_mean_age[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="blb_gc_date[]" id="blb_gc_date[0]" class="form-control" style="width:80px;" readonly ></td>

                                                    <td style="visibility: hidden; display: none;"><input type="text" name="olb_fcr[]" id="olb_fcr[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="olb_cfcr[]" id="olb_cfcr[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="olb_mort[]" id="olb_mort[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="olb_avg_bodywt[]" id="olb_avg_bodywt[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="olb_mean_age[]" id="olb_mean_age[0]" class="form-control" style="width:70px;" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="olb_gc_date[]" id="olb_gc_date[0]" class="form-control" style="width:80px;" readonly ></td>
