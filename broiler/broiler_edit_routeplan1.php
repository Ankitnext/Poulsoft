...
<html lang="en">
    ...
    <body class="m-0 p-0 hold-transition">
        <?php
        $ids = $_GET['trnum'];
        $sql = "SELECT * FROM `broiler_routeplan` WHERE `trnum` = '$ids' AND `dflag` = '0' AND `trlink` = 'broiler_display_routeplan1.php'";
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Edit Route Plan</h3></div>
                        </div>
                        <div class="p-0 pt-5 card-body">
                            <div class="col-md-12">
                                <form action="broiler_modify_routeplan1.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                        <div class="form-group">
                                            <label>Order Date<b style="color:red;">&nbsp;*</b></label>
							                <input type="text" name="so_date" id="so_date" class="form-control range_picker" style="width:100px;" value="<?php echo date('d.m.Y',strtotime($so_date)); ?>" readonly />
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
							                ...
							                <input type="text" name="date" id="date" class="form-control range_picker" style="width:100px;" value="<?php echo date('d.m.Y',strtotime($date)); ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Vehicle</label>
                                            <select name="vehicle" id="vehicle" class="form-control select2">
                                                ...
                                                <?php foreach($vehicle_code as $lcode){ ?>
                                                    <option value="<?php echo $vehicle_regno[$lcode]; ?>" <?php if($vehicle_regno[$lcode] == $vehicle){ echo "selected"; } ?>><?php echo $vehicle_regno[$lcode]; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <option></option>
                                                ...
                                                <option value="<?php echo $lcode; ?>" <?php if($lcode == $driver){ echo "selected";} ?>><?php echo $driver_name[$lcode]; ?></option>
                                                <?php  } ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <option></option>
                                                ...
                                                <option value="<?php echo $lcode; ?>" <?php if($lcode == $route_no){ echo "selected"; } ?>><?php echo $cuslinename[$lcode]; ?></option>
                                                <?php  } ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
							                ...
							                <input type="text" name="labour1" id="labour1" class="form-control" value="<?php echo $labour1; ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Labour 2<b style="color:red;">&nbsp;*</b></label>
							                <input type="text" name="labour2" id="labour2" class="form-control" value="<?php echo $labour2; ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Lifter<b style="color:red;">&nbsp;*</b></label>
							                <input type="text" name="lifter" id="lifter" class="form-control" value="<?php echo $lifter; ?>"/>
                                        </div>
                                        <div class="form-group">
                                            <label>Lifter Mob<b style="color:red;">&nbsp;*</b></label>
							                <input type="text" name="lifter_mob" id="lifter_mob" class="form-control" value="<?php echo $lifter_mob; ?>"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" style="visibility:hidden;">
                                        <div class="form-group" style="width:25px;">
                                            <label>ID</label>
                                            <input type="text" name="idvalue" id="idvalue" class="form-control" value="<?php echo $ids; ?>" style="width:25px;" readonly />
                                        </div>
                                        <div class="form-group" style="width:25px;">
                                            <label>IN</label>
        ...
        <script>
            ...
            function fetch_sale_orders(){
                ...
                if(date == "" || date == "01.01.1970"){
                    ...
                    var method = "GET";
                    var url = "broiler_fetch_saleorder_details.php?&date="+date+"&trnum="+trnum;
                    //window.open(url);
