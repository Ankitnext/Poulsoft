<?php
//broiler_edit_placementplanning2.php
include "newConfig.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $ccid = $_SESSION['placementplanning2'];
    ...
    <body class="m-0 hold-transition">
            ...
            <section class="m-0 p-0 content">
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="broiler_modify_placementplanning2.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                        ...
                                        <table class="m-0 p-0 table-bordered">
                                            ...
                                            <tbody id="row_body">
                                                ...
                                                while($row = mysqli_fetch_assoc($query)){
                                                    ...
                                                    $edit_chicks_place = $row['chicks_place'];
                                                ...
                                                <tr id="row_no[<?php echo $c; ?>]">
                                                    ...
                                                    <td><input type="text" name="chicks_place[]" id="chicks_place[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_chicks_place; ?>"  ></td>
                                                    ...
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="lb_fcr[]" id="lb_fcr[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_lb_fcr; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="lb_cfcr[]" id="lb_cfcr[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_lb_cfcr; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="lb_mort[]" id="lb_mort[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_lb_mort; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="lb_avg_bodywt[]" id="lb_avg_bodywt[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_lb_avg_bodywt; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="lb_mean_age[]" id="lb_mean_age[<?php echo $c; ?>]" class="form-control" style="width:80px;" value="<?php echo $edit_lb_mean_age; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="lb_gc_date[]" id="lb_gc_date[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_lb_gc_date; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="blb_fcr[]" id="blb_fcr[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_blb_fcr; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="blb_cfcr[]" id="blb_cfcr[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_blb_cfcr; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="blb_mort[]" id="blb_mort[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_blb_mort; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="blb_avg_bodywt[]" id="blb_avg_bodywt[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_blb_avg_bodywt; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="blb_mean_age[]" id="blb_mean_age[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_blb_mean_age; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="blb_gc_date[]" id="blb_gc_date[<?php echo $c; ?>]" class="form-control" style="width:80px;" value="<?php echo $edit_blb_gc_date; ?>" readonly ></td>

                                                    <td style="visibility: hidden; display: none;"><input type="text" name="olb_fcr[]" id="olb_fcr[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_olb_fcr; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="olb_cfcr[]" id="olb_cfcr[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_olb_cfcr; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="olb_mort[]" id="olb_mort[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_olb_mort; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="olb_avg_bodywt[]" id="olb_avg_bodywt[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_olb_avg_bodywt; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="olb_mean_age[]" id="olb_mean_age[<?php echo $c; ?>]" class="form-control" style="width:70px;" value="<?php echo $edit_olb_mean_age; ?>" readonly ></td>
                                                    <td style="visibility: hidden; display: none;"><input type="text" name="olb_gc_date[]" id="olb_gc_date[<?php echo $c; ?>]" class="form-control" style="width:80px;" value="<?php echo $edit_olb_gc_date; ?>" readonly ></td>
        ...
        <script>
            function return_back(){
                ...
                window.location.href = 'broiler_display_placementplanning2.php?ccid'+ccid;
            }
            function checkval(){
            ...
            function create_row(a){
                ...
                html += '<td><input type="text" name="chicks_place[]" id="chicks_place['+d+']" class="form-control" style="width:70px;" ></td>';
                html += '<td><textarea name="remarks[]" id="remarks['+d+']" class="form-control" style="width:120px;height:23px;"></textarea></td>';
                
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="lb_fcr[]" id="lb_fcr['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="lb_cfcr[]" id="lb_cfcr['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="lb_mort[]" id="lb_mort['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="lb_avg_bodywt[]" id="lb_avg_bodywt['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="lb_mean_age[]" id="lb_mean_age['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="lb_gc_date[]" id="lb_gc_date['+d+']" class="form-control" style="width:80px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="blb_fcr[]" id="blb_fcr['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="blb_cfcr[]" id="blb_cfcr['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="blb_mort[]" id="blb_mort['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="blb_avg_bodywt[]" id="blb_avg_bodywt['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="blb_mean_age[]" id="blb_mean_age['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="blb_gc_date[]" id="blb_gc_date['+d+']" class="form-control" style="width:80px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="olb_fcr[]" id="olb_fcr['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="olb_cfcr[]" id="olb_cfcr['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="olb_mort[]" id="olb_mort['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="olb_avg_bodywt[]" id="olb_avg_bodywt['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="olb_mean_age[]" id="olb_mean_age['+d+']" class="form-control" style="width:70px;" readonly ></td>';
                html += '<td style="visibility: hidden; display: none;"><input type="text" name="olb_gc_date[]" id="olb_gc_date['+d+']" class="form-control" style="width:80px;" readonly ></td>';
