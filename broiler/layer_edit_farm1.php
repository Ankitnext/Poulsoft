...
<html lang="en">
    ...
    <body class="m-0 hold-transition">
        <?php
        $ids = $_GET['id'];
        $sql = "SELECT * FROM `layer_farms` WHERE `id` = '$ids' AND `dflag` = '0' AND `trlink` = 'layer_display_farm1.php'";
            ...
            <section class="m-0 p-0 content">
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="layer_modify_farm1.php" method="post" role="form" onsubmit="return checkval()">
        ...
        <script>
			...
			function check_duplicate(){
				...
				if(description != ""){
					...
					var method = "GET";
					var url = "layer_fetch_farm1_duplicates.php?description="+description+"&id="+id+"&type="+type;
                    //window.open(url);
