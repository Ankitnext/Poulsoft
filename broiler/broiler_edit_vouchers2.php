...
<html lang="en">
    ...
    <body class="m-0 hold-transition">
        ...
        while($row = mysqli_fetch_assoc($query)){
            ...
            $farm_batch = $row['farm_batch'];
            $vcode[$c] = $row['vcode'];
            $crdr[$c] = $row['crdr'];
            $cr_amt[$c] = round($row['cr_amt'],5);
            $dr_amt[$c] = round($row['dr_amt'],5);
            ...
            <section class="m-0 p-0 content">
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="broiler_modify_vouchers2.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                    ...
                                    <table>
                                        ...
                                        <tbody id="row_body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="vcode[]" id="vcode[<?php echo $c; ?>]" class="form-control select2" style="width:180px;">
                                                        <?php
                                                        if((int)$pflag[$c] == 1){
                                                        ?>
                                                        <option value="<?php echo $vcode[$c]; ?>"><?php echo $acc_name[$vcode[$c]]; ?></option>
                                                        <?php
                                                        }
                                                        else{
                                                            foreach($acc_code as $acode){ ?><option value="<?php echo $acode; ?>" <?php if($acode == $vcode[$c]){ echo "selected"; } ?>><?php echo $acc_name[$acode]; ?></option><?php }
                                                        }
                                                        ?>
                                                    </select>
                                                </td>
                                                <td><select name="crdr[]" id="crdr[<?php echo $c; ?>]" class="form-control select2" style="width:180px;"><option value="<?php echo $crdr[$c]; ?>"><?php echo $crdr[$c]; ?></option></select></td>
                                                <td><input type="text" name="dr_amt[]" id="dr_amt[<?php echo $c; ?>]" class="form-control text-right" value="<?php echo $dr_amt[$c]; ?>" style="width:90px;" onkeyup="validatenum(this.id);calculate_total_amt(this.id);" onchange="validateamount(this.id);" <?php if($crdr[$c] == "Cr"){ echo "readonly"; } ?> /></td>
                                                <td><input type="text" name="cr_amt[]" id="cr_amt[<?php echo $c; ?>]" class="form-control text-right" value="<?php echo $cr_amt[$c]; ?>" style="width:90px;" onkeyup="validatenum(this.id);calculate_total_amt(this.id);" onchange="validateamount(this.id);" <?php if($crdr[$c] == "Dr"){ echo "readonly"; } ?> /></td>
                                                ...
                                                echo '</td>';
                                                ?>
                                                <td style="visibility:hidden;"><input type="text" name="amount[]" id="amount[<?php echo $c; ?>]" class="form-control text-right" value="<?php echo $amount[$c]; ?>" style="width:90px;" readonly /></td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                        <tfoot>
                                    ...
                                    <div class="row" style="visibility:hidden;">
                                        <div class="form-group" style="width:30px;">
                                            <label>I</label>
                                            <input type="text" name="idvalue" id="idvalue" class="form-control" value="<?php echo $ids; ?>" style="padding:0;padding-left:2px;width:20px;" readonly />
                                        </div>
                                        <div class="form-group" style="width:30px;">
                                            <label>I</label>
                                            <input type="text" name="incr" id="incr" class="form-control" value="<?php echo $i; ?>" style="padding:0;padding-left:2px;width:20px;" readonly />
                                        </div>
                                        <div class="form-group" style="width:30px;">
                                            <label>E</label>
