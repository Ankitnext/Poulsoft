<?php
//broiler_add_inventoryreceived.php
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Add Stock Received</h3></div>
                        </div>
                        <div class="m-0 p-2 card-body">
                            <div class="col-md-18">
                                <form action="broiler_save_inventoryreceived.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
        ...
        <script>
            ...
            function fetch_stock_master(a){
                ...
                if(sector != "select" && item_code != "select"){
                    ...
                    var method = "GET";
                    var url = "broiler_fetch_itemstockmaster_lsfi.php?sector="+sector+"&item_code="+item_code+"&date="+date+"&trtype=stkreceived&etype=stkreceived";
                    //window.open(url);
