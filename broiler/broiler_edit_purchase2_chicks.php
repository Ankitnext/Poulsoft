                                ...
                                <form action="broiler_modify_purchase2_chicks.php" method="post" role="form" onsubmit="return checkval()">
                                    ...
                                    <div class="row" style="margin-bottom:3px;" id="row_no[<?php echo $i; ?>]">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="item_tamt[]" id="item_tamt[<?php echo $i; ?>]" value="<?php echo round(($rcd_qty[$i] * $rate[$i]),0); ?>" class="form-control" placeholder="0.00" style="width:90px;" readonly >
                                        </div>
                                        <div class="form-group">
