<?php
//breeder_display_receive_stocks1.php
include "newConfig.php";
include "number_format_ind.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $cid = $_GET['ccid'];
if($cid != ""){ $_SESSION['receive_stocks1'] = $cid; } else{ $cid = $_SESSION['receive_stocks1']; }
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM `item_stocktransfers` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `active` = '1' AND `dflag` = '0' AND `quantity` > '0' ORDER BY `id` DESC";
                                        ...
                                        while($row = mysqli_fetch_assoc($query)){
                                            ...
                                            $val = ""; $val = $row['trnum'];
                                            $sh_qty = (float)$row['sent_qty'] - (float)$row['quantity'];
                                    ?>
                                    <tr>
										...
										<td style="text-align:right;"><?php echo round($sh_qty,5); ?></td>
        ...
        <script>
			function checkdelete(x){
                ...
                if(trnum != ""){
                    ...
                    var method = "GET";
                    var url = "breeder_check_receive_stocks1.php?trnum="+trnum;
                    //window.open(url);
