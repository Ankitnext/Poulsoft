<?php
//breeder_display_eggconvert1.php
include "newConfig.php";
include "number_format_ind.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $cid = $_GET['ccid'];
if($cid != ""){ $_SESSION['eggconvert1'] = $cid; } else{ $cid = $_SESSION['eggconvert1']; }
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM `breeder_egg_conversion` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `dflag` = '0' AND `trlink` = '$href' ORDER BY `date`,`trnum` ASC";
                                    ...
                                    <tr>
										...
										<td style="text-align:right;"><?php echo $bitem_name[$row['from_item']]; ?></td>
										<td style="text-align:right;"><?php echo $bitem_name[$row['to_item']]; ?></td>
										<td style="text-align:right;"><?php echo round($row['to_qty'],5); ?></td>
										<td style="text-align:right;"><?php echo round($row['disposed_qty'],5); ?></td>
        ...
        <script>
			function checkdelete(x){
                ...
                if(trnum != ""){
                    ...
                    var method = "GET";
                    var url = "breeder_check_eggconvert1.php?trnum="+trnum;
                    //window.open(url);
