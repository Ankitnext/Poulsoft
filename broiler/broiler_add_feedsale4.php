    ...
    <body class="m-0 hold-transition">
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="m-0 p-2 card-body">
                            <div class="col-md-18">
                                <form action="broiler_save_feedsale4.php" method="post" role="form" onSubmit="return checkval()">
                                    <div class="row">
                                    ...
                                    <table>
                                        ...
                                        <tbody id="row_body">
                                            <tr>
                                                <td><select name="icode[]" id="icode[0]" class="form-control select2" style="width:180px;" onchange="fetch_stock_master(this.id);fetch_reset(this.id);"><option value="select">select</option><?php foreach($item_code as $prod_code){ ?><option value="<?php echo $prod_code; ?>"><?php echo $item_name[$prod_code]; ?></option><?php } ?></select></td>
                                                <td><input type="text" name="fre_qty[]" id="fre_qty[0]" class="form-control" placeholder="0.00" style="width:90px;" onkeyup="validatenum(this.id);fetch_kgs(this.id);fetch_discount_amount2(this.id);" onchange="validateamount(this.id);" ></td>
                                                <td><input type="text" name="rcd_qty[]" id="rcd_qty[0]" class="form-control" placeholder="0.00" style="width:90px;" onkeyup="validatenum(this.id);calculate_total_amt(this.id);" onchange="validateamount(this.id);" readonly></td>
                                                <td><input type="text" name="mrp_amt[]" id="mrp_amt[0]" class="form-control" placeholder="0.00" style="width:90px;" onkeyup="validatenum(this.id);fetch_discount_amount2(this.id);fetch_prc(this.id);calculate_total_amt(this.id)" onchange="validateamount(this.id)"; ></td>
                                                <td><input type="text" name="dis_per[]" id="dis_per[0]" class="form-control" placeholder="%" style="width:80px;" onkeyup="validatenum(this.id);fetch_discount_amount(this.id);fetch_discount_amount2(this.id);calculate_total_amt(this.id);"></td>
                                                <td><input type="text" name="dis_amt[]" id="dis_amt[0]" class="form-control" placeholder="&#8377" style="width:80px;" onkeyup="validatenum(this.id);fetch_discount_amount(this.id);fetch_discount_amount2(this.id);calculate_total_amt(this.id);" onchange="validateamount(this.id);"></td>
        ...
        <script>
            ...
            function checkval(){
                ...
                var incrs = document.getElementById("incr").value; var qty = price = total_amt = mrp_amt = fre_qty = c = d = stock = rate_count = 0; var icode = "";
                var l = true;
                ...
                if(date == ""){
                    ...
                    for(d = 0;d <= incrs;d++){
                        if(l == true){
                            ...
                            item_amt = document.getElementById("rate["+d+"]").value; if(price == ""){ price = 0; }
            ...
            function create_row(a){
                ...
                html += '<td><input type="text" name="rcd_qty[]" id="rcd_qty['+d+']" class="form-control" placeholder="0.00" style="width:90px;" onkeyup="validatenum(this.id);calculate_total_amt(this.id);" onchange="validateamount(this.id);" readonly></td>';
                html += '<td><input type="text" name="mrp_amt[]" id="mrp_amt['+d+']" class="form-control" placeholder="0.00" style="width:90px;" onkeyup="validatenum(this.id);fetch_discount_amount2(this.id);fetch_prc(this.id);" onchange="validateamount(this.id)"; ></td>';
        ...
        <script>
                ...
                function fetch_kgs(a) {
                    ...
                    alert("Please Select Bag Size First");
                    }
                }
