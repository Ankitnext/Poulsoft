<?php
//broiler_edit_growingcharge_moti.php
include "newConfig.php";
date_default_timezone_set("Asia/Kolkata");
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $ccid = $_SESSION['growingcharge_moti'];
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="p-0 pt-2 card-body">
                            <div class="col-md-12">
                                <form action="broiler_modify_growingcharge_moti.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                if($schema_name == ""){
                                                ?>
                                                <select name="schema_name" id="schema_name" class="form-control select2">
                                                    <option value="select">-select-</option>
                                                <?php
                                                    $region_code = $farm_region[$f_code];
                                                    $sql = "SELECT * FROM `broiler_gc_standard` WHERE `region_code` = '$region_code' AND `branch_code` = '$branch_code' AND `from_date` <= '$start_date' AND `to_date` >= '$start_date' AND `active` = '1' AND `dflag` = '0' ORDER BY `schema_name` ASC";
                                                    $query = mysqli_query($conn,$sql);
                                                    while($row = mysqli_fetch_assoc($query)){
                                                        $sch_name = $row['schema_name'];
                                                        echo "<option value='$sch_name'>$sch_name</option>";
                                                    }
                                                    ?>
                                                </select>
                                                <?php
                                        ...
                                        <div class="col-md-8">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="visibility:hidden"><input type="text" name="days7_mort_count" id="days7_mort_count" class="form-control" value="<?php echo $days7_mort_count; ?>" readonly /></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="visibility:hidden"><input type="text" name="days30_mort_count" id="days30_mort_count" class="form-control" value="<?php echo $days30_mort_count;  ?>" readonly /></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="daysge31_mort" id="daysge31_mort" class="form-control" value="<?php echo round($daysge31_mort,2); ?>" readonly /></td>
                                                     <td style="visibility:hidden"><input type="text" name="days31_mort_count" id="days31_mort_count" class="form-control" value="<?php echo $days31_mort_count;  ?>" readonly /></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <div class="col-md-7">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="grow_charge_exp_prc" id="grow_charge_exp_prc" class="form-control" value="<?php echo round($grow_charge_exp_prc,3); ?>" readonly onkeyup="calculate_gc_amount()" /></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td><input type="text" name="ifft_charges" id="ifft_charges" class="form-control" value="<?php echo round($ifft_charges,2); ?>" onkeyup="calculate_amount_pay()" /></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <table>
                                                ...
                                                <tr>
                                                    <td style="text-align:right;" id="tds_lbl"><label for="mnu_tds_flag"><input type="checkbox" name="mnu_tds_flag" id="mnu_tds_flag" onchange="calculate_amount_pay()" <?php if($mnu_tds_flag == 1){ echo "checked"; } ?> />Manual TDS&ensp;&ensp;</label><label><?php echo "TDS@".$tds_lbl."%"; ?></label></td>
                                                    <td><input type="text" name="tds_amt" id="tds_amt" class="form-control" value="<?php echo round($tds_amt,2); ?>" onkeyup="calculate_amount_pay()" /></td>
  ...
  <span></span>
        ...
        <script>
            function return_back(){
                ...
                window.location.href = 'broiler_display_growingcharge_moti.php?ccid='+ccid;
            }
            function checkval(){
            ...
            function fetch_farmdetails(){
                ...
                if(schema_name == "" || schema_name == "select"){
                    alert("Please select Schema");
                }
                else if(!farm_code.match("select")){
                    var fetchgc = new XMLHttpRequest();
					var method = "GET";
					var url = "broiler_fetch_rearingcharge_moti2.php?farm_code="+farm_code+"&batch_code="+batch_code+"&schema_id="+schema_id+"&schema_name="+schema_name;
                    //window.open(url);
					...
					fetchgc.onreadystatechange = function(){
						if(this.readyState == 4 && this.status == 200){
							...
							if(bbal == "") {
                                ...
                                document.getElementById("days7_mort_count").value = farm_details[88];
                                document.getElementById("days30_mort_count").value = farm_details[89];
                                document.getElementById("days31_mort_count").value = farm_details[90];
            ...
            function calculate_amount_pay(){
                ...
                famt_pay = (parseFloat(amt_pay) + parseFloat(transport_add_amt)) - (parseFloat(fsale_ded_amt) + parseFloat(feedtr_ded_amt) + parseFloat(vacc_ded_amt) + parseFloat(other_ded_amt));
                document.getElementById("total_amount_payable").value = famt_pay.toFixed(0);
                
                var mnu_tds_flag = document.getElementById("mnu_tds_flag");
                if(mnu_tds_flag.checked == true){
                    var tds_amt = document.getElementById("tds_amt").value; if(tds_amt == ""){ tds_amt = 0; }
                }
                else{
                    if(tds_flag == 1 || tds_flag == "1"){
                        ...
                        var tds_amt = (parseFloat(total_inc_amt) * parseFloat(tds_per)).toFixed(0);
                    }
                    else{
                        var tds_amt = 0;
                    }
                }
                if(parseFloat(tds_amt) <= 0){ tds_amt = 0; }
