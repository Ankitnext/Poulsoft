            ...
            <section class="m-0 p-0 content">
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="broiler_save_vouchers3.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group"  style="width:190px;">
                                            ...
                                            <select name="coa_code" id="coa_code" class="form-control select2" style="width:180px;">
                                                <option value="select">select</option>
                                        ...
                                        <div class="form-group" style="width:90px;">
                                            <label>Vehicle</label>
                                            <input type="text" name="vehicle_code" id="vehicle_code" class="form-control" style="width:90px;" onkeyup="validatename(this.id);" />
                                        </div>
                                    </div><br/>
                                    <table>
                                        <thead>
                                        ...
                                        <tbody id="row_body">
                                            ...
                                            <tr>
                                                <td><select name="vcode[]" id="vcode[<?php echo $c; ?>]" class="form-control select2" style="width:180px;"><option value="<?php echo $acode; ?>"><?php echo $acc_name[$acode]; ?></option></select></td>
                                                <td><input type="text" name="amount[]" id="amount[<?php echo $c; ?>]" class="form-control text-right" style="width:90px;" onkeyup="validatenum(this.id);calculate_total_amt();" onchange="validateamount(this.id);" /></td>
                                                <th><textarea name="remarks[]" id="remarks[<?php echo $c; ?>]" class="form-control" style="width:150px;height:28px;"></textarea></th>
                                            </tr>
                                            <?php $c++; } $c = $c - 1; ?>
                                        </tbody>
                                        <tfoot>
