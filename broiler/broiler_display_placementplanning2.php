<?php
//broiler_display_placementplanning2.php
include "newConfig.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $cid = $_GET['ccid'];
if($cid != ""){ $_SESSION['placementplanning2'] = $cid; } else{ $cid = $_SESSION['placementplanning2']; }
...
<html lang="en">
    ...
    <body class="m-0 hold-transition sidebar-mini">
        ...
        if($acount == 1){
            ...
            if(in_array("chicks_place", $existing_col_names, TRUE) == ""){ $sql = "ALTER TABLE `broiler_placementplan` ADD `chicks_place` VARCHAR(300) NOT NULL DEFAULT '0' COMMENT 'Chicks Placement' AFTER `dflag`"; mysqli_query($conn,$sql); }
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        while($row = mysqli_fetch_assoc($query)){
                                            ...
                                            $print_url = "/records/".$print_link."?id=".$id;
