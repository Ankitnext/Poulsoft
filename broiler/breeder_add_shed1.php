            ...
            <section class="m-0 p-0 content">
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="breeder_save_shed1.php" method="post" role="form" onsubmit="return checkval()">
        ...
        <script>
			...
			function check_scode_duplicate(){
				...
				if(shed_code != ""){
					...
					var method = "GET";
					var url = "breeder_fetch_shedcode_duplicates.php?shed_code="+shed_code+"&type="+type;
                    //window.open(url);
					var asynchronous = true;
			...
			function check_sname_duplicate(){
				...
				if(description != ""){
					var oldqty = new XMLHttpRequest();
					var method = "GET";
					var url = "breeder_fetch_shedname_duplicates.php?description="+description+"&type="+type;
                    //window.open(url);
					var asynchronous = true;
					oldqty.open(method, url, asynchronous);
					oldqty.send();
