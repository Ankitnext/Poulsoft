<?php
//broiler_add_growingcharge_goels.php
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="p-0 pt-2 card-body">
                            <div class="col-md-12">
                                <form action="broiler_save_growingcharge_goels.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1" style="visibility:hidden;">
                                            <div class="row">
                                                <div class="form-group" style="width:20px;"><input type="text" name="high_feedin_sup_code" id="high_feedin_sup_code" class="form-control" style="width:10px;" readonly /></div>
                                                <div class="form-group" style="width:20px;"><input type="text" name="high_feedin_brand_code" id="high_feedin_brand_code" class="form-control" style="width:10px;" readonly /></div>
                                                <div class="form-group" style="width:20px;"><input type="text" name="high_chickin_secvcode" id="high_chickin_secvcode" class="form-control" style="width:10px;" readonly /></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="sales_incentive_avgwt" id="sales_incentive_avgwt" class="form-control" title="Sales Incentive Avg. Body Weight Calculations" readonly /></td>
                                                    <td><input type="text" name="avgwt_incentive_amt" id="avgwt_incentive_amt" class="form-control" readonly /></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="unload_incentive_prc" id="unload_incentive_prc" class="form-control" style="visibility:hidden;" readonly /></td>
                                                    <td><input type="text" name="unload_incentive_amt" id="unload_incentive_amt" class="form-control" onkeyup="calculate_amount_pay()" readonly /></td>
                                                </tr>
                                                <tr>
  ...
  <span></span>
        ...
        <script>
            ...
            function fetch_farmdetails(){
                ...
                if(farm_code != "select" && schema_id != "select"){
                    var fetchgc = new XMLHttpRequest();
					var method = "GET";
					var url = "broiler_fetch_rearingcharge_goels1.php?farm_code="+farm_code+"&schema_id="+schema_id+"&schema_name="+schema_name;
                    //window.open(url);
					var asynchronous = true;
