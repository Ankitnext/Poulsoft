<?php
//broiler_display_salaryparam1.php
include "newConfig.php";
include "number_format_ind.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $cid = $_GET['ccid'];
if($cid != ""){ $_SESSION['salaryparam1'] = $cid; } else{ $cid = $_SESSION['salaryparam1']; }
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM `salary_structures` WHERE `active` = '1' AND `dflag` = '0' ORDER BY `id` DESC";
                                    ...
                                    <tr>
										...
										<td><?php echo $desg_name[$row['desig_code']]; ?></td>
										<td style="text-align:right;"><?php echo round($row['basic'],5); ?></td>
										<td style="text-align:right;"><?php echo round($row['hra'],5); ?></td>
										<td style="text-align:right;"><?php echo round($row['medical'],5); ?></td>
										<td style="text-align:right;"><?php echo round($row['con_allow'],5); ?></td>
										<td style="text-align:right;"><?php echo round($row['transport'],5); ?></td>
        ...
        <script>
			function checkdelete(x){
                ...
                if(trnum != ""){
                    ...
                    var method = "GET";
                    var url = "breeder_check_salaryparam1.php?trnum="+trnum;
                    //window.open(url);
