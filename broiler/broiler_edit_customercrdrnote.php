<?php
//broiler_edit_customercrdrnote.php
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Edit Customer CrDr Note</h3></div>
                        </div>
                        <div class="p-0 pt-5 card-body">
                            <div class="col-md-12">
                                <form action="broiler_modify_customercrdrnote.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
							                ...
							                <input type="text" name="amount" id="amount" class="form-control" value="<?php echo $amount; ?>" style="width:90px;" />
                                        </div>
                                        <div class="form-group" style="width:170px;">
