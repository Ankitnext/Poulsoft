<?php
//broiler_add_itemdetails.php
include "newConfig.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $ccid = $_SESSION['itemdetails'];
    ...
    <body class="m-0 hold-transition">
                    ...
                    <div class="m-0 p-0 card">
                        ...
                        <div class="pl-2 card-body">
                            <!-- <div class="col-md-12 d-flex flex-wrap justify-content-center align-items-center"> -->
                                <form action="broiler_save_item.php" method="post" role="form" novalidate onsubmit="return checkval()">
                                    <div class="row table-wrapper-scroll" style="margin-bottom:3px;">
                                        <table class="p-1 form-group table1 table table-bordered table-sm">
                                            <thead>
                                            ...
                                            <tbody id="row_body">
                                                <tr>
                                                    ...
                                                    <td><input  type="text" name="vehicle_code[]" id="vehicle_code[0]" class="form-control" style="width:180px;" /></td>
                                                    <td><input  type="text" name="driver_code[]" id="driver_code[0]" class="form-control" style="width:180px;" /></td>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group" align="center">
                                            <button type="submit" name="submit" id="submit" class="btn btn-sm" style="background-color:rgb(102, 41, 200); color: white;">Submit</button>&ensp;
                                            <button type="button" name="cancel" id="cancel" class="btn btn-sm bg-danger" style="color:white;" onclick="return_back()">Cancel</button>
                                        </div>
                                    </div>
                                </form>
                            <!-- </div> -->
        ...
        <script>
            ...
            function return_back(){
                ...
                window.location.href = 'broiler_display_stocktransfer.php?ccid='+ccid;
            }
            ...
            function create_row(a){
                ...
                html += '<td><input type="text" name="vehicle_code[]" id="vehicle_code['+d+']" class="form-control" style="width:180px;" /></td>';
                html += '<td><input type="text" name="driver_code[]" id="driver_code['+d+']" class="form-control" style="width:180px;" /></td>';
