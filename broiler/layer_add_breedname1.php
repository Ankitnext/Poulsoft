                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Add Layer Name</h3></div>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="layer_save_breedname1.php" method="post" role="form" onsubmit="return checkval()">
        ...
        <script>
			function checkval(){
                ...
                for(var d = 0;d <= incr;d++){
                    if(l == true){
                        ...
                        if(description == ""){
                            alert("Please enter Description in row: "+e);
                                ...
                                if(l == true){
                                    if(c == d){ }
                                        ...
                                        if(iname == description){
                                            e = c + 1;
                                            alert("Same description already available in row: "+e);
                                            document.getElementById("description["+d+"]").focus();
                                            l = false;
                                        }
                                    }
			...
			function check_duplicate(a){
				...
				if(description != ""){
					...
					var method = "GET";
					var url = "layer_fetch_breedname1_duplicates.php?description="+description+"&type="+type+"&row_count="+d;
                    //window.open(url);
