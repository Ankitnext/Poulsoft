...
<html lang="en">
    ...
    <body class="m-0 hold-transition">
        <?php
        $ids = $_GET['trnum'];
        $sql = "SELECT * FROM `item_stocktransfers` WHERE `trnum` = '$ids' AND `dflag` = '0' AND `trlink` = 'breeder_display_send_stocks1.php'";
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="pl-2 card-body">
                            <form action="breeder_modify_send_stocks1.php" method="post" role="form" onsubmit="return checkval()">
                                    ...
                                    <table class="p-1 table1" style="width:auto;">
                                        ...
                                        <tbody id="tbody">
                                            <tr>
                                                ...
                                                <td><input type="text" name="quantity" id="quantity" class="form-control text-right" value="<?php echo $quantity; ?>" style="width:90px;" onkeyup="validatenum(this.id);calculate_amount();" onchange="validateamount(this.id);" /></td>
                                                <td><input type="text" name="price" id="price" class="form-control text-right" value="<?php echo $price; ?>" style="width:90px;" onkeyup="calculate_amount()"/></td>
                                                <td><input type="text" name="amount" id="amount" class="form-control text-right" value="<?php echo $amount; ?>" style="width:90px;" onkeyup="validatenum(this.id); calculate_amount()" /></td>
        ...
        <script>
            ...
            function calculate_amount() {
                let quantity = parseFloat(document.getElementById('quantity').value);  if(quantity == "") { quantity = 0; }
                let price = parseFloat(document.getElementById('price').value);  if(price == "") { price = 0; }
