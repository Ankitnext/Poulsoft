                                    ...
                                    <div class="col-md-6">
                                        <div class="row float-right">
                                            ...
                                            <div class="form-group">
                                                <button type="button" class="btn bg-success" id="editpage" value="broiler_edit_batchmultiple2.php" onclick="add_page(this.id)" ><i class="fa fa-align-left"></i> Edit-Multiple</button>&ensp;
                                            </div>
                                            <?php } ?>
                                            <?php if($add_flag == 1){ ?>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $farm_code = array();
                                        $sql = "SELECT * FROM `broiler_farm` WHERE `dflag` = '0'".$branch_filter."".$status_filter." ORDER BY `id` DESC"; $query = mysqli_query($conn,$sql);
                                        while($row = mysqli_fetch_assoc($query)){
                                        ...
                                        $sql = "SELECT * FROM `broiler_batch` WHERE `dflag` = '0'".$farm_filter."".$status_filter." ORDER BY `id` DESC"; $query = mysqli_query($conn,$sql); $c = 0;
                                        while($row = mysqli_fetch_assoc($query)){
                                            $id = $row['id'];
