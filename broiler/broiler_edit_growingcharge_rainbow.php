<?php
//broiler_edit_growingcharge_rainbow.php
include "newConfig.php";
date_default_timezone_set("Asia/Kolkata");
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $ccid = $_SESSION['growingcharge_rainbow'];
...
<html lang="en">
    ...
    <body class="m-0 p-0 hold-transition">
        ...
        while($row = mysqli_fetch_assoc($query)){
            ...
            $farmer_receipt_deduction = $row['farmer_receipt_deduction']; if($farmer_receipt_deduction == ""){ $farmer_receipt_deduction = 0; }
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="p-0 pt-2 card-body">
                            <div class="col-md-12">
                                <form action="broiler_modify_growingcharge_rainbow.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="farmer_receipt_deduction" id="farmer_receipt_deduction" class="form-control" value="<?php echo round($farmer_receipt_deduction,2); ?>" onkeyup="calculate_amount_pay()" /></td>
                                                </tr>
                                                <tr>
  ...
  <span></span>
        ...
        <script>
            function return_back(){
                ...
                window.location.href = 'broiler_display_growingcharge_rainbow.php?ccid='+ccid;
            }
            function checkval(){
            ...
            function fetch_farmdetails(){
                ...
                if(schema_name == "" || schema_name == "select"){
					...
					var method = "GET";
					var url = "broiler_fetch_rearingcharge_rainbow2.php?farm_code="+farm_code+"&batch_code="+batch_code+"&schema_id="+schema_id+"&schema_name="+schema_name;
                    //window.open(url);
					...
					fetchgc.onreadystatechange = function(){
						if(this.readyState == 4 && this.status == 200){
							...
							if(bbal == "") {
                                ...
                                document.getElementById("farmer_receipt_deduction").value = farm_details[89];
                                ...
                                document.getElementById("advance_deduction").value = farm_details[88];
