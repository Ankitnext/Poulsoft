<?php
//broiler_add_growingcharge_mistri.php
include "newConfig.php";
date_default_timezone_set("Asia/Kolkata");
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $ccid = $_SESSION['growingcharge_mistri'];
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="p-0 pt-2 card-body">
                            <div class="col-md-12">
                                <form action="broiler_save_growingcharge_mistri.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Week No.</label>
                                                <input type="text" name="week_no" id="week_no" class="form-control" style="width:180px;"/>
                                            </div>
                                        </div>
                                        <div class="col-md-2"></div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <table>
                                                ...
                                                <tr>
                                                    <td style="text-align:right;"><label for="lifting_efficiency">Lifting Efficiency</label></td>
                                                    <td><input type="text" name="lifting_efficiency" id="lifting_efficiency" class="form-control" readonly /></td>
                                        ...
                                        <div class="col-md-8">
                                            <table>
                                                <tr style="color:blue;">
                                                    ...
                                                    <td style="text-align:center;"><label>Maize Details</label></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="maize_in_qty" id="maize_in_qty" class="form-control" readonly /></td>
                                                    <td style="text-align:right;"><label>Transfer In</label></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="maize_cons_qty" id="maize_cons_qty" class="form-control" readonly /></td>
                                                    <td style="text-align:right;"><label>Consumption</label></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="maize_tout_qty" id="maize_tout_qty" class="form-control" readonly /></td>
                                                    <td style="text-align:right;"><label>Transfer Out</label></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="maize_cls_qty" id="maize_cls_qty" class="form-control" readonly /></td>
                                                    <td style="text-align:right;"><label>Closing</label></td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <table>
                                                ...
                                                <tr>
                                                    <td style="text-align:right;"><label>Maize Cost</label></td>
                                                    <td><input type="text" name="maize_cons_frmr_amt" id="maize_cons_frmr_amt" class="form-control" readonly /></td>
                                                    <td><input type="text" name="maize_cons_frmr_prc" id="maize_cons_frmr_prc" class="form-control" readonly /></td>
                                                    <td style="width:60px;visibility:hidden;"><input type="text" name="maize_cons_mgmt_amt" id="maize_cons_mgmt_amt" class="form-control" readonly /></td>
                                                    <td style="width:90px;visibility:hidden;"><input type="text" name="maize_cons_mgmt_prc" id="maize_cons_mgmt_prc" class="form-control" readonly /></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7">
                                            <table>
                                                ...
                                                <tr>
                                                    <td style="text-align:right;"><label>Growing charges approved</label></td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <table>
                                                ...
                                                <tr>
                                                    <td style="text-align:right;"><label>Coal deduction</label></td>
                                                    <td><input type="text" name="farmer_coal_deduction" id="farmer_coal_deduction" class="form-control" onkeyup="calculate_amount_pay()" /></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="row" style="visibility:hidden;">
                                        <div class="form-group" style="width:20px;">
                                            <label>DT</label>
							                <input type="text" name="date[]" id="date[0]" class="form-control datepicker" style="width:20px;" value="<?php echo date('d.m.Y'); ?>" readonly />
                                        </div>
                                        <div class="form-group" style="width:20px;">
                                            <label>SD</label>
							                <input type="text" name="sale_start_date" id="sale_start_date" class="form-control" style="width:20px;" value="" readonly />
                                        </div>
                                        <div class="form-group" style="width:20px;">
                                            <label>ED</label>
							                <input type="text" name="sale_end_date" id="sale_end_date" class="form-control" style="width:20px;" value="" readonly />
                                        </div>
                                    </div>
                                    <div class="col-12">
  ...
  <span></span>
        ...
        <script>
            function return_back(){
                ...
                window.location.href = 'broiler_display_growingcharge_mistri.php?ccid='+ccid;
            }
            function checkval(){
            ...
            function fetch_farmdetails(){
                ...
                if(!farm_code.match("select")){
					...
					var method = "GET";
					var url = "broiler_fetch_rearingcharge_mistri1.php?farm_code="+farm_code;
                    //window.open(url);
					...
					fetchgc.onreadystatechange = function(){
						if(this.readyState == 4 && this.status == 200){
							...
							if(bbal == "") {
                                ...
                                document.getElementById("lifting_efficiency").value = farm_details[88];
                                document.getElementById("sale_start_date").value = farm_details[92];
                                document.getElementById("sale_end_date").value = farm_details[93];
                                document.getElementById("farmer_coal_deduction").value = farm_details[99];

                                //Maize Calculations
                                document.getElementById("maize_in_qty").value = farm_details[94];
                                document.getElementById("maize_cons_qty").value = farm_details[89];
                                document.getElementById("maize_tout_qty").value = farm_details[95];
                                document.getElementById("maize_cls_qty").value = farm_details[96];
                                document.getElementById("maize_cons_frmr_prc").value = farm_details[90];
                                document.getElementById("maize_cons_frmr_amt").value = farm_details[91];
                                document.getElementById("maize_cons_mgmt_amt").value = farm_details[97];
                                document.getElementById("maize_cons_mgmt_prc").value = farm_details[98];
            ...
            function calculate_amount_pay(){
                ...
                var fcoal_ded_amt = document.getElementById("farmer_coal_deduction").value;
                ...
                if(fcoal_ded_amt.length == 0){ fcoal_ded_amt = 0; }
                ...
                famt_pay = (parseFloat(amt_pay) + parseFloat(transport_add_amt)) - (parseFloat(fsale_ded_amt) + parseFloat(fcoal_ded_amt) + parseFloat(feedtr_ded_amt) + parseFloat(vacc_ded_amt) + parseFloat(other_ded_amt));
                ...
                if(parseFloat(famt_pay) <= 0){
                    document.getElementById("tds_amt").value = 0;
                    document.getElementById("farmer_payable").value = 0;
                    document.getElementById("per_bird_price").value = 0;
                }
            }
