<?php
//broiler_save_purchase2_chicks23.php
...
$i = 0; foreach($_POST['mnu_fqty_flag'] as $mnu_fqty_flags){ $mnu_fqty_flag[$i] = $mnu_fqty_flags; $i++; }
...
$sql = "UPDATE `master_generator` SET `chick_purchases` = '$incr' WHERE `fdate` <='$date' AND `tdate` >= '$date' AND `type` = 'transactions'";
...
for($i = 0;$i < $dsize;$i++){
    ...
    if(!mysqli_query($conn,$sql)){ die("Error 1:-".mysqli_error($conn)); }
        ...
        VALUES ('CR','$coa_Cr','$date','$vcode','$trnum','$icode','$rcd_qty[$i]','$rate[$i]','$amount','$warehouse[$i]','$farm_batch','$remarks','0','ChicksPurchase-RcvQty','0','1','0','$addedemp','$addedtime','$addedtime')";
        if(!mysqli_query($conn,$from_post)){ die("Error 2:-".mysqli_error($conn)); } else{ }

        /* ***** Free Quantity ***** */
        if($fre_qty[$i] > 0){
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('CR','$coa_Cr','$date','$vcode','$trnum','$icode','$fre_qty[$i]','0','0','$warehouse[$i]','$farm_batch','$remarks','0','ChicksPurchase-FreeQty','0','1','0','$addedemp','$addedtime','$addedtime')";
            if(!mysqli_query($conn,$from_post)){ die("Free Qty Error 2:-".mysqli_error($conn)); } else{ }
        }

        /* ***** Stock Quantity ***** */
        $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
        VALUES ('DR','$coa_Dr','$date','$vcode','$trnum','$icode','$item_stock_qty','$item_avg_price','$item_avg_amount','$warehouse[$i]','$farm_batch','$remarks','0','ChicksPurchase-RcvQty','0','1','0','$addedemp','$addedtime','$addedtime')";
        if(!mysqli_query($conn,$from_post)){ die("Error 3:-".mysqli_error($conn)); } else{ }

        /* ***** GST ***** */
        if($gst_amt[$i] > 0){
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('CR','$coa_Cr','$date','$vcode','$trnum','$icode','0','$gst_value[$i]','$gst_amt[$i]','$warehouse[$i]','$farm_batch','$remarks','0','ChicksPurchase-GST','0','1','0','$addedemp','$addedtime','$addedtime')";
            if(!mysqli_query($conn,$from_post)){ die("GST Error 1:-".mysqli_error($conn)); } else{ }
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('DR','$gst_acc','$date','$vcode','$trnum','$icode','0','$gst_value[$i]','$gst_amt[$i]','$warehouse[$i]','$farm_batch','$remarks','0','ChicksPurchase-GST','0','1','0','$addedemp','$addedtime','$addedtime')";
            if(!mysqli_query($conn,$from_post)){ die("GST Error 2:-".mysqli_error($conn)); } else{ }
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('CR','$gst_acc','$date','$vcode','$trnum','$icode','0','$gst_value[$i]','$gst_amt[$i]','$warehouse[$i]','$farm_batch','$remarks','0','ChicksPurchase-GST','0','1','0','$addedemp','$addedtime','$addedtime')";
        ...
        if($dis_amt[$i] > 0){
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('DR','$discount_code','$date','$vcode','$trnum','$icode','0','$dis_per[$i]','$dis_amt[$i]','$warehouse[$i]','$farm_batch','$remarks','0','ChicksPurchase-Discount','0','1','0','$addedemp','$addedtime','$addedtime')";
            if(!mysqli_query($conn,$from_post)){ die("Discount Error:-".mysqli_error($conn)); } else{ }
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('CR','$discount_code','$date','$vcode','$trnum','$icode','0','$dis_per[$i]','$dis_amt[$i]','$warehouse[$i]','$farm_batch','$remarks','0','ChicksPurchase-Discount','0','1','0','$addedemp','$addedtime','$addedtime')";
            if(!mysqli_query($conn,$from_post)){ die("Discount Error:-".mysqli_error($conn)); } else{ }
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('DR','$coa_Cr','$date','$vcode','$trnum','$icode','0','$dis_per[$i]','$dis_amt[$i]','$warehouse[$i]','$farm_batch','$remarks','0','ChicksPurchase-Discount','0','1','0','$addedemp','$addedtime','$addedtime')";
            if(!mysqli_query($conn,$from_post)){ die("Discount Error:-".mysqli_error($conn)); } else{ }
        }
    }
}
...
if($freight_amt > 0){
    ...
    if($freight_type == "include"){
        $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
        VALUES ('DR','$freight_acc','$date','$vcode','$trnum','','0','0','$freight_amt','','','$remarks','0','ChicksPurchase-FreightI','0','1','0','$addedemp','$addedtime','$addedtime')";
        if(!mysqli_query($conn,$from_post)){ die("Freight Error 1:-".mysqli_error($conn)); }
        else{
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('CR','$coa_Cr','$date','$vcode','$trnum','','0','0','$freight_amt','','','$remarks','0','ChicksPurchase-FreightI','0','1','0','$addedemp','$addedtime','$addedtime')";
            if(!mysqli_query($conn,$from_post)){ die("Freight Error 2:-".mysqli_error($conn)); } else{ }

            /*Freight Value to Item Account
            $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
            VALUES ('CR','$freight_acc','$date','$vcode','$trnum','','0','0','$freight_amt','','','$remarks','0','ChicksPurchase-FreightI','0','1','0','$addedemp','$addedtime','$addedtime')";
        ...
        $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
        VALUES ('CR','$freight_pay_acc','$date','$vcode','$trnum','','0','0','$freight_amt','','','$remarks','0','ChicksPurchase-FreightE','0','1','0','$addedemp','$addedtime','$addedtime')";
        if(!mysqli_query($conn,$from_post)){ die("Freight Error 5:-".mysqli_error($conn)); } else{ }
        //Freight Value to Freight Account
        $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
        VALUES ('DR','$freight_acc','$date','$vcode','$trnum','','0','0','$freight_amt','','','$remarks','0','ChicksPurchase-FreightE','0','1','0','$addedemp','$addedtime','$addedtime')";
        ...
        $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
        VALUES ('CR','$coa_Cr','$date','$vcode','$trnum','','0','0','$freight_amt','','','$remarks','0','ChicksPurchase-FreightB','0','1','0','$addedemp','$addedtime','$addedtime')";
        if(!mysqli_query($conn,$from_post)){ die("Freight Error 8:-".mysqli_error($conn)); } else{ }
        //Freight Value to Freight Account
        $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
        VALUES ('DR','$freight_acc','$date','$vcode','$trnum','','0','0','$freight_amt','','','$remarks','0','ChicksPurchase-FreightB','0','1','0','$addedemp','$addedtime','$addedtime')";
        if(!mysqli_query($conn,$from_post)){ die("Freight Error 7:-".mysqli_error($conn)); } else{ }
        //Freight Value to Item Account
        $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
        VALUES ('CR','$freight_acc','$date','$vcode','$trnum','','0','0','$freight_amt','','','$remarks','0','ChicksPurchase-FreightB','0','1','0','$addedemp','$addedtime','$addedtime')";
        if(!mysqli_query($conn,$from_post)){ die("Freight Error 8:-".mysqli_error($conn)); } else{ }
...
if($tcds_amt > 0){
    ...
    $coa_Cr = $control_acc_group[$contact_group[$vcode]];
    $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
    VALUES ('CR','$coa_Cr','$date','$vcode','$trnum','','0','0','$tcds_amt','','','$remarks','0','ChicksPurchase-TDS','0','1','0','$addedemp','$addedtime','$addedtime')";
    if(!mysqli_query($conn,$from_post)){ die("TDS Error 1:-".mysqli_error($conn)); }
    else{
        $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
        VALUES ('DR','$tds_code','$date','$vcode','$trnum','','0','0','$tcds_amt','','','$remarks','0','ChicksPurchase-TDS','0','1','0','$addedemp','$addedtime','$addedtime')";
        if(!mysqli_query($conn,$from_post)){ die("TDS Error 2:-".mysqli_error($conn)); } else{ }
        $from_post = "INSERT INTO `account_summary` (crdr,coa_code,date,vendor,trnum,item_code,quantity,price,amount,location,batch,remarks,gc_flag,etype,flag,active,dflag,addedemp,addedtime,updatedtime) 
        VALUES ('CR','$tds_code','$date','$vcode','$trnum','','0','0','$tcds_amt','','','$remarks','0','ChicksPurchase-TDS','0','1','0','$addedemp','$addedtime','$addedtime')";
        if(!mysqli_query($conn,$from_post)){ die("TDS Error 2:-".mysqli_error($conn)); } else{ }
    }
}
