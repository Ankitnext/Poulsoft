...
if(isset($_REQUEST['submit_report']) == true){
    ...
    $branches = $_REQUEST['branches']; if($branches == ""){ $branches = "all"; }
    $lines = $_REQUEST['lines']; if($lines == ""){ $lines = "all"; }
    $supervisors = $_REQUEST['supervisors']; if($supervisors == ""){ $supervisors = "all"; }
    $farms = $_REQUEST['farms']; if($farms == ""){ $farms = "all"; }
    //$fetch_type = $_REQUEST['fetch_type'];
    $excel_type = $_REQUEST['export']; if($excel_type == ""){ $excel_type = "display"; }
}
?>
<html>
    <head>
