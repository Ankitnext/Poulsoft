...
<html lang="en">
    ...
    <body class="m-0 p-0 hold-transition">
        <?php
            $id = $_GET['trnum'];
            $sql = "SELECT * FROM `broiler_receipts` WHERE `trnum` = '$id'"; $query = mysqli_query($conn,$sql);
            while($row = mysqli_fetch_assoc($query)){
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="p-0 pt-5 card-body">
                            <div class="col-md-12">
                                <form action="broiler_modify_receipt.php" method="post" role="form" onsubmit="return checkval()">
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group" style="width:110px;">
							                ...
							                <input type="text" name="amount" id="amount" class="form-control" value="<?php echo $amount; ?>" style="width:100px;" onkeyup="getamountinwords();validatenum(this.id);" onchange="validateamount(this.id);">
                                        </div>
                                        <div class="form-group" style="width:110px;">
                                            <label>Reference No</label>
							                <input type="text" name="dcno" id="dcno" class="form-control" value="<?php echo $docno; ?>" style="width:100px;" onkeyup="validatename(this.id);" />
                                        </div>
                                        <div class="form-group" style="width:130px;">
                                            <label>Remarks</label>
							                <textarea name="remark" id="remark" class="form-control" style="padding:1px;width:120px;height:23px;" onkeyup="validatename(this.id);"><?php echo $remarks; ?></textarea>
                                        </div>
