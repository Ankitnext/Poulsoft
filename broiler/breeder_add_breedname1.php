                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Add Breed Name</h3></div>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="breeder_save_breedname1.php" method="post" role="form" onsubmit="return checkval()">
        ...
        <script>
			...
			function check_duplicate(a){
				...
				if(description != ""){
					...
					var method = "GET";
					var url = "breeder_fetch_breedname1_duplicates.php?description="+description+"&type="+type+"&row_count="+d;
                    //window.open(url);
