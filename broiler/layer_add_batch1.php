            ...
            <section class="m-0 p-0 content">
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="layer_save_batch1.php" method="post" role="form" onsubmit="return checkval()">
                                        ...
                                        <table class="table1" style="width:auto;">
                                            <tbody>
                                                    ...
                                                    <td colspan="3">
                                                        <div class="row justify-content-center align-items-center">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="radio" name="bird_source" id="bird_source1" value="own_hatchery" onchange="fetch_layer_vslist();" checked />
                                                            </div>&ensp;&ensp;&ensp;&ensp;
                                                            <div class="form-group">
                                                                <label for="bird_source2">Purchase</label>
                                                                <input type="radio" name="bird_source" id="bird_source2" value="purchase" onchange="fetch_layer_vslist();" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr> -->
                                                <tr>
                                                    ...
                                                    <td colspan="3"><select name="vs_code" id="vs_code" class="form-control select2" style="width:390px;"><option value="select">-select-</option><?php foreach($ven_code as $vcode){ ?><option value="<?php echo $vcode; ?>"><?php echo $ven_name[$vcode]; ?></option><?php } ?></select></td>
                                                </tr>
                                                <tr>
                                                    <th><label for="batch_code">Batch Code<b style="color:red;">&nbsp;*</b></label></th>
                                                    <td><input type="text" name="batch_code" id="batch_code" class="form-control" style="width:120px;" onkeyup="validatename(this.id);" onchange="validatename(this.id);check_scode_duplicate();" /></td>
                                                    <th><label for="description">Batch Name<b style="color:red;">&nbsp;*</b></label></th>
                                                    <td><input type="text" name="description" id="description" class="form-control" style="width:170px;" onkeyup="validatename(this.id);" onchange="validatename(this.id);check_sname_duplicate();" /></td>
                                                </tr>
                                                <tr>
                                                    <th><label for="breed_code">Breed<b style="color:red;">&nbsp;*</b></label></th>
                                                    <td colspan="3"><select name="breed_code" id="breed_code" class="form-control select2" style="width:390px;"><option value="select">-select-</option><?php foreach($bbreed_code as $ucode){ ?><option value="<?php echo $ucode; ?>"><?php echo $bbreed_name[$ucode]; ?></option><?php } ?></select></td>
                                                </tr>
                                                <!--<tr>
                                                    <th><label for="bstart_date">Batch Start Date</label></th>
                                                    <td><input type="text" name="bstart_date" id="bstart_date" class="form-control datepicker" value="<?php //echo $date; ?>" style="width:120px;" readonly /></td>
                                                    <th><label for="start_age">Start Age</label></th>
                                                    <td><input type="text" name="start_age" id="start_age" class="form-control text-right" style="width:110px;" onkeyup="validate_count(this.id);" onchange="validate_count(this.id);" /></td>
                                                </tr>-->
                                                <tr>
                                                    <th></th>
                                                    <td colspan="3">
                                                        <div class="row">
                                                            <div class="form-group">
                                                                &ensp;<input type="checkbox" name="beps_flag" id="beps_flag" />
        ...
        <script>
			...
			function check_scode_duplicate(){
				...
				if(batch_code != ""){
					...
					var method = "GET";
					var url = "layer_fetch_batchcode_duplicates.php?batch_code="+batch_code+"&type="+type;
                    //window.open(url);
					var asynchronous = true;
			...
			function check_sname_duplicate(){
				...
				if(description != ""){
					var oldqty = new XMLHttpRequest();
					var method = "GET";
					var url = "layer_fetch_batchname_duplicates.php?description="+description+"&type="+type;
                    //window.open(url);
					var asynchronous = true;
					oldqty.open(method, url, asynchronous);
					oldqty.send();
