<?php
//broiler_edit_stocktransfer.php
include "newConfig.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $ccid = $_SESSION['stocktransfer'];
                            ...
                            <div class="col-md-12 d-flex flex-wrap justify-content-center align-items-center">
                                <form action="broiler_modify_item.php" method="post" role="form" onsubmit="return checkval()">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <label>Batch</label>
                                            <input readonly type="text" name="batch" id="batch"  value="<?php echo $rename_batch; ?>" class="form-control" style="width:180px;" />
                                        </div>
                                        <div class="form-group" style="width:130px;">
                                            <label>Vehicle</label>
                                            <input readonly type="text" name="vehicle_code" id="vehicle_code"  value="<?php echo $vcode; ?>" class="form-control" style="width:180px;" />
                                        </div>
                                        <div class="form-group" style="width:130px;">
                                            <label>Driver</label>
                                            <input readonly type="text" name="driver_code" id="driver_code"  value="<?php echo $driver_code; ?>" class="form-control" style="width:180px;" />
                                        </div>
                                        <div class="form-group">
                                            <label>Remarks</label>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group" align="center">
                                            <button type="submit" name="submit" id="submit" class="btn btn-sm" style="background-color:rgb(102, 41, 200); color: white;">Update</button>&ensp;
