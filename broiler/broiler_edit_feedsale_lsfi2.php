<?php
//broiler_edit_feedsale_lsfi2.php
...
if($link_active_flag > 0){
    ...
    if($acount == 1){
        ...
        $sql4 = "SELECT *  FROM `extra_access` WHERE `field_name` LIKE 'broiler_display_feedsale_lsfi.php' AND `field_function` LIKE 'Fetch Customer Item Prices from Price Master'  AND  `user_access` = 'all' AND `flag` = '1'";
...
<html lang="en">
    ...
    <body class="m-0 hold-transition">
        ...
        while($row = mysqli_fetch_assoc($query)){
            ...
            $prt[$i] = $row['prt'];
            $prt_amt[$i] = $row['prt_amt'];
            $chrg_prc[$i] = $row['chrg_prc'];
            $br_code[$i] = $row['branch_code'];
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="m-0 p-2 card-body">
                            <div class="col-md-18">
                                <form action="broiler_modify_feedsale_lsfi2.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                    ...
                                    <table>
                                        ...
                                        <tbody id="row_body">
                                            ...
                                            <tr id="row_no[<?php echo $c; ?>]">
                                                ...
                                                <td><input type="text" name="rcd_qty[]" id="rcd_qty[<?php echo $c; ?>]" class="form-control" value="<?php echo $rcd_qty[$c]; ?>" placeholder="0.00" style="width:90px;" onkeyup="validatenum(this.id);" onchange="validateamount(this.id);" ></td>
                                                ...
                                                <td><input type="text" name="prt_per[]" id="prt_per[<?php echo $c; ?>]" class="form-control" value="<?php echo $prt[$c]; ?>" placeholder="0.00" style="width:90px;" onkeyup="validatenum5(this.id);calculate_total_amt(this.id);" onchange="validateamount5(this.id);" ></td>
                                                <td><input type="text" name="prt_pamt[]" id="prt_pamt[<?php echo $c; ?>]" class="form-control" value="<?php echo $prt_amt[$c]; ?>" placeholder="0.00" style="width:90px;" onkeyup="validatenum5(this.id);calculate_total_amt(this.id);" onchange="validateamount5(this.id);" readonly></td>
                                                <td><input type="text" name="chrg_prc[]" id="chrg_prc[<?php echo $c; ?>]" class="form-control" value="<?php echo $chrg_prc[$c]; ?>" placeholder="0.00" style="width:90px;" onkeyup="validatenum5(this.id);calculate_total_amt(this.id);" onchange="validateamount5(this.id);" readonly></td>
                                                ...
                                                <td><select name="branch[]" id="branch[<?php echo $c; ?>]" class="form-control select2" style="width:180px;" onchange="fetch_stock_master(this.id);"><option value="select">select</option><?php foreach($branch_code as $prod_code){ ?><option value="<?php echo $prod_code; ?>" <?php if($br_code[$c] == $prod_code){ echo "selected"; } ?>><?php echo $branch_name[$prod_code]; ?></option><?php } ?></select></td>
