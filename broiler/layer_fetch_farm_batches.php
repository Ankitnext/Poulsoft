...
$inv_list = "";
$sql = "SELECT * FROM `layer_batch` WHERE `farm_code` IN ('$farm_code') AND `unit_code` IN ('$unit_code') AND `active` = '1' AND `dflag` = '0' ORDER BY `description` ASC";
