<?php
//broiler_add_growingcharge_spfp.php
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="p-0 pt-2 card-body">
                            <div class="col-md-12">
                                <form action="broiler_save_growingcharge_spfp.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="visibility:hidden"><input type="text" name="days7_mort_count" id="days7_mort_count" class="form-control" readonly /></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="visibility:hidden"><input type="text" name="days30_mort_count" id="days30_mort_count" class="form-control" readonly /></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td style="visibility:hidden"><input type="text" name="days31_mort_count" id="days31_mort_count" class="form-control" readonly /></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="sfcr" id="sfcr" class="form-control" readonly /></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="actual_birds" id="actual_birds" class="form-control" readonly /></td>
        ...
        <script>
            ...
            function fetch_farmdetails(){
                ...
                if(!farm_code.match("select")){
					...
					var method = "GET";
					var url = "broiler_fetch_rearingcharge_spfp1.php?farm_code="+farm_code;
                    //window.open(url);
