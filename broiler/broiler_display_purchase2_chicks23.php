<?php
//broiler_display_purchase2_chicks23.php
include "newConfig.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $cid = $_GET['ccid'];
if($cid != ""){ $_SESSION['purchase2_chicks23'] = $cid; } else{ $cid = $_SESSION['purchase2_chicks23']; }
                                ...
                                <div class="row">
                                    ...
                                    <div class="row float-right">
                                        ...
                                        <div class="form-group">
                                            <button type="button" class="btn bg-success" id="editpage" value="broiler_edit_purchase2_chicksm23.php" onclick="add_page(this.id)" ><i class="fa fa-align-left"></i> Edit-Multiple</button>&ensp;
                                        </div>
                                        <?php } ?>
                                        <?php if($add_flag == 1){ ?>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-min" role="document">
                                    <div class="modal-content">
                                        <div class="modal-body text-left">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <form action="broiler_upload_purchase2_chicks23.php" method="post" onsubmit="return add_newcomment()" enctype="multipart/form-data">
