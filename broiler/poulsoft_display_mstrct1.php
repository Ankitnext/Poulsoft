<?php
//poulsoft_display_mstrct1.php
include "newConfig.php";
include "number_format_ind.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $cid = $_GET['ccid'];
if($cid != ""){ $_SESSION['mstrct1'] = $cid; } else{ $cid = $_SESSION['mstrct1']; }
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        $sql = "SELECT * FROM `master_receipts` WHERE `date` >= '$fdate' AND `date` <= '$tdate' AND `dflag` = '0' AND `trlink` = '$href' ORDER BY `date`,`trnum` ASC";
        ...
        <script>
			function checkdelete(x){
                ...
                if(trnum != ""){
                    ...
                    var method = "GET";
                    var url = "poulsoft_check_mstrct1.php?trnum="+trnum;
                    //window.open(url);
