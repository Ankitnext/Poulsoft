<?php
//broiler_edit_purchase2_chicks23.php
...
<html lang="en">
    ...
    <body class="m-0 hold-transition">
        ...
        while($row = mysqli_fetch_assoc($query)){
            ...
            $mnu_fqty_flag[$pcount] = $row['mnu_fqty_flag']; if($mnu_fqty_flag[$pcount] == ""){ $mnu_fqty_flag[$pcount] = 0; }
            ...
            $item_tamt[$pcount] = round($row['item_tamt']); 
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="m-0 p-2 card-body">
                            <div class="col-md-18">
                                <form action="broiler_modify_purchase2_chicks23.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                    ...
                                    <div class="row" style="margin-bottom:3px;" id="row_no[<?php echo $i; ?>]">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fre_qper[]" id="fre_qper[<?php echo $i; ?>]" class="form-control" value="<?php echo $fre_qper[$i]; ?>" placeholder="0.00" style="width:80px;" onkeyup="validatenum(this.id);upd_mnhfree_qty_flag(this.id);calculate_total_amt(this.id);" onchange="validateamount(this.id);" >
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label <?php if($i > 0){ echo 'class="labelrow" style="display:none;"'; } ?>>Free Qty</label>
                                            <input type="text" name="fre_qty[]" id="fre_qty[<?php echo $i; ?>]" class="form-control" value="<?php echo $fre_qty[$i]; ?>" placeholder="0.00" style="width:80px;" onkeyup="validatenum(this.id);upd_mnhfree_qty_flag(this.id);calculate_total_amt(this.id);" onchange="validateamount(this.id);" >
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="rate[]" id="rate[<?php echo $i; ?>]" class="form-control" value="<?php echo $rate[$i]; ?>" placeholder="0.00" style="width:80px;" onkeyup="validatenum5(this.id);calculate_total_amt(this.id);fetch_discount_amount(this.id);" onchange="validateamount5(this.id);" >
                                        </div>
                                        <div class="form-group">
                                            <label <?php if($i > 0){ echo 'class="labelrow" style="display:none;"'; } ?>>Amount</label>
                                            <input type="text" name="item_tamt[]" id="item_tamt[<?php echo $i; ?>]" value="<?php echo round(($rcd_qty[$i] * $rate[$i]),0); ?>" class="form-control" placeholder="0.00" style="width:90px;" onkeyup="validatenum(this.id);cal_prc(this.id);" >
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group" style="width:20px;visibility:hidden;">
                                            <label <?php if($i > 0){ echo 'class="labelrow" style="display:none;"'; } ?> title="Discount Percentage">MF</label>
                                            <input type="text" name="mnu_fqty_flag[]" id="mnu_fqty_flag[<?php echo $i; ?>]" class="form-control" value="<?php echo $mnu_fqty_flag[$i]; ?>" style="width:20px;" readonly />
                                        </div>
                                    </div>
                                    <?php
                                    }
