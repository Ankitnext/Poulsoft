<?php
//breeder_edit_stocktransfer1.php
...
<html lang="en">
    ...
    <body class="m-0 hold-transition">
        <?php
        $ids = $_GET['trnum'];
        $sql = "SELECT * FROM `item_stocktransfers` WHERE `trnum` = '$ids' AND `dflag` = '0' AND `trlink` = 'breeder_display_stocktransfer1.php'";
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="pl-2 card-body">
                            <form action="breeder_modify_stocktransfer1.php" method="post" role="form" onsubmit="return checkval()">
