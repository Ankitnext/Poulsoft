<?php
//broiler_add_growingcharge_rainbow.php
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="p-0 pt-2 card-body">
                            <div class="col-md-12">
                                <form action="broiler_save_growingcharge_rainbow.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
        ...
        <script>
            ...
            function fetch_farmdetails(){
                ...
                if(!farm_code.match("select") && schema_id != "select"){
					...
					var method = "GET";
					var url = "broiler_fetch_rearingcharge_rainbow1.php?farm_code="+farm_code+"&schema_id="+schema_id+"&schema_name="+schema_name;
                    //window.open(url);
