<?php
//breeder_add_stocktransfer1.php
    ...
    <body class="m-0 hold-transition">
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="pl-2 card-body">
                            <form action="breeder_save_stocktransfer1.php" method="post" role="form" onsubmit="return checkval()">
        ...
        <script>
            ...
            function return_back(){
                ...
                window.location.href = 'breeder_display_stocktransfer1.php?ccid='+ccid;
            }
