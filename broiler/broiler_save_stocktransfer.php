<?php
//broiler_save_stocktransfer.php
...
$sql1 = "SELECT *  FROM `extra_access` WHERE `field_name` LIKE 'StktransAutoWapp:broiler_display_stocktransfer.php' AND `user_access` LIKE '%$addedemp%'"; $query1 = mysqli_query($conn,$sql1); $ccount1 = mysqli_num_rows($query1);
$sql2 = "SELECT *  FROM `extra_access` WHERE `field_name` LIKE 'StktransAutoWapp:broiler_display_stocktransfer.php' AND `user_access` = 'all'"; $query2 = mysqli_query($conn,$sql2); $ccount2 = mysqli_num_rows($query2);
