<?php
//broiler_farmwise_performance1_ta.php
...
if($db == ''){
    ...
    $form_path = "broiler_farmwise_performance1_ta.php";
}
else{
    ...
    include "header_head.php";
    $form_path = "broiler_farmwise_performance1_ta.php?db=$db&userid=".$user_code;
}
