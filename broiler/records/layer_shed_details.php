...
if($db == ''){
    ...
    $form_path = "layer_shed_details.php";
}
else{
    ...
    include "header_head.php";
    $form_path = "layer_shed_details.php?db=$db&userid=".$user_code;
}
    ...
    <body align="center">
        ...
        <table id="main_table" class="tbl" align="center">
            ...
            if(isset($_POST['submit_report']) == true){
                ...
                $sql = "SELECT * FROM `layer_sheds` WHERE `active` = '1'".$farm_fltr."".$unit_fltr." AND `dflag` = '0' ORDER BY `addedtime` ASC";
