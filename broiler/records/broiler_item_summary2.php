...
<html>
    ...
    <body align="center">
        <table class="tbl" style="width:auto;" align="center">
            ...
            <?php } ?>
            <form action="broiler_item_summary2.php" method="post" onsubmit="return checkval()">
            ...
            if(isset($_POST['submit_report']) == true){
                ...
                foreach($sector_list as $slist){
                    foreach($item_list as $ilist){
                        $key = $slist."@".$ilist;
                        $ccode = $item_category[$ilist]; $key2 = $slist."@".$ccode; $icat_list[$ccode] = $ccode;
