<?php
//broiler_supplier_debitnote.php
...
global $page_title; $page_title = "Supplier Debit Note Report";
...
if(isset($_POST['submit_report']) == true){
    ...
    $export_sectors = $sector_name[$_POST['sectors']]; if ( $export_sectors == "") {  $export_sectors = "All"; }
     ...
     {$filename = "Supplier Debit Note_".$export_tdate; }
      else {
     $filename = "Supplier Debit Note_".$export_fdate."_to_".$export_tdate; }
        ...
        <table class="tbl" align="center">
            ...
            <thead class="thead1" align="center">
                <tr align="center">
                    ...
                    <th colspan="12" align="center"><?php echo $row['cdetails']; ?><h5>Supplier Debit Note Report</h5></th>
                </tr>
            </thead>
            <?php } ?>
            <form action="broiler_supplier_debitnote.php" method="post">
                    ...
                    <tr>
                        <th colspan="14">
                            <div class="row">
                                ...
                                <div class="m-2 form-group">
                                    <label>Export</label>
                                    <select name="export" id="export" class="form-control select2" onchange="tableToExcel('main_body', 'Supplier Debit Note','<?php echo $filename;?>', this.options[this.selectedIndex].value)">
           ...
           <thead class="thead1" align="center" style="width:1212px;  display:none; ">
            ...
            <tbody class="tbody1">
                <?php
                $sql_record = "SELECT * FROM `broiler_crdrnote` WHERE `date` >= '$fdate' AND `date` <= '$tdate'".$vcodes."".$wcodes." AND `type` IN ('Supplier') AND `crdr` IN ('Debit') AND `active` = '1' AND `dflag` = '0' ORDER BY `date`,`trnum` ASC";
