...
if($db == ''){
    ...
    global $page_title; $page_title = "Vaccination Schedule Report";
    include "header_head.php";
    $form_path = "breeder_medvacschedule.php";
}
else{
    ...
    global $page_title; $page_title = "Vaccination Schedule Report";
    include "header_head.php";
    $form_path = "breeder_medvacschedule.php?db=$db&userid=".$user_code;
}
...
if(in_array("broiler_vaccineschedule", $exist_tbl_names, TRUE) == ""){ $sql1 = "CREATE TABLE $database_name.broiler_vaccineschedule LIKE poulso6_admin_breeder_breedermaster.broiler_vaccineschedule;"; mysqli_query($conn,$sql1); }
