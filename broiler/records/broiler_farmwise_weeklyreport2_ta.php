<?php
//broiler_farmwise_weeklyreport2_ta.php
...
if($db == ''){
    ...
    $form_path = "broiler_farmwise_weeklyreport2_ta.php";
}
else{
    ...
    include "header_head.php";
    $form_path = "broiler_farmwise_weeklyreport2_ta.php?db=$db&userid=".$user_code;
}
...
<html>
    ...
    <body align="center">
        ...
        <table id="main_table" class="tbl" align="center">
            ...
            $nhtml .= '<th colspan="6">Lot Details</th>'; $fhtml .= '<th id="order" colspan="6">Lot Details</th>';
            $nhtml .= '<th colspan="3">Mortality Details</th>'; $fhtml .= '<th id="order" colspan="3">Mortality Details</th>';
            $nhtml .= '<th colspan="3">Feed Intake</th>'; $fhtml .= '<th id="order" colspan="3">Feed Intake</th>';
            $nhtml .= '<th colspan="5">Weight</th>'; $fhtml .= '<th id="order" colspan="5">Weight</th>';
            $nhtml .= '<th colspan="3">FCR</th>'; $fhtml .= '<th id="order" colspan="3">FCR</th>';
            $nhtml .= '<th colspan="3"></th>'; $fhtml .= '<th id="order" colspan="3"></th>';
                        ...
                        if($batch_size > 0){
                            ...
                            for($wno = 1;$wno <= 10;$wno++){
                                ...
                                if((float)$rw_bnos > 0 && $farms == "all"){
                                    ...
                                    if((int)$wno == 1){ $html .= '<th style="text-align:right;" colspan="4">Lot Summary</th>'; } else{ $html .= '<th style="text-align:right;" colspan="4">Weekly Summary</th>'; }
