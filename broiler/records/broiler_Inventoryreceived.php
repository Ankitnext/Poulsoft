...
global $page_title; $page_title = "Inventory Received Report";
...
if(isset($_POST['submit_report']) == true){
    ...
    $export_items = $item_name[$_POST['items']]; if ($export_items == "") { $export_items = "All"; } 
     ...
     {$filename = "Inventory Received Report_".$export_tdate; }
      else {
     $filename = "Inventory Received Report_".$export_fdate."_to_".$export_tdate; }
        ...
        <table class="tbl" align="center">
            ...
            <thead class="thead1" align="center">
                <tr align="center">
                    ...
                    <th colspan="6" align="center" style="border-right:none;"><?php echo $row['cdetails']; ?><h5>Inventory Received Report</h5></th>
                </tr>
            </thead>
            <?php } ?>
            <form action="broiler_Inventoryreceived.php" method="post">
                    ...
                    <tr>
                        <th colspan="8">
                            <div class="row">
                                ...
                                <div class="m-2 form-group">
                                    <label>Export</label>
                                    <select name="export" id="export" class="form-control select2"  onchange="tableToExcel('main_body', 'Inventory Received','<?php echo $filename;?>', this.options[this.selectedIndex].value)">
           ...
           <table id="main_body" class="tbl" align="center"  style="width:1300px;">
            ...
            ?>
                <tr align="center">
                    ...
                    <th colspan="8" align="center" style="border-right:none;"><?php echo $row['cdetails']; ?><h5>Inventory Received Report</h5></th>
            ...
            <tbody class="tbody1">
                ...
                $sql = "SELECT * FROM `broiler_inv_intermediate_received` WHERE `date` >= '$fdate' AND `date` <= '$tdate'".$item_filter." AND `active` = '1' AND `dflag` = '0' ORDER BY `date`,`trnum` ASC"; $query = mysqli_query($conn,$sql);
                while($row = mysqli_fetch_assoc($query)){
                ?>
                <tr>
