...
$file_name = "Stock Report with Amount";
...
while($row = mysqli_fetch_assoc($query)){ $item_code[$row['code']] = $row['code']; $item_name[$row['code']] = $row['description']; $item_category[$row['code']] = $row['category']; $item_unit[$row['code']] = $row['cunits']; }
...
if(isset($_POST['submit_report']) == true){
	...
	//$url = "../PHPExcel/Examples/broiler_stock_report2-Excel.php?fdate=".$fdate."&tdate=".$tdate."&item_cat=".$item_cat."&sectors=".$sectors;
}
?>
<html>
    <head>
    ...
    <body align="center">
        <table class="tbl" align="center">
            ...
            <?php } ?>
            <form action="broiler_stock_report2_ta.php" method="post">
        ...
        <table class="tbl" align="center" id="main_table">
            ...
            <tbody class="tbody1">
                <?php
                    ...
                    $sql = "SELECT * FROM `item_details` WHERE `code` IN ('$aitem_list')".$trasin_item_filter." ORDER BY `description` ASC"; $query = mysqli_query($conn,$sql); $aitem_code = array();
                    ...
                    foreach($aitem_code as $ikey){
                        if(number_format_ind($final_opening_stock[$ikey]) != "0.00" || number_format_ind($final_purin_qty[$ikey]) != "0.00" || number_format_ind($final_in_quantity[$ikey]) != "0.00" || number_format_ind($final_consumed_quantity[$ikey]) != "0.00" || number_format_ind($final_sold_quantity[$ikey]) != "0.00" || number_format_ind($final_salereturn_quantity[$ikey]) != "0.00" || number_format_ind($final_closing_stock[$ikey]) != "0.00"){
                            ...
                            if(!empty($final_opening_amounts[$ikey]) && $final_opening_amounts[$ikey] > 0 && !empty($final_opening_stock[$ikey]) && $final_opening_stock[$ikey] > 0){
                                echo "<td title='Opening' style='text-align:right;'>".number_format_ind($final_opening_amounts[$ikey] / $final_opening_stock[$ikey])."</td>";
                            }
                            else{
                                echo "<td title='Opening' style='text-align:right;'>".number_format_ind(0)."</td>";
                            }
                            

                            echo "<td title='Opening' style='text-align:right;'>".number_format_ind($final_opening_amounts[$ikey])."</td>";

                            //Purchases
                            echo "<td title='Purchase/Transfer In' style='text-align:right;'>".number_format_ind($final_purin_qty[$ikey])."</td>";
                            if(!empty($final_purin_amt[$ikey]) && $final_purin_amt[$ikey] > 0 && !empty($final_purin_qty[$ikey]) && $final_purin_qty[$ikey] > 0){
                                echo "<td title='Purchase/Transfer In' style='text-align:right;'>".number_format_ind(round(($final_purin_amt[$ikey] / $final_purin_qty[$ikey]),2))."</td>";
                            }
                            else{ echo "<td title='Purchase/Transfer In' style='text-align:right;'>".number_format_ind(0)."</td>"; }
                            echo "<td title='Purchase/Transfer In' style='text-align:right;'>".number_format_ind($final_purin_amt[$ikey])."</td>";

                            //Stock-In
                            echo "<td title='Purchase/Transfer In' style='text-align:right;'>".number_format_ind($final_in_quantity[$ikey])."</td>";
                            if(!empty($final_in_amounts[$ikey]) && $final_in_amounts[$ikey] > 0 && !empty($final_in_quantity[$ikey]) && $final_in_quantity[$ikey] > 0){
                                echo "<td title='Purchase/Transfer In' style='text-align:right;'>".number_format_ind(round(($final_in_amounts[$ikey] / $final_in_quantity[$ikey]),2))."</td>";
                            }
                            else{ echo "<td title='Purchase/Transfer In' style='text-align:right;'>".number_format_ind(0)."</td>"; }
                            echo "<td title='Purchase/Transfer In' style='text-align:right;'>".number_format_ind($final_in_amounts[$ikey])."</td>";


                            echo "<td title='Consumption/Transferout' style='text-align:right;'>".number_format_ind($final_consumed_quantity[$ikey])."</td>";
                            if(!empty($final_consumed_amounts[$ikey]) && $final_consumed_amounts[$ikey] > 0 && !empty($final_consumed_quantity[$ikey]) && $final_consumed_quantity[$ikey] > 0){
                                echo "<td title='Consumption/Transferout' style='text-align:right;'>".number_format_ind(round(($final_consumed_amounts[$ikey] / $final_consumed_quantity[$ikey]),2))."</td>";
                            }
                            else{
                                echo "<td title='Consumption/Transferout' style='text-align:right;'>".number_format_ind(0)."</td>";
                            }
                            ...
                            if(!empty($final_sold_amounts[$ikey]) && $final_sold_amounts[$ikey] > 0 && !empty($final_sold_quantity[$ikey]) && $final_sold_quantity[$ikey] > 0){
                                echo "<td title='Sold' style='text-align:right;'>".number_format_ind(round(($final_sold_amounts[$ikey] / $final_sold_quantity[$ikey]),2))."</td>";
                            }
                            else{
                                echo "<td title='Sold' style='text-align:right;'>".number_format_ind(0)."</td>";
                            }
                            
                            echo "<td title='Sold' style='text-align:right;'>".number_format_ind($final_sold_amounts[$ikey])."</td>";

                            echo "<td title='Sale Return' style='text-align:right;'>".number_format_ind($final_purreturn_quantity[$ikey])."</td>";
                            if(!empty($final_purreturn_amounts[$ikey]) && $final_purreturn_amounts[$ikey] > 0 && !empty($final_purreturn_quantity[$ikey]) && $final_purreturn_quantity[$ikey] > 0){
                                echo "<td title='Sale Return' style='text-align:right;'>".number_format_ind(round(($final_purreturn_amounts[$ikey] / $final_purreturn_quantity[$ikey]),2))."</td>";
                            }
                            else{
                                echo "<td title='Sale Return' style='text-align:right;'>".number_format_ind(0)."</td>";
                            }
                            echo "<td title='Sale Return' style='text-align:right;'>".number_format_ind($final_purreturn_amounts[$ikey])."</td>";

                            echo "<td title='Sale Return' style='text-align:right;'>".number_format_ind($final_salereturn_quantity[$ikey])."</td>";
                            if(!empty($final_salereturn_amounts[$ikey]) && $final_salereturn_amounts[$ikey] > 0 && !empty($final_salereturn_quantity[$ikey]) && $final_salereturn_quantity[$ikey] > 0){
                                echo "<td title='Sale Return' style='text-align:right;'>".number_format_ind(round(($final_salereturn_amounts[$ikey] / $final_salereturn_quantity[$ikey]),2))."</td>";
                            }
                            else{
                                echo "<td title='Sale Return' style='text-align:right;'>".number_format_ind(0)."</td>";
                            }
                            echo "<td title='Sale Return' style='text-align:right;'>".number_format_ind($final_salereturn_amounts[$ikey])."</td>";
                    ...
                    if($total_opening_amt > 0 && $total_opening_qty > 0){
                        echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind(round(($total_opening_amt / $total_opening_qty),2))."</td>";
                    }
                    else{
                        echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind(0)."</td>";
                    }
                    
                    echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind($total_opening_amt)."</td>";

                    //Purchases
                    echo "<td title='Purchase/Transfer In' style='text-align:right;font-weight:bold;'>".number_format_ind($total_purtrin_qty)."</td>";
                    if((float)$total_purtrin_qty != 0){  echo "<td title='Purchase/Transfer In' style='text-align:right;font-weight:bold;'>".number_format_ind(round(($total_purtrin_amt / $total_purtrin_qty),2))."</td>"; }
                    else{ echo "<td title='Purchase/Transfer In' style='text-align:right;font-weight:bold;'>".number_format_ind(0)."</td>"; }
                    echo "<td title='Purchase/Transfer In' style='text-align:right;font-weight:bold;'>".number_format_ind($total_purtrin_amt)."</td>";

                    //Stock-In
                    echo "<td title='Purchase/Transfer In' style='text-align:right;font-weight:bold;'>".number_format_ind($total_stkin_qty)."</td>";
                    if((float)$total_stkin_qty != 0){  echo "<td title='Purchase/Transfer In' style='text-align:right;font-weight:bold;'>".number_format_ind(round(($total_stkin_amt / $total_stkin_qty),2))."</td>"; }
                    else{ echo "<td title='Purchase/Transfer In' style='text-align:right;font-weight:bold;'>".number_format_ind(0)."</td>"; }
                    echo "<td title='Purchase/Transfer In' style='text-align:right;font-weight:bold;'>".number_format_ind($total_stkin_amt)."</td>";


                    echo "<td title='Consumption/Transferout' style='text-align:right;font-weight:bold;'>".number_format_ind($total_consumd_qty)."</td>";
                    if($total_consumd_amt > 0 && $total_consumd_qty > 0){
                        echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind(round(($total_consumd_amt / $total_consumd_qty),2))."</td>";
                    }
                    else{
                        echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind(0)."</td>";
                    }
                    ...
                    echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind($total_sales_amt)."</td>";
                    echo "<td title='Sale Return' style='text-align:right;font-weight:bold;'>".number_format_ind($total_preturn_qty)."</td>";
                    if($total_preturn_amt > 0 && $total_preturn_qty > 0){
                        echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind(round(($total_preturn_amt / $total_preturn_qty),2))."</td>";
                    }
                    else{
                        echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind(0)."</td>";
                    }
                    
                    echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind($total_preturn_amt)."</td>";
                    echo "<td title='Sale Return' style='text-align:right;font-weight:bold;'>".number_format_ind($total_sreturn_qty)."</td>";
                    if($total_sreturn_amt > 0 && $total_sreturn_qty > 0){
                        echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind(round(($total_sreturn_amt / $total_sreturn_qty),2))."</td>";
                    }
                    else{
                        echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind(0)."</td>";
                    }
                    
                    echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind($total_sreturn_amt)."</td>";
                    echo "<td title='Closing' style='text-align:right;font-weight:bold;'>".number_format_ind($total_closed_qty)."</td>";
                    if($total_closed_amt > 0 && $total_closed_qty > 0){
                        echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind(round(($total_closed_amt / $total_closed_qty),2))."</td>";
                    }
                    else{
                        echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind(0)."</td>";
                    }
                    
                    echo "<td title='Opening' style='text-align:right;font-weight:bold;'>".number_format_ind($total_closed_amt)."</td>";
                    echo "</tr>";
                ?>
            </tbody>
        <?php
