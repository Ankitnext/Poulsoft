...
<html>
    ...
    <body align="center">
        <table class="tbl" align="center">
            ...
            <tbody class="tbody1">
                <?php
                $sql_record = "SELECT * FROM `item_stocktransfers` WHERE `date` >= '$fdate' AND `date` <= '$tdate'".$fromwarehouse."".$vehicle_filter."".$driver_filter."".$towarehouse."".$item_filter." AND `active` = '1' AND `dflag` = '0' ORDER BY `date`,`trnum` ASC";
