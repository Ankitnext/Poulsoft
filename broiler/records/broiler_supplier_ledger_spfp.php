...
global $page_title; $page_title = "Supplier History Report";
...
<html>
    ...
    <body align="center">
        <table class="tbl" align="center">
            ...
            <form action="broiler_supplier_ledger_spfp.php" method="post">
        ...
        <table id="main_table" class="tbl" align="center">
            ...
            <tbody class="tbody1">
                <?php
                    $old_inv = ""; $opening_purchases = $osup_frtamt = $opening_payments = $opening_rcts = $opening_scn = $opening_sdn = $opening_returns = $rb_amt = $opening_cntcr = $opening_cntdr = $opening_vcr = $opening_vdr = 0;
                    ...
                    $sql_record = "SELECT * FROM `master_receipts` WHERE `date` < '$fdate' AND `to_account` = '$vendors' AND `t_type` IN ('Supplier Receipt') AND `active` = '1' AND `dflag` = '0' ORDER BY `date`,`trnum` ASC";
                    $query = mysqli_query($conn,$sql_record); $transaction_count = 0; if(!empty($query)){ $transaction_count = mysqli_num_rows($query); }
                    if($transaction_count > 0){ while($row = mysqli_fetch_assoc($query)){ $opening_rcts += (float)$row['amount']; } }
                    ...
                    $ob_rcv = $opening_purchases + $osup_frtamt + $opening_rcts + $opening_scn + $opening_cntcr + $opening_vcr + $ob_dramt;
                    ...
                    $key_code = "";
                    $purchase_info = $pur_freight_info = $payment_info = $suppay_info = $suprct_info = $return_info = $contra_cr = $contra_dr = $scn_info = $sdn_info = $inv_count = $inv_fcount = $between_vcr = $between_vdr = $masterpayment = array();
                   ...
                   // sales
                    ...
                    $query = mysqli_query($conn,$sql_record); $sales_info = array(); $i = 0; $transaction_count = 0; if(!empty($query)){ $transaction_count = mysqli_num_rows($query); }
                    if($transaction_count > 0){
                        while($row = mysqli_fetch_assoc($query)){
                            $i++; $key_code = $row['date']."@".$i;
                            $sales_info[$key_code] = $row['incr']."@".$row['prefix']."@".$row['trnum']."@".$row['date']."@".$row['vcode']."@".$row['icode']."@".$row['birds']."@".$row['rcd_qty']."@".$row['rate']."@".$row['itemtamt']."@".$row['finl_amt']."@".$row['warehouse']."@".$row['remarks'];
                        }
                    }
                    ...
                    $suprct_ccount = sizeof($suprct_info);
                    ...
                    $mastetpay = sizeof($masterpayment);
                    $sales_cnt = sizeof($sales_info);
                    ...
                    for ($currentDate = strtotime($fdate); $currentDate <= strtotime($tdate); $currentDate += (86400)) {
                        ...
                        for($i = 0;$i <= $suppay_ccount;$i++){
                            if(!empty($suppay_info[$date_asc."@".$i])){
                                $payment_details = array(); $payment_details = explode("@",$suppay_info[$date_asc."@".$i]);
                                echo "<tr>";
								echo "<td style='width:93px;' class='dates'>".date("d.m.Y",strtotime($payment_details[3]))."</td>";
								echo "<td style='width:110px;text-align:left;'>".$payment_details[2]."</td>";
								echo "<td style='width:70px;text-align:left;'>".$payment_details[4]."</td>";
								echo "<td style='width:70px;text-align:left;'>Payments</td>";
								//echo "<td style='width:130px;text-align:left;'>".$vendor_name[$payment_details[4]]."</td>";
								//echo "<td style='width:130px;text-align:left;'>".$mode_name[$payment_details[6]]."</td>";
								echo "<td style='width:110px;text-align:left;'>".$coa_name[$payment_details[5]]."</td>";
                                echo "<td style='width:130px;text-align:left;'></td>";
                                echo "<td style='width:130px;text-align:left;'></td>";
								echo "<td style='width:110px;text-align:right;'></td>";
								echo "<td style='width:110px;text-align:right;'></td>";
								echo "<td style='width:110px;text-align:right;'>".number_format_ind($payment_details[9])."</td>";
                                echo "<td style='width:100px;text-align:right;'></td>";
                                echo "<td style='width:100px;text-align:right;'></td>";
                                echo "<td style='width:100px;text-align:right;'></td>";
                                echo "<td style='width:100px;text-align:right;'>".number_format_ind(0.00)."</td>";
                                echo "<td style='width:100px;text-align:right;'>".number_format_ind($payment_details[9])."</td>";
                                $bt_pay_amt = $bt_pay_amt + $payment_details[9];
                                $ob_pid_amt = $ob_pid_amt + $payment_details[9];
                                $rb_amt = $rb_amt - $payment_details[9];
                                if(number_format_ind(round($ob_rev_amt,5)) == number_format_ind(round($ob_pid_amt,5))){ $rb_amt = 0; }
                                echo "<td style='width:100px;text-align:right;'>".number_format_ind($rb_amt)."</td>";
                                echo "<td style='width:130px;text-align:left;'>".$sector_name[$payment_details[14]]."</td>";
                                echo "<td style='width:130px;text-align:left;'></td>";
                                echo "<td style='width:130px;text-align:left;'>".$payment_details[15]."</td>";
								echo "<td style='width:70px;text-align:left;'></td>";
                                echo "</tr>";
                            }
                        }
                         ...
                         //Sales Entries
                         for($i = 0;$i <= $sales_cnt;$i++){
                            if(!empty($sales_info[$date_asc."@".$i])){
                                $payment_details = array(); $payment_details = explode("@",$sales_info[$date_asc."@".$i]);
                                echo "<tr>";
								echo "<td style='width:93px;' class='dates'>".date("d.m.Y",strtotime($payment_details[3]))."</td>";
								echo "<td style='width:110px;text-align:left;'>".$payment_details[2]."</td>";
								echo "<td style='width:70px;text-align:left;'></td>";
								echo "<td style='width:70px;text-align:left;'>Sales</td>";
								//echo "<td style='width:130px;text-align:left;'>".$vendor_name[$payment_details[4]]."</td>";
								//echo "<td style='width:130px;text-align:left;'>".$mode_name[$payment_details[6]]."</td>";
								echo "<td style='width:110px;text-align:left;'>".$item_name[$payment_details[5]]."</td>";
                                echo "<td style='width:130px;text-align:left;'></td>";
                                echo "<td style='width:130px;text-align:left;'></td>";
								echo "<td style='width:110px;text-align:right;'>".$payment_details[7]."</td>";
								echo "<td style='width:110px;text-align:right;'>".$payment_details[8]."</td>";
								echo "<td style='width:110px;text-align:right;'>".number_format_ind($payment_details[10])."</td>";
                                echo "<td style='width:100px;text-align:right;'></td>";
                                echo "<td style='width:100px;text-align:right;'></td>";
                                echo "<td style='width:100px;text-align:right;'></td>";
                                echo "<td style='width:100px;text-align:right;'>".number_format_ind(0.00)."</td>";
                                echo "<td style='width:100px;text-align:right;'>".number_format_ind($payment_details[10])."</td>";
                                $bt_pay_amt = (float)$bt_pay_amt + (float)$payment_details[10];
                                $ob_pid_amt = (float)$ob_pid_amt + (float)$payment_details[10];
                                $rb_amt = $rb_amt - (float)$payment_details[10];
                                if(number_format_ind(round($ob_rev_amt,5)) == number_format_ind(round($ob_pid_amt,5))){ $rb_amt = 0; }
                                echo "<td style='width:100px;text-align:right;'>".number_format_ind($rb_amt)."</td>";
                                echo "<td style='width:130px;text-align:left;'>".$sector_name[$payment_details[14]]."</td>";
                                echo "<td style='width:130px;text-align:left;'></td>";
                        ...
                        //Receipt Entries
                        for($i = 0;$i <= $suprct_ccount;$i++){
                            if(!empty($suprct_info[$date_asc."@".$i])){
                                $rct_details = array(); $rct_details = explode("@",$suprct_info[$date_asc."@".$i]);
                                echo "<tr>";
								...
								echo "<td style='width:70px;text-align:left;'>".$rct_details[4]."</td>";
								echo "<td style='width:70px;text-align:left;'>Receipts</td>";
								//echo "<td style='width:130px;text-align:left;'>".$vendor_name[$rct_details[4]]."</td>";
								//echo "<td style='width:130px;text-align:left;'>".$mode_name[$rct_details[6]]."</td>";
								echo "<td style='width:110px;text-align:left;'>".$coa_name[$rct_details[5]]."</td>";
                                echo "<td style='width:130px;text-align:left;'></td>";
                                echo "<td style='width:130px;text-align:left;'></td>";
								echo "<td style='width:110px;text-align:right;'></td>";
								echo "<td style='width:110px;text-align:right;'></td>";
								echo "<td style='width:110px;text-align:right;'>".number_format_ind($rct_details[9])."</td>";
                                echo "<td style='width:100px;text-align:right;'></td>";
                                echo "<td style='width:100px;text-align:right;'></td>";
                                echo "<td style='width:100px;text-align:right;'></td>";
                                echo "<td style='width:100px;text-align:right;'>".number_format_ind($rct_details[9])."</td>";
                                echo "<td style='width:100px;text-align:right;'>".number_format_ind(0.00)."</td>";
                                $bt_pur_amt = $bt_pur_amt + $rct_details[9];
                                $ob_rev_amt = $ob_rev_amt + $rct_details[9];
                                $rb_amt = $rb_amt + $rct_details[9];
                                if(number_format_ind(round($ob_rev_amt,5)) == number_format_ind(round($ob_pid_amt,5))){ $rb_amt = 0; }
                                echo "<td style='width:100px;text-align:right;'>".number_format_ind($rb_amt)."</td>";
                                echo "<td style='width:130px;text-align:left;'>".$sector_name[$rct_details[14]]."</td>";
                                echo "<td style='width:130px;text-align:left;'></td>";
                                echo "<td style='width:130px;text-align:left;'>".$rct_details[15]."</td>";
								echo "<td style='width:70px;text-align:left;'></td>";
                                echo "</tr>";
                            }
                        }
                    ...
                    if(number_format_ind(round($ob_rev_amt,5)) == number_format_ind(round($ob_pid_amt,5))){
                        ...
                        echo "<td style='width:100px;text-align:right;font-weight:bold;'>".number_format_ind($ob_rev_amt - $ob_pid_amt - $tmpayamt)."</td>";
                        echo "<td style='width:100px;text-align:right;'></td>";
                    }
                    else{
                        echo "<td style='width:100px;text-align:right;'></td>";
                        echo "<td style='width:100px;text-align:right;font-weight:bold;'>".number_format_ind($ob_pid_amt - $ob_rev_amt - $tmpayamt)."</td>";
                    }
