...
if($db == ''){
    ...
    $form_path = "breeder_farm_details.php";
}
else{
    ...
    include "header_head.php";
    $form_path = "breeder_farm_details.php?db=$db&userid=".$user_code;
}
...
if(in_array("broiler_employee", $exist_tbl_names, TRUE) == ""){ $sql1 = "CREATE TABLE $database_name.broiler_employee LIKE poulso6_admin_breeder_breedermaster.broiler_employee;"; mysqli_query($conn,$sql1); }
    ...
    <body align="center">
        ...
        <table id="main_table" class="tbl" align="center">
            ...
            if(isset($_POST['submit_report']) == true){
                ...
                $sql = "SELECT * FROM `breeder_units` WHERE `active` = '1'".$drv_fltr." AND `dflag` = '0' ORDER BY `addedtime` ASC";
