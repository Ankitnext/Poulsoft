...
<body align="center">
    <table class="tbl" align="center" <?php if ($excel_type == "print") {
        ...
        <?php } ?>
        <form action="broiler_account_ledger_masterreport1.php" method="post" onSubmit="return checkval()">
    ...
    ?>
        ...
        <tbody class="tbody1" id="tbody1">
            ...
            //    if($crdr_chk == "DR"){$acc_fcoa = $coa_name[$row['coa_code']]; } 

            //  $sql_record = "SELECT * FROM `account_vouchers` WHERE `trnum`= '$trnumes' AND `active` = '1' AND `dflag` = '0'  ORDER BY `date`,`addedtime`,`trnum` ASC";
