<?php
//broiler_customer_ledger_all_ta.php
...
if($vendor_group != "all"){
    ...
    if($cas_flag == 1){
        ...
        // $vengrp_filter = " AND `groupcode` IN ('$glist')";
         ...
         $glist = [];
    foreach($vengrp_code as $gcode){
        if($vengrp_gtype[$gcode] == "C") $glist[] = $gcode;
    }
    $vengrp_filter = !empty($glist) ? " AND `groupcode` IN ('" . implode("','", $glist) . "')" : "";
    }
}
...
<html>
    ...
    <body align="center">
        <table class="tbl" align="center">
            ...
            <?php } ?>
            <form action="broiler_customer_ledger_all_ta.php" method="post">
