<?php
//broiler_liveflocksummary_masterreport_ta.php
...
if($db == ''){
    ...
    $form_path = "broiler_liveflocksummary_masterreport_ta.php";
}
else{
    $user_code = $_GET['userid'];
    include "APIconfig.php";
    include "header_head.php";
    $form_path = "broiler_liveflocksummary_masterreport_ta.php?db=$db&userid=".$user_code;
}
...
if(isset($_REQUEST['submit_report']) == true){
	...
	//$url = "../PHPExcel/Examples/broiler_liveflocksummary_masterreport_ta-Excel.php?fromdate=".$fdate."&todate=".$tdate."&branch=".$branches."&line=".$lines."&supervisor=".$supervisors."&farm=".$farms."&abirds=".$abirds."&age_above=".$age_above."&href=".$field_href[0];
}
?>
<html>
    <head>
