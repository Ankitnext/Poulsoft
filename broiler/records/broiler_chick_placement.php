...
<html>
    ...
    <body align="center">
        <table class="tbl" align="center">
            ...
            <?php } ?>
            <?php if($db == ''){?>
            <form action="broiler_chick_placement.php" method="post">
                <?php } else { ?>
                <form action="broiler_chick_placement.php?db=<?php echo $db; ?>" method="post">
                <?php } ?>
                ...
                for ($currentDate = $start_date; $currentDate <= $end_date; $currentDate += (86400)) {
                    ...
                    for($i = 1;$i <= $pur_count;$i++){
                        if($pur_chicks[$prev_date."@".$i] != ""){
                            ...
                            <tr>
                                ...
                                <td title="Purchase Price" style="text-align:right;"><?php echo number_format_ind($pur_details[13]); ?></td>
                    ...
                    for($i = 1;$i <= $trin_count;$i++){
                        if($trin_chicks[$prev_date."@".$i] != ""){
                            ...
                            if($trin_details[9] != 0 && $trin_details[9] != ""){ $mortp = ($trin_details[10]/$trin_details[9]) * 100;} else { $mortp = 0;}
                            if($trin_details[9] != 0 && $trin_details[9] != ""){ $weeksp = ($trin_details[11]/$trin_details[9]) * 100; } else { $weeksp = 0;}
                            ...
                            <tr>
                                ...
                                <td title="Mort%" style="text-align:right;"><?php echo number_format_ind($mortp); ?></td>                                <td title="Shortage" style="text-align:right;"><?php echo number_format_ind($trin_details[16]); ?></td>
                                ...
                                <td title="Purchase Price" style="text-align:right;"><?php echo number_format_ind($trin_details[14]); ?></td>
