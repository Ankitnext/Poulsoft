<?php
//broiler_customer_debitnote.php
...
global $page_title; $page_title = "Customer Debit Note Report";
...
if(isset($_POST['submit_report']) == true){
	...
	$url = "../PHPExcel/Examples/CustomerDebitNoteReport-Excel.php?fromdate=".$fdate."&todate=".$tdate."&vendors=".$vendors."&sectors=".$sectors;
}
?>
<html>
    <head>
        ...
        <table class="tbl" align="center">
            ...
            <thead class="thead1" align="center">
                <tr align="center">
                    ...
                    <th colspan="13" align="center"><?php echo $row['cdetails']; ?><h5>Customer Debit Note Report</h5></th>
                </tr>
            </thead>
            <?php } ?>
            <form action="broiler_customer_debitnote.php" method="post">
            ...
            <tbody class="tbody1">
                <?php
                $sql_record = "SELECT * FROM `broiler_crdrnote` WHERE `date` >= '$fdate' AND `date` <= '$tdate'".$vcodes."".$wcodes." AND `type` IN ('Customer') AND `crdr` IN ('Debit') AND `active` = '1' AND `dflag` = '0' ORDER BY `date`,`trnum` ASC";
