...
if($db == ''){
    ...
    $form_path = "layer_breed_standards.php";
}
else{
    ...
    include "header_head.php";
    $form_path = "layer_breed_standards.php?db=$db&userid=".$user_code;
}
...
if(in_array("layer_breed_standards", $exist_tbl_names, TRUE) == ""){ $sql1 = "CREATE TABLE $database_name.layer_breed_standards LIKE poulso6_admin_layer_layermaster.layer_breed_standards;"; mysqli_query($conn,$sql1); }
    ...
    <body align="center">
        ...
        <table id="main_table" class="tbl" align="center">
            ...
            if(isset($_POST['submit_report']) == true){
                ...
                $sql = "SELECT * FROM `layer_breed_standards` WHERE `active` = '1'".$brd_fltr." AND `dflag` = '0' ORDER BY `breed_age` ASC";
