...
<html>
    ...
    <body align="center">
        ...
        <table id="main_table" class="tbl" align="center">
            ...
            $nhtml .= '<th>Female Opening</th>'; $fhtml .= '<th id="order_num">Female Opening</th>';
            $nhtml .= '<th>Male Opening</th>'; $fhtml .= '<th id="order_num">Male Opening</th>';
            ...
            if(isset($_POST['submit_report']) == true){
                ...
                $sql = "SELECT * FROM `breeder_shed_allocation` WHERE `active` = '1'".$farm_fltr."".$unit_fltr."".$shed_fltr." AND `dflag` = '0' ORDER BY `addedtime` ASC";
