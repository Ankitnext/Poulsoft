...
if(isset($_POST['submit_report']) == true){
   ...
   // $tdate = date("Y-m-d",strtotime($_POST['tdate']));
	...
	//$url = "../PHPExcel/Examples/broiler_stock_report9-Excel.php?fdate=".$fdate."&tdate=".$tdate."&item_cat=".$item_cat."&sectors=".$sectors;
}
?>
<html>
    <head>
    ...
    <body align="center">
        <table class="tbl" align="center">
            ...
            <?php } ?>
            <form action="broiler_stock_report9.php" method="post">
