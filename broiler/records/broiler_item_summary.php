...
<html>
    ...
    <body align="center">
        <table class="tbl"  align="center"  style="width:1300px;" >
            <?php
            ...
            <?php } ?>
            <form action="broiler_item_summary.php" method="post" onsubmit="return checkval()">
           ...
           <table id="main_body" class="tbl" align="center"  style="width:1300px;">
            ...
            ?>
                <tr align="center">
                    ...
                    <th colspan="15" align="center" style="border-right:none;"><?php echo $row['cdetails']; ?><h5>Item Summary Report</h5></th>
            ...
            <?php
            if(isset($_POST['submit_report']) == true){
                $current_stock = $current_price = $current_amount = $item_list = $sector_list = $opening_stk_qty = $opening_stk_amt = $between_in_qty = $between_in_amt = $between_out_qty = $between_out_amt = array();
            ...
            foreach($sector_list as $slist){
                ...
                foreach($icat_list as $ilist){
                    ...
                    if(number_format_ind(round($loc_icat_opening_qty[$key],2)) == "0.00" && number_format_ind(round($loc_icat_btwin_qty[$key],2)) == "0.00" && number_format_ind(round($loc_icat_btwout_qty[$key],2)) == "0.00" && number_format_ind(round($loc_icat_btwclose_qty[$key],2)) == "0.00"){ }
                        ...
                        echo "<tr>";
                        if($sector_header[$slist] == 0){ echo "<td>".$sector_name[$slist]."</td>"; } else{ echo "<td></td>"; }
                        echo "<td>".$icat_name[$item_category[$ilist]]."</td>";
