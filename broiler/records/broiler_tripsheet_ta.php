...
if($db == ''){
    ...
    $form_path = "broiler_tripsheet_ta.php";
}
else{
    $user_code = $_GET['userid'];
    include "APIconfig.php";
    include "header_head.php";
    $form_path = "broiler_tripsheet_ta.php?db=$db&userid=".$user_code;
}
        ...
        <table id="main_table" class="tbl" align="center">
            ...
            <?php
               ...
               $query = mysqli_query($conn,$sql);
                ...
                $emps_fltr = ""; if($supervisors != "all"){ $emps_fltr = " AND `added_empcode` = '$supervisors'"; }
              ...
              echo  $sql_record = "SELECT * FROM `trip_sheet` WHERE `date` >= '$fdate' AND `date` <= '$tdate'".$emp_filter." AND `dflag` = '0' AND `active` = '1' ORDER BY `date`,`trnum`,`id` ASC";
