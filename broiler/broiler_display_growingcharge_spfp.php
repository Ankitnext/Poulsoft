<?php
//broiler_display_growingcharge_spfp.php
include "newConfig.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $cid = $_GET['ccid'];
if($cid != ""){ $_SESSION['growingcharge_spfp'] = $cid; } else{ $cid = $_SESSION['growingcharge_spfp']; }
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        while($row = mysqli_fetch_assoc($query)){
                                            ...
                                            $print_url1 = "print/Examples/farmerrearingchargeprint_spfp.php?trnum=".$id;
                                            $print_url2 = "print/Examples/mgmtrearingchargeprint_spfp.php?trnum=".$id;
                                            $print_url3 = "print/Examples/managementprint_spfp.php?trnum=".$id;
                                            ...
                                            if($row['flag'] == 1){
                                                ...
                                                if($print_flag == 1){
                                                   ...
                                                   // echo "<a href='".$print_url2."' target='_BLANK'><i class='fa fa-print' style='color:green;' title='Management Report'></i></a>&ensp;&ensp;";
                                                    echo "<a href='".$print_url3."' target='_BLANK'><i class='fa fa-print' style='color:orange;' title='Management'></i></a>&ensp;&ensp;";
                                                    //echo "<a href='".$print_url4."' target='_BLANK'><i class='fa fa-print' style='color:green;' title='Management Report'></i></a>&ensp;&ensp;";
                                                }
                                            }
                                        ?>
                                        </td>
