...
<html lang="en">
    ...
    <body class="m-0 hold-transition">
        <?php
         $id = $_GET['id'];
         $sql = "SELECT * FROM `broiler_farm` WHERE `id` = '$id'"; $query = mysqli_query($conn,$sql);
         while($row = mysqli_fetch_assoc($query)){
            $code = $row['code'];
            ...
            $farm_type2 = $row['farm_type2'];
            $state_code = $row['state_code'];
            $district_name = $row['district_name'];
            $area_name = $row['area_name'];
            $farm_address = $row['farm_address'];
            $agreement_months = $row['agreement_months'];
            $agreement_copy_path = $row['agreement_copy_path'];
            $agreement_copy_name = $row['agreement_copy_name'];
            $security_cheque1 = $row['security_cheque1'];
            $security_cheque2 = $row['security_cheque2'];
            $security_cheque3 = $row['security_cheque3'];
            $security_cheque4 = $row['security_cheque4'];
            $other_doc_path = $row['other_doc_path'];
            $other_doc_name = $row['other_doc_name'];
            $remarks = $row['remarks'];
         }
         $i = 0;
         $sql = "SELECT * FROM `broiler_farm_shed_details` WHERE farm_code = '$code'";
         $query = mysqli_query($conn,$sql);
         if(mysqli_num_rows($query)){
            while($row = mysqli_fetch_assoc($query)){

                $shed_no[$i] = $row['shed_no'];
                $shed_dimentions[$i] = $row['shed_dimentions'];
                $shed_sqft[$i] = $row['shed_sqft'];
                $i++;
            }
            $i = $i - 1;
         }
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Edit Farm</h3></div>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="broiler_modify_farm.php" method="post" role="form" onsubmit="return checkval()" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
							                    ...
							                    <select name="branch_code" id="branch_code" class="form-control select2" style="width: 100%;" onchange="fetch_line_details(this.id)">
                                                    <option value="select">select</option>
                                                    <?php
                                                    $sql = "SELECT * FROM `location_branch` WHERE `region_code` = '$region_code' AND `active` = '1' AND `dflag` = '0' ORDER BY `description` ASC"; $query = mysqli_query($conn,$sql);
                                                    while($row = mysqli_fetch_assoc($query)){
                                                    ?>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
							                    ...
							                    <select name="line_code" id="line_code" class="form-control select2" style="width: 100%;">
                                                    <option value="select">select</option>
                                                    <?php
                                                    $sql = "SELECT * FROM `location_line` WHERE `region_code` = '$region_code' AND `branch_code` = '$branch_code' AND `active` = '1' AND `dflag` = '0' ORDER BY `description` ASC"; $query = mysqli_query($conn,$sql);
                                                    while($row = mysqli_fetch_assoc($query)){
                                                    ?>
                                                    <option value="<?php echo $row['code']; ?>" <?php if($line_code == $row['code']){ echo "selected"; } ?>><?php echo $row['description']; ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <select name="supervisor_code" id="supervisor_code" class="form-control select2" style="width: 100%;">
                                                    ...
                                                    while($row = mysqli_fetch_assoc($query)){
                                                    ?>
                                                    <option value="<?php echo $row['code']; ?>" <?php if($supervisor_code == $row['code']){ echo "selected"; } ?>><?php echo $row['name']; ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
							                ...
							                <input type="text" name="farm_code" id="farm_code" class="form-control" value="<?php echo $farm_code; ?>" onkeyup="validatename(this.id)" onchange="check_farm_code()">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                            <label>Farm Name<b style="color:red;">&nbsp;*</b></label>
							                <input type="text" name="description" id="description" class="form-control" value="<?php echo $description; ?>" onkeyup="validatename(this.id)" onchange="check_duplicate();">
                                            </div>
                                        </div>
                                        <div class="col-md-1">
                                            <div class="form-group">
                                            <label>Farm Pincode<b style="color:red;">&nbsp;*</b></label>
							                <input type="text" name="farm_pincode" id="farm_pincode" class="form-control" value="<?php echo $farm_pincode; ?>" onkeyup="validatenum(this.id)">
                                            </div>
                                        </div>
                                        <div class="col-md-">
                                            <div class="form-group">
                                            <label>Farm Capacity<b style="color:red;">&nbsp;*</b></label>
							                <input type="text" name="farm_capacity" id="farm_capacity" class="form-control" value="<?php echo $farm_capacity; ?>" onkeyup="validatenum(this.id)">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="farmer_code" id="farmer_code" class="form-control select2" style="width: 100%;">
                                                    ...
                                                    while($row = mysqli_fetch_assoc($query)){
                                                    ?>
                                                    <option value="<?php echo $row['code']; ?>" <?php if($farmer_code == $row['code']){ echo "selected"; } ?>><?php echo $row['name']."(".$row['code'].")"; ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1" align="center">
                                            ...
                                            <input type="radio" name="farm_type" id="farm_type1" class="form-control" value="own" <?php if($farm_type == "own"){ echo "checked"; } ?> style="transform: scale(.7);">
                                        </div>
                                        <div class="col-md-1" align="center">
                                            <label>Ec Shed<b style="color:red;">&nbsp;*</b></label>
                                            <input type="radio" name="farm_type" id="farm_type2" class="form-control" value="ecs" <?php if($farm_type == "ecs"){ echo "checked"; } ?> style="transform: scale(.7);">
                                        </div>
                                        
                                        <div class="col-md-1" align="center">
                                            <label>Integration<b style="color:red;">&nbsp;*</b></label>
                                            <input type="radio" name="farm_type" id="farm_type3" class="form-control" value="int" <?php if($farm_type == "int"){ echo "checked"; } ?> style="transform: scale(.7);">
                                        </div>
                                        
                                        <div class="col-md-4"></div>
                                    </div>
                                      <?php if($fown_lease > 0) { ?>
                                     <div class="row" id="additionalOptions" style="">
                                        <div class="col-md-6"></div>
                                        <div class="col-md-1" align="center">
                                            <label>Own<b style="color:red;">&nbsp;*</b></label>
                                            <input type="radio" name="farm_types" id="farm_type4" class="form-control" value="own2" <?php if($farm_type2 == "own2"){ echo "checked"; } ?> style="transform: scale(.7);">
                                        </div>
                                        <div class="col-md-1" align="center">
                                            <label>Lease<b style="color:red;">&nbsp;*</b></label>
                                            <input type="radio" name="farm_types" id="farm_type5" class="form-control" value="lease" <?php if($farm_type2 == "lease"){ echo "checked"; } ?> style="transform: scale(.7);">
                                        </div>
                                        <div class="col-md-4"></div>
                                    </div>
                                    <?php } ?>
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
							                ...
							                <input type="text" name="district_name" id="district_name" class="form-control" value="<?php echo $district_name; ?>" onkeyup="validatename(this.id)">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                            <label>Area</label>
							                <input type="text" name="area_name" id="area_name" class="form-control" value="<?php echo $area_name; ?>" onkeyup="validatename(this.id)">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                            <label>Farm Address</label>
							                <textarea name="farm_address" id="farm_address" class="form-control"><?php echo $farm_address; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-2"></div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="agreement_months" id="agreement_months" class="form-control" value="<?php echo $agreement_months; ?>" onkeyup="validatename(this.id)">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="security_cheque1" id="security_cheque1" class="form-control" value="<?php echo $security_cheque1; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Security Cheque 2</label>
                                                <input type="text" name="security_cheque2" id="security_cheque2" class="form-control" value="<?php echo $security_cheque2; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Security Cheque 3</label>
                                                <input type="text" name="security_cheque3" id="security_cheque3" class="form-control" value="<?php echo $security_cheque3; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label>Security Cheque 4</label>
                                                <input type="text" name="security_cheque4" id="security_cheque4" class="form-control" value="<?php echo $security_cheque4; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-2"></div>
                                    </div>
                                        ...
                                        <table>
                                            ...
                                            <tbody id="row_body">
                                                ...
                                                <tr  id="row_no[<?php echo $c; ?>]">
                                                    <td><input type="text" name="shed_no[]" id="shed_no[<?php echo $c; ?>]" value="<?php echo $shed_no[$c]; ?>"  class="form-control"  style="width:110px;margin-right: 10px;" /></td>
                                                    <td><input type="text" name="shed_dimentions[]" id="shed_dimentions[<?php echo $c; ?>]" value="<?php echo $shed_dimentions[$c]; ?>"  class="form-control" style="width:110px;margin-right: 10px;" /></td>
                                                    <td><input type="text" name="shed_sqft[]" id="shed_sqft[<?php echo $c; ?>]" value="<?php echo $shed_sqft[$c]; ?>"  class="form-control" style="width:110px;" /></td>
        ...
        <script>
			...
			function check_duplicate(){
				...
				if(!b.length == 0){
					...
					var method = "GET";
					var url = "broiler_fetch_farm_duplicates.php?cname="+b+"&type="+c+"&id="+d;
                    //window.open(url);
            ...
            function check_farm_code(){
                ...
                if(farm_code.length > 0){
					var oldqty = new XMLHttpRequest();
					var method = "GET";
					var url = "broiler_validate_farmcode.php?farm_code="+farm_code+"&type="+type+"&id="+id;
					//window.open(url);
					var asynchronous = true;
					oldqty.open(method, url, asynchronous);
					oldqty.send();
