<?php
//broiler_add_generalsales6.php
include "newConfig.php";
include "broiler_generate_trnum_details.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $ccid = $_SESSION['generalsales6'];
...
if($link_active_flag > 0){
    ...
    if($acount == 1){
        ...
        $trno_dt1 = generate_transaction_details($date,"generalsales6","GGS","display",$_SESSION['dbase']);
    ...
    <body class="m-0 hold-transition">
        <div class="m-0 p-0 wrapper">
            <section class="m-0 p-0 content">
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="m-0 p-2 card-body">
                            <div class="col-md-18">
                                <form action="broiler_save_generalsales6.php" method="post" role="form" enctype="multipart/form-data" onSubmit="return checkval()">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <br/><a href="javascript:void(0);" id="cus_apopup" class="form-control" style="width:15px; height:15px;border:none;"><i class="fa fa-plus" style="color:green;"></i></a>
                                        </div>
                                        <?php if((int)$pnme_flag == 1) { ?>
                                        <div class="form-group">
                                            <label>PO No.</label>
                                            <input type="text" name="sale_pono" id="sale_pono" class="form-control" style="width:120px;" />
                                        </div><?php } ?>
                                        <?php if((int)$pdme_flag == 1) { ?>
                                        <div class="form-group">
                                            <label>PO Date</label>
                                            <input type="text" name="sale_podate" id="sale_podate" class="form-control rc_datepicker" value="<?php echo date('d.m.Y'); ?>" style="width:120px;" onkeyup="validatename(this.id);" readonly/>
                                        </div><?php } ?>
                                    </div><br/>
                                    <table>
                                        <thead>
                                            <tr style="text-align:center;">
                                                ...
                                                <th>GST</th>
                                                <th>Item Amount</th>
                                                <th>Stock Point / Feed Mill</th>
                                                <th></th>
                                                <?php if((int)$bnme_flag == 1) { ?> <th>Batch No.</th> <?php } ?>
                                        ...
                                        <tbody id="row_body">
                                            <tr>
                                                <td><select name="icode[]" id="icode[0]" class="form-control select2" style="width:180px;" onchange="fetch_stock_master(this.id);fetch_customer_pricemaster(this.id);fetch_itemuom(this.id);"><option value="select">select</option><?php foreach($item_code as $icode){ ?><option value="<?php echo $icode; ?>"><?php echo $item_name[$icode]; ?></option><?php } ?></select></td>
                                                <td><a href="javascript:void(0);" id="itm_apopup[0]" class="form-control" style="width:15px; height:15px;border:none;" onclick="show_apopup(this.id);"><i class="fa fa-plus" style="color:green;"></i></a></td>
                                                ...
                                                <td><input type="text" name="amount1[]" id="amount1[0]" class="form-control text-right" placeholder="0.00" style="width:90px;" readonly ></td>
                                                ...
                                                <td><select name="warehouse[]" id="warehouse[0]" class="form-control select2" style="width:160px;"><option value="select">select</option><?php foreach($sector_code as $scode){ ?><option value="<?php echo $scode; ?>"><?php echo $sector_name[$scode]; ?></option><?php } ?></select></td>
                                                ...
                                                <?php if((int)$bnme_flag == 1) { ?> <td><input type="text" name="fbatch_no[]" id="fbatch_no[0]" class="form-control" style="width:100px;" /></td><?php } ?>
                                                <?php if((int)$mdme_flag == 1) { ?><td><input type="text" name="fmake_date[]" id="fmake_date[0]" class="form-control rc_datepicker" style="width:100px;" value="<?php echo date('d.m.Y'); ?>" readonly /></td><?php } ?>
                                                <?php if((int)$edme_flag == 1) { ?><td><input type="text" name="fexp_date[]" id="fexp_date[0]" class="form-control rc_datepicker" style="width:100px;" value="<?php echo date('d.m.Y'); ?>" readonly /></td><?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="dmobile_no" id="dmobile_no" class="form-control" style="width:120px;" onkeyup="validatename(this.id);" />
                                        </div>
                                    </div>
                ...
                <!-- Customer Creation Pop-Up -->
                <div class="row">
                    <div id="cus_ascrn" style="display:none;">
                        <span class="cus-clsicon" onclick="cus_pclose()"><i class="fa-solid fa-xmark"></i></span>
                        <h6><b style="color:red;">Note: </b>once new customer added, click on close icon to make changes</h6>
                        <iframe id="cus_aframe" src="" width="100%" height="400"></iframe>
                    </div>
                </div>
                <!-- Item Creation Pop-Up -->
                <div class="row">
                    <div id="itm_ascrn" style="display:none;">
                        <span class="itm-clsicon" onclick="itm_pclose()"><i class="fa-solid fa-xmark"></i></span>
                        <h6><b style="color:red;">Note: </b>once new Item added, click on close icon to make changes</h6>
                        <iframe id="itm_aframe" src="" width="100%" height="400"></iframe>
                        <div class="row" style="visibility:hidden;"><input type="text" name="itm_id" id="itm_id" class="form-control" value="0" readonly /></div>
                    </div>
                </div>
            </section>
        </div>
        ...
        <script src="broiler_dynamic_single_cuscreate.js"></script>
        <script src="broiler_dynamic_multiple_itmcreate.js"></script>
        <script>
            function return_back(){
                var ccid = '<?php echo $ccid; ?>';
                window.location.href = 'broiler_display_generalsales6.php?ccid='+ccid;
            }
            function checkval(){
                        ...
                        for(d = 0;d <= incrs;d++){
                            if(l == true){
                                ...
                                if(parseFloat(qty) > parseFloat(stock)){
                                    ...
                                    alert("Kindly select appropriate Warehouse"+c);
            ...
            function create_row(a){
                ...
                html += '<tr id="row_no['+d+']">';
                html += '<td><select name="icode[]" id="icode['+d+']" class="form-control select2" style="width:180px;" onchange="fetch_stock_master(this.id);fetch_customer_pricemaster(this.id);fetch_itemuom(this.id);"><option value="select">select</option><?php foreach($item_code as $icode){ ?><option value="<?php echo $icode; ?>"><?php echo $item_name[$icode]; ?></option><?php } ?></select></td>';
                html += '<td><a href="javascript:void(0);" id="itm_apopup['+d+']" class="form-control" style="width:15px; height:15px;border:none;" onclick="show_apopup(this.id);"><i class="fa fa-plus" style="color:green;"></i></a></td>';
                ...
                html += '<td><select name="warehouse[]" id="warehouse['+d+']" class="form-control select2" style="width:160px;"><option value="select">select</option><?php foreach($sector_code as $scode){ ?><option value="<?php echo $scode; ?>"><?php echo $sector_name[$scode]; ?></option><?php } ?></select></td>';
