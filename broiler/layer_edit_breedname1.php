...
<html lang="en">
    ...
    <body class="m-0 hold-transition">
        <?php
        $ids = $_GET['id'];
        $sql = "SELECT * FROM `layer_breed_details` WHERE `id` = '$ids' AND `dflag` = '0' AND `trlink` = 'layer_display_breedname1.php'";
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Edit Layer Name</h3></div>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="layer_modify_breedname1.php" method="post" role="form" onsubmit="return checkval()">
        ...
        <script>
            ...
            function return_back(){
                ...
                window.location.href = 'layer_display_breedname1.php?ccid='+ccid;
            }
			function check_duplicate(){
				...
				if(description != ""){
					...
					var method = "GET";
					var url = "layer_fetch_breedname1_duplicates.php?description="+description+"&id="+id+"&type="+type;
                    //window.open(url);
