<?php
//broiler_edit_feedproduction3.php
include "newConfig.php";
date_default_timezone_set("Asia/Kolkata");
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $ccid = $_SESSION['feedproduction3'];
    ...
    <body class="m-0 p-0 hold-transition">
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="p-0 pt-5 card-body">
                            <div class="col-md-12">
                                <form action="broiler_modify_feedproduction3.php" method="post" role="form" enctype="multipart/form-data" onsubmit="return checkval()">
                                    <div class="row">
                                        <div class="form-group">
                                            <label>Date<b style="color:red;">&nbsp;*</b></label>
							                <input type="text" name="date" id="date" class="form-control range_picker" style="width:100px;" value="<?php echo date('d.m.Y',strtotime($fm_prod_date)); ?>" />
                                        </div>
                                        <div class="form-group">
                                            <label>Dc No.</label>
                                    ...
                                    <div class="row" id="production_info" Style="" align="center">
                                        ...
                                        <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="make_date" id="make_date" class="form-control range_picker" value="<?php echo date("d.m.Y",strtotime($make_date)); ?>" style="width:200px;" readonly /></td>
                                                    <td><input type="text" name="exp_date" id="exp_date" class="form-control range_picker" value="<?php echo date("d.m.Y",strtotime($exp_date)); ?>" style="width:200px;" readonly /></td>
                                                </tr>
                                        </table>
                                        </div>
                                    </div><br/>
        ...
        <script>
            function return_back(){
                ...
                window.location.href = 'broiler_display_feedproduction3.php?ccid='+ccid;
            }
            function checkval(){
            ...
            var is_flag = '<?php echo $isel_flag; ?>'; if(parseInt(is_flag) == 1){ fetch_edititem_master(); }
