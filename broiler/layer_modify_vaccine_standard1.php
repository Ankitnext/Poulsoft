<?php
//layer_modify_vaccine_standard1.php
...
$sql = "UPDATE `layer_medvac_schedule` SET `breed_code` = '$breed_code',`medvac_code` = '$medvac_code',`age` = '$age',`updatedemp` = '$addedemp',`updatedtime` = '$addedtime' WHERE `id` = '$id'";
