...
<head>
    ...
    <!--<script src="https://kit.fontawesome.com/75dfa87db4.js" crossorigin="anonymous"></script>-->
    <style>
        #dboard { width: 100%; min-height: 100%; overflow: auto; } .treeview-menu { min-width:210px; }
        .select2-container .select2-selection--single{ padding-top: 5px; box-sizing:border-box; cursor:pointer; display:block; height:25px; user-select:none; -webkit-user-select:none; }
