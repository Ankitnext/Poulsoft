<?php
//broiler_add_hatcher.php
include "newConfig.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $ccid = $_SESSION['hatcher'];
    ...
    <body class="m-0 hold-transition">
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Add Hatcher</h3></div>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <form action="broiler_save_hatcher.php" method="post" role="form" onsubmit="return checkval()">
                                    <div class="row">
                                        ...
                                        <table class="p-1">
                                            <thead>
                                                <tr style="text-align:center;">
                                                    <th><label>Hatcher<b style="color:red; width: 100%;">&nbsp;*</b></label></th>
                                            ...
                                            <tbody id="row_body">
                                                <tr>
                                                    <td><input type="text" name="hatcher[]" id="hatcher[0]" class="form-control " style="width:80px;" value=""   /></td>
                                                    <td><input type="text" name="hatcher_capacity[]" id="hatcher_capacity[0]" class="form-control" style="width:60px;" onchange="validatenum(this.id)" onkeyup="validatenum(this.id)"/></td>
        ...
        <script>
            function return_back(){
                ...
                window.location.href = 'broiler_display_hatcher.php?ccid='+ccid;
            }
            function checkval(){
                var l = true;
                if(l == true){
            ...
            function create_row(a){
                ...
                html += '<tr id="row_no['+d+']">';
                html += '<td><input type="text" name="hatcher[]" id="hatcher['+d+']" class="form-control " style="width:80px;" value="" onchange=""  /></td>';
                html += '<td><input type="text" name="hatcher_capacity[]" id="hatcher_capacity['+d+']" class="form-control" style="width:60px;" /></td>';
