<?php
//breeder_add_eggtransfer1.php
include "newConfig.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $ccid = $_SESSION['eggtransfer1'];
...
if($link_active_flag > 0){
    ...
    if($acount == 1){
        $date = date("d.m.Y"); $sector_code = $sector_name = array();
        
		$sql = "SELECT * FROM `main_officetypes` WHERE `description` LIKE '%hatchery%' AND `active` = '1' ORDER BY `description` ASC"; $query = mysqli_query($conn,$sql); $hatchery_alist = array();
        ...
        $bsql = "SELECT * FROM `inv_sectors` WHERE `active` = '1' AND (`brd_sflag` = '1' OR `type` IN ('$hatchery_list')) AND `dflag` = '0' ORDER BY `description` ASC"; $bquery = mysqli_query($conn,$bsql);
        while($brow = mysqli_fetch_assoc($bquery)){ $sector_code[$brow['code']] = $brow['code']; $sector_name[$brow['code']] = $brow['description']; }
    ...
    <body class="m-0 hold-transition">
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        <div class="card-header">
                            <div class="float-left"><h3 class="card-title">Add Egg Transfer</h3></div>
                        </div>
                        <div class="pl-2 card-body">
                            <form action="breeder_save_eggtransfer1.php" method="post" role="form" onsubmit="return checkval()">
        ...
        <script>
            ...
            function return_back(){
                ...
                window.location.href = 'breeder_display_eggtransfer1.php?ccid='+ccid;
            }
