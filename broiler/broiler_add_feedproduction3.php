<?php
//broiler_add_feedproduction3.php
...
if($link_active_flag > 0){
    ...
    if($acount == 1){
        ...
        $sql = "SELECT * FROM `extra_access` WHERE `field_name` LIKE 'broiler_display_feedproduction3.php' AND `field_function` LIKE 'Date Range Extended'"; $query = mysqli_query($conn,$sql);
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="p-0 pt-5 card-body">
                            <div class="col-md-12">
                                <form action="broiler_save_feedproduction3.php" method="post" role="form" enctype="multipart/form-data" onsubmit="return checkval()">
                                    <div class="row">
