...
for($i = 0;$i < $ssize;$i++){
    ...
    if($dcount > 0){ }
        ...
        $code = $prefix."-".$incr;
        $sql = "INSERT INTO `location_line` (incr,prefix,code,description,region_code,branch_code,addedemp,addedtime,updatedtime) VALUES ('$incr','$prefix','$code','$description[$i]','$region_code','$branch_code','$addedemp','$addedtime','$addedtime')";
