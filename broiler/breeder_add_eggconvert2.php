<?php
//breeder_add_eggconvert2.php
include "newConfig.php";
$user_name = $_SESSION['users']; $user_code = $_SESSION['userid']; $ccid = $_SESSION['eggconvert2'];
                ...
                <div class="m-0 p-0 container-fluid">
                    <div class="m-0 p-0 card">
                        ...
                        <div class="pl-2 card-body">
                            <form action="breeder_save_eggconvert2.php" method="post" role="form" onsubmit="return checkval()">
                                <div class="row row_body2">
                                    <table class="p-1 table1" style="width:auto;" align="center">
                                        ...
                                        <thead>
                                            <tr>
                                                <th style="text-align:center;"><label>Sector/Flock<b style="color:red;">&nbsp;*</b></label></th>
                                        ...
                                        <tbody id="tbody">
                                            <tr>
                                                <td><select name="from_loc[]" id="from_loc[0]" class="form-control select2" style="width:190px;" onchange="fetch_bird_details(this.id);"><option value="select">-select-</option><?php foreach($sector_code as $ucode){ ?><option value="<?php echo $ucode; ?>"><?php echo $sector_name[$ucode]; ?></option><?php } ?></select></td>
        ...
        <script>
			function checkval(){
                ...
                if(date == ""){
                    ...
                    var from_loc = from_item = to_item = ""; var to_qty = disposed_qty = 0;
                    for(var d = 0;d <= incr;d++){
                        if(l == true){
                            e = d + 1;
                            from_loc = document.getElementById("from_loc["+d+"]").value;
                            ...
                            if(from_loc == "" || from_loc == "select"){
                                alert("Please select Sector/Flock in row: "+e);
                                document.getElementById("from_loc["+d+"]").focus();
                                l = false;
                            }
                            else if(from_item == "" || from_item == "select"){
            ...
            function return_back(){
                ...
                window.location.href = 'breeder_display_eggconvert2.php?ccid='+ccid;
            }
			function create_row(a){
                ...
                html += '<tr id="row_no['+d+']">';
                html += '<td><select name="from_loc[]" id="from_loc['+d+']" class="form-control select2" style="width:190px;" onchange="fetch_bird_details(this.id);"><option value="select">-select-</option><?php foreach($sector_code as $ucode){ ?><option value="<?php echo $ucode; ?>"><?php echo $sector_name[$ucode]; ?></option><?php } ?></select></td>';
            ...
            function fetch_bird_details(a){
                ...
                var b = a.split("["); var c = b[1].split("]"); var d = c[0];
                var date = document.getElementById("date").value;
                var from_loc = document.getElementById("from_loc["+d+"]").value;
