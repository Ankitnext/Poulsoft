<?php
//breeder_save_vaccine_standard1.php
...
$trlink = "breeder_display_vaccine_standard1.php";

$dsize = sizeof($medvac_code);
for($i = 0;$i < $dsize;$i++){
    if($age[$i] == ""){ $age[$i] = 0; }
    $sql = "INSERT INTO `breeder_medvac_schedule` (`breed_code`,`age`,`medvac_code`,`flag`,`active`,`dflag`,`trtype`,`trlink`,`addedemp`,`addedtime`,`updatedtime`) 
...
<script>
    ...
    if(x == true){
        window.location.href = "breeder_add_vaccine_standard1.php";
    }
    else if(x == false) {
