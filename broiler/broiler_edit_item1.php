...
<html lang="en">
    ...
    <body class="m-0 hold-transition">
        ...
        while($row = mysqli_fetch_assoc($query)){
            ...
            $bfamf_flag = $row['bfamf_flag']; if($bfamf_flag == ""){ $bfamf_flag = 0; }
            $category = $row['category'];
            $sub_category = $row['sub_category'];
            $sunits = $row['sunits'];
            $cunits = $row['cunits'];
            $einv_units = $row['einv_units'];
                    ...
                    <div class="m-0 p-0 card">
                        ...
                        <div class="card-body">
                            <div class="col-md-12 d-flex flex-wrap justify-content-center align-items-center">
                                <form action="broiler_modify_item1.php" method="post" role="form" onsubmit="return checkval()">
                                <div class="row d-flex flex-wrap justify-content-center align-items-center">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="einv_units" id="einv_units" class="form-control select2" style="width: 100%;">
                                                    <option value="select">select</option>
                                                    <?php foreach($eiunit_code as $ucode){ ?><option value="<?php echo $ucode; ?>" <?php if($ucode == $einv_units){ echo 'selected'; } ?>><?php echo $eiunit_name[$ucode]; ?></option><?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        <?php } else{ echo '<div class="col-md-2"></div>'; } ?>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox" name="bfamf_flag" id="bfamf_flag" class="form-control" <?php if($bfamf_flag == 1){ echo "checked"; } ?> style="height:20px;" />
                                            </div>
                                        </div>
                                        <?php } ?>
                                    </div>
